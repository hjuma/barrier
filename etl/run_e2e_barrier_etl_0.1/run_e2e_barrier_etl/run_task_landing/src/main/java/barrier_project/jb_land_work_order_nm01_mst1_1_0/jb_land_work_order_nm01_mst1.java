...
package barrier_project.jb_land_work_order_nm01_mst1_1_0;
...
/**
 * Job: jb_land_work_order_nm01_mst1 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_nm01_mst1 implements TalendJob {
...
public String getSource_x_data_home(){
	...
	private final String jobName = "jb_land_work_order_nm01_mst1";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_nm01_mst1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_nm01_mst1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("work_order_MST1_*.txt");  
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("mst1", 3, 0);
					}           			
...
public static class mst1Struct implements routines.system.IPersistableRow<mst1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_mst1 = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1 = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mst1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_mst1) {
     ...
     * Compare keys
     */
    public int compareTo(mst1Struct other) {
...
mst1Struct mst1 = new mst1Struct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("mst1" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_nm01_mst1";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "work_order_nm01_mst1" + "` (`facility_code`,`order`,`functional_loc`,`description`,`order_type`,`planner_group`,`user_status`,`abc_indic`,`work_center`,`maint_activ_type`,`latest_allow_fin_dat`,`system_status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
mst1Struct mst1_tmp = new mst1Struct();
// ###############################
...
// # Output table : 'mst1'
mst1_tmp.facility_code = row1.facility_code;
mst1_tmp.order = row1.work_order_number ;
mst1_tmp.functional_loc = row1.functional_location ;
mst1_tmp.description = row1.work_order_description ;
mst1_tmp.order_type = row1.order_type;
mst1_tmp.planner_group = row1.planner_group;
mst1_tmp.user_status = row1.user_status;
mst1_tmp.abc_indic = row1.abc_field ;
mst1_tmp.work_center = row1.work_centre ;
mst1_tmp.maint_activ_type = row1.maint_activ_type;
mst1_tmp.latest_allow_fin_dat = row1.latest_allowable_finish_date ;
mst1_tmp.system_status = row1.system_status;
mst1 = mst1_tmp;
// ###############################
...
if(mst1 != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//mst1
				...
				if(execStat){
					runStat.updateStatOnConnection("mst1"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(mst1.facility_code == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, mst1.facility_code);
}

                            if(mst1.order == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(2, mst1.order);
}

                            if(mst1.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, mst1.functional_loc);
}

                            if(mst1.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, mst1.description);
}

                            if(mst1.order_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, mst1.order_type);
}

                            if(mst1.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, mst1.planner_group);
}

                            if(mst1.user_status == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, mst1.user_status);
}

                            if(mst1.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else {if(mst1.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(mst1.abc_indic == ' '){
pstmt_tMysqlOutput_1.setString(8, "");
} else {
pstmt_tMysqlOutput_1.setString(8, String.valueOf(mst1.abc_indic));
}}

                            if(mst1.work_center == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, mst1.work_center);
}

                            if(mst1.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, mst1.maint_activ_type);
}

                            if(mst1.latest_allow_fin_dat != null) {
date_tMysqlOutput_1 = mst1.latest_allow_fin_dat.getTime();
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                            ...
                            if(mst1.system_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, mst1.system_status);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("mst1"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_nm01_mst1 jb_land_work_order_nm01_mst1Class = new jb_land_work_order_nm01_mst1();

        int exitCode = jb_land_work_order_nm01_mst1Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_nm01_mst1.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_nm01_mst1_1_0/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_nm01_mst1");
        }
