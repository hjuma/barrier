...
package barrier_project.jb_land_ps_mapping_nm01_0_1;
...
/**
 * Job: jb_land_ps_mapping_nm01 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_ps_mapping_nm01 implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_land_ps_mapping_nm01";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_ps_mapping_nm01.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_ps_mapping_nm01.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map_2_landingStruct implements routines.system.IPersistableRow<map_2_landingStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_ps_mapping_nm01 = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01 = new byte[0];
			    ...
			    public String floc_type;

				public String getFloc_type () {
					return this.floc_type;
				}
			    ...
			    public String support_floc;

				public String getSupport_floc () {
					return this.support_floc;
				}
				
			    public String support_floc_description;

				public String getSupport_floc_description () {
					return this.support_floc_description;
				}
				
			    public String abc_indicator;

				public String getAbc_indicator () {
					return this.abc_indicator;
				}
				
			    public String criticality_justification;

				public String getCriticality_justification () {
					return this.criticality_justification;
				}
				
			    public String ps_ref1;

				public String getPs_ref1 () {
					return this.ps_ref1;
				}
				
			    public String ps_ref2;

				public String getPs_ref2 () {
					return this.ps_ref2;
				}
				
			    public String new_ps_ref_1;

				public String getNew_ps_ref_1 () {
					return this.new_ps_ref_1;
				}
				
			    public String new_ps_ref_2;

				public String getNew_ps_ref_2 () {
					return this.new_ps_ref_2;
				}
				
			    public String nl_sce;

				public String getNl_sce () {
					return this.nl_sce;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01 = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_ps_mapping_nm01) {

        	try {

        		int length = 0;
		
					this.floc = readString(dis);
					
					this.floc_type = readString(dis);
					
					this.description = readString(dis);
					
					this.support_floc = readString(dis);
					
					this.support_floc_description = readString(dis);
					
					this.abc_indicator = readString(dis);
					
					this.criticality_justification = readString(dis);
					
					this.ps_ref1 = readString(dis);
					
					this.ps_ref2 = readString(dis);
					
					this.new_ps_ref_1 = readString(dis);
					
					this.new_ps_ref_2 = readString(dis);
					
					this.nl_sce = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.floc,dos);
					
					// String
				
						writeString(this.floc_type,dos);
					...
					// String
						...
						writeString(this.support_floc,dos);
					
					// String
				
						writeString(this.support_floc_description,dos);
					
					// String
				
						writeString(this.abc_indicator,dos);
					
					// String
				
						writeString(this.criticality_justification,dos);
					
					// String
				
						writeString(this.ps_ref1,dos);
					
					// String
				
						writeString(this.ps_ref2,dos);
					
					// String
				
						writeString(this.new_ps_ref_1,dos);
					
					// String
				
						writeString(this.new_ps_ref_2,dos);
					
					// String
				
						writeString(this.nl_sce,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("floc="+floc);
		sb.append(",floc_type="+floc_type);
		sb.append(",description="+description);
		sb.append(",support_floc="+support_floc);
		sb.append(",support_floc_description="+support_floc_description);
		sb.append(",abc_indicator="+abc_indicator);
		sb.append(",criticality_justification="+criticality_justification);
		sb.append(",ps_ref1="+ps_ref1);
		sb.append(",ps_ref2="+ps_ref2);
		sb.append(",new_ps_ref_1="+new_ps_ref_1);
		sb.append(",new_ps_ref_2="+new_ps_ref_2);
		sb.append(",nl_sce="+nl_sce);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(map_2_landingStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_nm01 = new byte[0];
				...
				public String getSupFunctLoc () {
					return this.SupFunctLoc;
				}
				
			    public String SupFL_Description;

				public String getSupFL_Description () {
					return this.SupFL_Description;
				}
			    ...
			    public String PSRef2;

				public String getPSRef2 () {
					return this.PSRef2;
				}
				
			    public String NEW_PS_Ref_;

				public String getNEW_PS_Ref_ () {
					return this.NEW_PS_Ref_;
				}
				
			    public String NEW_PS_Ref__2;

				public String getNEW_PS_Ref__2 () {
					return this.NEW_PS_Ref__2;
				}
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_ps_mapping_nm01) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SupFunctLoc = readString(dis);
					
					this.SupFL_Description = readString(dis);
					
					this.ABC_Indic = readString(dis);
					
					this.Criticality_Justification = readString(dis);
					
					this.PSRef = readString(dis);
					
					this.PSRef2 = readString(dis);
					
					this.NEW_PS_Ref_ = readString(dis);
					
					this.NEW_PS_Ref__2 = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SupFunctLoc,dos);
					
					// String
				
						writeString(this.SupFL_Description,dos);
					...
					// String
						...
						writeString(this.PSRef,dos);
					
					// String
				
						writeString(this.PSRef2,dos);
					
					// String
				
						writeString(this.NEW_PS_Ref_,dos);
					
					// String
				
						writeString(this.NEW_PS_Ref__2,dos);
    ...
    public String toString() {
		...
		sb.append(",FLOC_Type="+FLOC_Type);
		sb.append(",Description="+Description);
		sb.append(",SupFunctLoc="+SupFunctLoc);
		sb.append(",SupFL_Description="+SupFL_Description);
		sb.append(",ABC_Indic="+ABC_Indic);
		sb.append(",Criticality_Justification="+Criticality_Justification);
		sb.append(",PSRef="+PSRef);
		sb.append(",PSRef2="+PSRef2);
		sb.append(",NEW_PS_Ref_="+NEW_PS_Ref_);
		sb.append(",NEW_PS_Ref__2="+NEW_PS_Ref__2);
		sb.append(",NL_SCE="+NL_SCE);
	    sb.append("]");
...
map_2_landingStruct map_2_landing = new map_2_landingStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("map_2_landing" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "ps_mapping_nm01";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "ps_mapping_nm01" + "` (`floc`,`floc_type`,`description`,`support_floc`,`support_floc_description`,`abc_indicator`,`criticality_justification`,`ps_ref1`,`ps_ref2`,`new_ps_ref_1`,`new_ps_ref_2`,`nl_sce`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
map_2_landingStruct map_2_landing_tmp = new map_2_landingStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"/barrier/database/barrier_landing/data/ps_mapping_nm01.csv"/** End field tFileInputDelimited_1:FILENAME */;		
			...
			if(footer_value_tFileInputDelimited_1 > 0){
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							row1.Functional_Loc = null;
					
							row1.FLOC_Type = null;
					
							row1.Description = null;
					
							row1.SupFunctLoc = null;
					
							row1.SupFL_Description = null;
					
							row1.ABC_Indic = null;
					
							row1.Criticality_Justification = null;
					
							row1.PSRef = null;
					
							row1.PSRef2 = null;
					
							row1.NEW_PS_Ref_ = null;
					
							row1.NEW_PS_Ref__2 = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Functional_Loc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.FLOC_Type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.SupFunctLoc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.SupFL_Description = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ABC_Indic = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Criticality_Justification = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.PSRef = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.PSRef2 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.NEW_PS_Ref_ = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.NEW_PS_Ref__2 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.NL_SCE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// # Output table : 'map_2_landing'
map_2_landing_tmp.floc =  row1.Functional_Loc ;
map_2_landing_tmp.floc_type =  row1.FLOC_Type ;
map_2_landing_tmp.description =  row1.Description ;
map_2_landing_tmp.support_floc =  row1.SupFunctLoc ;
map_2_landing_tmp.support_floc_description =  row1.SupFL_Description ;
map_2_landing_tmp.abc_indicator =  row1.ABC_Indic ;
map_2_landing_tmp.criticality_justification =  row1.Criticality_Justification ;
map_2_landing_tmp.ps_ref1 =  row1.PSRef ;
map_2_landing_tmp.ps_ref2 =  row1.PSRef2 ;
map_2_landing_tmp.new_ps_ref_1 =  row1.NEW_PS_Ref_ ;
map_2_landing_tmp.new_ps_ref_2 =  row1.NEW_PS_Ref__2 ;
map_2_landing_tmp.nl_sce =  row1.NL_SCE ;
map_2_landing = map_2_landing_tmp;
// ###############################
 ...
 * [tMap_1 main ] stop
 */
// Start of branch "map_2_landing"
if(map_2_landing != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//map_2_landing
				...
				if(execStat){
					runStat.updateStatOnConnection("map_2_landing"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(map_2_landing.floc == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, map_2_landing.floc);
}

                            if(map_2_landing.floc_type == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, map_2_landing.floc_type);
}

                            if(map_2_landing.description == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, map_2_landing.description);
}

                            if(map_2_landing.support_floc == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, map_2_landing.support_floc);
}

                            if(map_2_landing.support_floc_description == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, map_2_landing.support_floc_description);
}

                            if(map_2_landing.abc_indicator == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, map_2_landing.abc_indicator);
}

                            if(map_2_landing.criticality_justification == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, map_2_landing.criticality_justification);
}

                            if(map_2_landing.ps_ref1 == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, map_2_landing.ps_ref1);
}

                            if(map_2_landing.ps_ref2 == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, map_2_landing.ps_ref2);
}

                            if(map_2_landing.new_ps_ref_1 == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, map_2_landing.new_ps_ref_1);
}

                            if(map_2_landing.new_ps_ref_2 == null) {
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(11, map_2_landing.new_ps_ref_2);
}

                            if(map_2_landing.nl_sce == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, map_2_landing.nl_sce);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("map_2_landing"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_ps_mapping_nm01 jb_land_ps_mapping_nm01Class = new jb_land_ps_mapping_nm01();

        int exitCode = jb_land_ps_mapping_nm01Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_ps_mapping_nm01.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_ps_mapping_nm01_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_ps_mapping_nm01");
        }
...
/************************************************************************************************
 *     95753 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:43 GMT
 ************************************************************************************************/