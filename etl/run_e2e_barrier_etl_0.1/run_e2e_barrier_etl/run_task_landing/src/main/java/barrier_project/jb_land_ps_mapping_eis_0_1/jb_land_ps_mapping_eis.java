...
package barrier_project.jb_land_ps_mapping_eis_0_1;
...
/**
 * Job: jb_land_ps_mapping_eis Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_ps_mapping_eis implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_land_ps_mapping_eis";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_ps_mapping_eis.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_ps_mapping_eis.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map_2_eisStruct implements routines.system.IPersistableRow<map_2_eisStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_ps_mapping_eis = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis = new byte[0];
			    ...
			    public String ps_ref_1;

				public String getPs_ref_1 () {
					return this.ps_ref_1;
				}
				
			    public String ps_ref_2;

				public String getPs_ref_2 () {
					return this.ps_ref_2;
				}
				
			    public String ps_ref_3;

				public String getPs_ref_3 () {
					return this.ps_ref_3;
				}
				
			    public String ps_mapping_barrier_1;

				public String getPs_mapping_barrier_1 () {
					return this.ps_mapping_barrier_1;
				}
				
			    public String ps_mapping_barrier_2;

				public String getPs_mapping_barrier_2 () {
					return this.ps_mapping_barrier_2;
				}
				
			    public String ps_mapping_barrier_3;

				public String getPs_mapping_barrier_3 () {
					return this.ps_mapping_barrier_3;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_ps_mapping_eis, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_ps_mapping_eis) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ps_ref_1 = readString(dis);
					
					this.ps_ref_2 = readString(dis);
					
					this.ps_ref_3 = readString(dis);
					
					this.ps_mapping_barrier_1 = readString(dis);
					
					this.ps_mapping_barrier_2 = readString(dis);
					
					this.ps_mapping_barrier_3 = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ps_ref_1,dos);
					
					// String
				
						writeString(this.ps_ref_2,dos);
					
					// String
				
						writeString(this.ps_ref_3,dos);
					
					// String
				
						writeString(this.ps_mapping_barrier_1,dos);
					
					// String
				
						writeString(this.ps_mapping_barrier_2,dos);
					
					// String
				
						writeString(this.ps_mapping_barrier_3,dos);
    ...
    public String toString() {
		...
		sb.append(",ps_ref_1="+ps_ref_1);
		sb.append(",ps_ref_2="+ps_ref_2);
		sb.append(",ps_ref_3="+ps_ref_3);
		sb.append(",ps_mapping_barrier_1="+ps_mapping_barrier_1);
		sb.append(",ps_mapping_barrier_2="+ps_mapping_barrier_2);
		sb.append(",ps_mapping_barrier_3="+ps_mapping_barrier_3);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(map_2_eisStruct other) {
...
map_2_eisStruct map_2_eis = new map_2_eisStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("map_2_eis" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "ps_mapping_eis";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "ps_mapping_eis" + "` (`floc`,`description`,`system_status`,`user_status`,`support_floc`,`ps_ref_1`,`ps_ref_2`,`ps_ref_3`,`ps_mapping_barrier_1`,`ps_mapping_barrier_2`,`ps_mapping_barrier_3`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
map_2_eisStruct map_2_eis_tmp = new map_2_eisStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/ps_mapping_eis.csv"/** End field tFileInputDelimited_1:FILENAME */;		
			...
			if(footer_value_tFileInputDelimited_1 > 0){
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							row1.ps_mapping_barrier_1 = null;
					
							row1.ps_mapping_barrier_2 = null;
					
							row1.ps_mapping_barrier_3 = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.floc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.system_status = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.user_status = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.support_floc = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_ref_1 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_ref_2 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_ref_3 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_mapping_barrier_1 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_mapping_barrier_2 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.ps_mapping_barrier_3 = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
// # Output table : 'map_2_eis'
map_2_eis_tmp.floc = row1.floc;
map_2_eis_tmp.description = row1.description;
map_2_eis_tmp.system_status = row1.system_status;
map_2_eis_tmp.user_status = row1.user_status;
map_2_eis_tmp.support_floc = row1.support_floc;
map_2_eis_tmp.ps_ref_1 = row1.ps_ref_1;
map_2_eis_tmp.ps_ref_2 = row1.ps_ref_2;
map_2_eis_tmp.ps_ref_3 = row1.ps_ref_3;
map_2_eis_tmp.ps_mapping_barrier_1 = row1.ps_mapping_barrier_1;
map_2_eis_tmp.ps_mapping_barrier_2 = row1.ps_mapping_barrier_2;
map_2_eis_tmp.ps_mapping_barrier_3 = row1.ps_mapping_barrier_3;
map_2_eis = map_2_eis_tmp;
// ###############################
...
if(map_2_eis != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//map_2_eis
				...
				if(execStat){
					runStat.updateStatOnConnection("map_2_eis"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(map_2_eis.floc == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, map_2_eis.floc);
}

                            if(map_2_eis.description == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, map_2_eis.description);
}

                            if(map_2_eis.system_status == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, map_2_eis.system_status);
}

                            if(map_2_eis.user_status == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, map_2_eis.user_status);
}

                            if(map_2_eis.support_floc == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, map_2_eis.support_floc);
}

                            if(map_2_eis.ps_ref_1 == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, map_2_eis.ps_ref_1);
}

                            if(map_2_eis.ps_ref_2 == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, map_2_eis.ps_ref_2);
}

                            if(map_2_eis.ps_ref_3 == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, map_2_eis.ps_ref_3);
}

                            if(map_2_eis.ps_mapping_barrier_1 == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, map_2_eis.ps_mapping_barrier_1);
}

                            if(map_2_eis.ps_mapping_barrier_2 == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, map_2_eis.ps_mapping_barrier_2);
}

                            if(map_2_eis.ps_mapping_barrier_3 == null) {
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(11, map_2_eis.ps_mapping_barrier_3);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("map_2_eis"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_ps_mapping_eis jb_land_ps_mapping_eisClass = new jb_land_ps_mapping_eis();

        int exitCode = jb_land_ps_mapping_eisClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_ps_mapping_eis.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_ps_mapping_eis_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_ps_mapping_eis");
        }
...
/************************************************************************************************
 *     94777 characters generated by Talend Open Studio for Data Integration 
