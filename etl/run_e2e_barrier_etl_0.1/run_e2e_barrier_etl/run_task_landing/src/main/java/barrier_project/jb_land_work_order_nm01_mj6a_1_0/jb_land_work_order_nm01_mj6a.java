...
package barrier_project.jb_land_work_order_nm01_mj6a_1_0;
...
/**
 * Job: jb_land_work_order_nm01_mj6a Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_nm01_mj6a implements TalendJob {
...
public String getSource_x_data_home(){
	...
	private final String jobName = "jb_land_work_order_nm01_mj6a";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_nm01_mj6a.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_nm01_mj6a.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("work_order_MJ6A_*.txt");  
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("mj6a", 3, 0);
					}           			
...
public static class mj6aStruct implements routines.system.IPersistableRow<mj6aStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_mj6a) {
     ...
     * Compare keys
     */
    public int compareTo(mj6aStruct other) {
...
mj6aStruct mj6a = new mj6aStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("mj6a" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_nm01_mj6a";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "work_order_nm01_mj6a" + "` (`facility_code`,`order`,`functional_loc`,`description`,`order_type`,`planner_group`,`user_status`,`abc_indic`,`work_center`,`maint_activ_type`,`latest_allow_fin_dat`,`system_status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
mj6aStruct mj6a_tmp = new mj6aStruct();
// ###############################
...
// # Output table : 'mj6a'
mj6a_tmp.facility_code = row1.facility_code ;
mj6a_tmp.order = row1.work_order_number ;
mj6a_tmp.functional_loc = row1.functional_location ;
mj6a_tmp.description = row1.work_order_description ;
mj6a_tmp.order_type = row1.order_type;
mj6a_tmp.planner_group = row1.planner_group;
mj6a_tmp.user_status = row1.user_status;
mj6a_tmp.abc_indic = row1.abc_field ;
mj6a_tmp.work_center = row1.work_centre ;
mj6a_tmp.maint_activ_type = row1.maint_activ_type;
mj6a_tmp.latest_allow_fin_dat = row1.latest_allowable_finish_date ;
mj6a_tmp.system_status = row1.system_status;
mj6a = mj6a_tmp;
// ###############################
...
if(mj6a != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//mj6a
				...
				if(execStat){
					runStat.updateStatOnConnection("mj6a"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(mj6a.facility_code == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, mj6a.facility_code);
}

                            if(mj6a.order == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(2, mj6a.order);
}

                            if(mj6a.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, mj6a.functional_loc);
}

                            if(mj6a.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, mj6a.description);
}

                            if(mj6a.order_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, mj6a.order_type);
}

                            if(mj6a.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, mj6a.planner_group);
}

                            if(mj6a.user_status == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, mj6a.user_status);
}

                            if(mj6a.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else {if(mj6a.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(mj6a.abc_indic == ' '){
pstmt_tMysqlOutput_1.setString(8, "");
} else {
pstmt_tMysqlOutput_1.setString(8, String.valueOf(mj6a.abc_indic));
}}

                            if(mj6a.work_center == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, mj6a.work_center);
}

                            if(mj6a.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, mj6a.maint_activ_type);
}

                            if(mj6a.latest_allow_fin_dat != null) {
date_tMysqlOutput_1 = mj6a.latest_allow_fin_dat.getTime();
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                            ...
                            if(mj6a.system_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, mj6a.system_status);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("mj6a"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_nm01_mj6a jb_land_work_order_nm01_mj6aClass = new jb_land_work_order_nm01_mj6a();

        int exitCode = jb_land_work_order_nm01_mj6aClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_nm01_mj6a.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_nm01_mj6a_1_0/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_nm01_mj6a");
        }
...
/************************************************************************************************
 *     110852 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:46 GMT
 ************************************************************************************************/