...
package barrier_project.run_task_landing_0_1;
...
/**
 * Job: run_task_landing Purpose: runs a task taking into account task dependancies<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class run_task_landing implements TalendJob {
...
public String getBarrier_control_conn_Server(){
	...
	private final String jobName = "run_task_landing";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				run_task_landing.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(run_task_landing.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_run_task_landing = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_run_task_landing = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_run_task_landing.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_run_task_landing.length == 0) {
   					commonByteArray_BARRIER_PROJECT_run_task_landing = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_run_task_landing = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_run_task_landing, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_run_task_landing, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_run_task_landing) {
		...
		String classpathSeparator_tRunJob_1 = System.getProperty("path.separator");
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_ps_mapping_eis_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_ps_mapping_eis_0_1.jb_land_ps_mapping_eis".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_ps_mapping_eis",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_ps_mapping_nm01_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_ps_mapping_nm01_0_1.jb_land_ps_mapping_nm01".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_ps_mapping_nm01",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_eis_map1_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_eis_map1_0_1.jb_land_work_order_eis_map1".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_eis_map1",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_eis_mcp1_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_eis_mcp1_0_1.jb_land_work_order_eis_mcp1".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_eis_mcp1",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_eis_mdp1_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_eis_mdp1_0_1.jb_land_work_order_eis_mdp1".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_eis_mdp1",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_chis_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_chis_1_0.jb_land_work_order_nm01_chis".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_chis",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_f3fa_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_f3fa_1_0.jb_land_work_order_nm01_f3fa".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_f3fa",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_grov_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_grov_1_0.jb_land_work_order_nm01_grov".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_grov",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_grow_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_grow_1_0.jb_land_work_order_nm01_grow".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_grow",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_mj6a_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_mj6a_1_0.jb_land_work_order_nm01_mj6a".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_mj6a",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_mkew_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_mkew_1_0.jb_land_work_order_nm01_mkew".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_mkew",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_mst1_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_mst1_1_0.jb_land_work_order_nm01_mst1".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_mst1",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_stam_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_stam_1_0.jb_land_work_order_nm01_stam".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_stam",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/jakarta-oro-2.0.8.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_land_work_order_nm01_wind_1_0.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_land_work_order_nm01_wind_1_0.jb_land_work_order_nm01_wind".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_land_work_order_nm01_wind",childJob_commandLine_tRunJob_1);	
 ...
 */
    ...
    public static void main(String[] args){
        final run_task_landing run_task_landingClass = new run_task_landing();

        int exitCode = run_task_landingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = run_task_landing.class.getClassLoader().getResourceAsStream("barrier_project/run_task_landing_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : run_task_landing");
        }
...
/************************************************************************************************
 *     91123 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:48 GMT
 ************************************************************************************************/