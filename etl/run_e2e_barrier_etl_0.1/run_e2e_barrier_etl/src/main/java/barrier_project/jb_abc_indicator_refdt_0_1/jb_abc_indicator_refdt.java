...
package barrier_project.jb_abc_indicator_refdt_0_1;
...
/**
 * Job: jb_abc_indicator_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_abc_indicator_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_abc_indicator_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_abc_indicator_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_abc_indicator_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class kkStruct implements routines.system.IPersistableRow<kkStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_abc_indicator_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final kkStruct other = (kkStruct) obj;
	...
	public void copyDataTo(kkStruct other) {
	...
	public void copyKeysDataTo(kkStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_abc_indicator_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_abc_indicator_refdt) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.updated_at = readDate(dis);
						...
						this.current_flag = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.current_flag,dos);
     ...
     * Compare keys
     */
    public int compareTo(kkStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("kk" + iterateId, 0, 0);
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "abc_indicator";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `asset_id`, `updated_at`, `created_at`, `description`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    dateStr_tMysqlSCD_1 = resultSet_tMysqlSCD_1.getString(3);
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.updated_at = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(3).getTime());
                        } else {
                    ...
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.created_at = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(4).getTime());
                        } else {
                            row_tMysqlSCD_1.created_at = (java.util.Date) dateYear0_tMysqlSCD_1.clone();
                        }
                    } else {
                        row_tMysqlSCD_1.created_at = null;
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `asset_id`, `updated_at`, `created_at`, `description`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType1_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `updated_at` = ?, `created_at` = ? WHERE `code` = ? AND `asset_id` = ?";
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `code` = ? AND `asset_id` = ? AND `end_dt` IS NULL";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/abc_indicator_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'kk'
kk_tmp.id = row1.id;
kk_tmp.code = row1.code;
kk_tmp.asset_id = row1.asset_id;
kk_tmp.description = row1.description;
kk_tmp.created_at = row1.created_at;
kk_tmp.updated_at = row1.updated_at;
kk_tmp.current_flag = null;
kk_tmp.start_dt = null;
kk_tmp.end_dt = null;
kk_tmp.version_no = null;
kk = kk_tmp;
// ###############################
...
if(kk != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//kk
				...
				if(execStat){
					runStat.updateStatOnConnection("kk"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = kk.code;
            lookUpKey_tMysqlSCD_1.asset_id = kk.asset_id;
...
insertionStatement_tMysqlSCD_1.setString(1, kk.code);
}

                    insertionStatement_tMysqlSCD_1.setInt(2, kk.asset_id);

                    if(kk.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(kk.updated_at != null) {
date_tMysqlSCD_1 = kk.updated_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
                    ...
                    if(kk.description == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(5, kk.description);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.updated_at == null && kk.updated_at!= null) || ((lookUpValue_tMysqlSCD_1.updated_at != null && kk.updated_at!= null ) && ((( lookUpValue_tMysqlSCD_1.updated_at.getTime()-kk.updated_at.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.updated_at.getTime()-kk.updated_at.getTime() ) < -999) ))  || (lookUpValue_tMysqlSCD_1.created_at == null && kk.created_at!= null) || ((lookUpValue_tMysqlSCD_1.created_at != null && kk.created_at!= null ) && ((( lookUpValue_tMysqlSCD_1.created_at.getTime()-kk.created_at.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.created_at.getTime()-kk.created_at.getTime() ) < -999) )) ) {
                    if(kk.updated_at == null) {
...
updateForType1_tMysqlSCD_1.setNull(1, java.sql.Types.DATE);
                    ...
                    if(kk.created_at == null) {
updateForType1_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
} else {
if(kk.created_at != null) {
date_tMysqlSCD_1 = kk.created_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
updateForType1_tMysqlSCD_1.setString(2, "0000-00-00 00:00:00");
} else {
updateForType1_tMysqlSCD_1.setTimestamp(2, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
updateForType1_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
}
                    ...
                    if(kk.code == null) {
updateForType1_tMysqlSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
updateForType1_tMysqlSCD_1.setString(3, kk.code);
}

                    updateForType1_tMysqlSCD_1.setInt(4, kk.asset_id);

                nb_line_update_tMysqlSCD_1 += updateForType1_tMysqlSCD_1.executeUpdate();
            }
            if((lookUpValue_tMysqlSCD_1.description == null && kk.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(kk.description))) {
                    if(kk.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, kk.code);
}

                    updateForType2_tMysqlSCD_1.setInt(3, kk.asset_id);
...
insertionStatement_tMysqlSCD_1.setString(5, kk.description);
                ...
                lookUpValue_tMysqlSCD_1.updated_at = kk.updated_at;
                lookUpValue_tMysqlSCD_1.created_at = kk.created_at;
                lookUpValue_tMysqlSCD_1.description = kk.description;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("kk"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_abc_indicator_refdt jb_abc_indicator_refdtClass = new jb_abc_indicator_refdt();

        int exitCode = jb_abc_indicator_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_abc_indicator_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_abc_indicator_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_abc_indicator_refdt");
        }
...
/************************************************************************************************
 *     97319 characters generated by Talend Open Studio for Data Integration 
