...
package barrier_project.jb_asset_refdt_0_1;
...
/**
 * Job: jb_asset_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_asset_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_asset_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_asset_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_asset_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_businessunitid_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class scd1Struct implements routines.system.IPersistableRow<scd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_asset_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_asset_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_asset_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_asset_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_asset_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_asset_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_asset_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_asset_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_asset_refdt) {
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "asset";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `name`, `business_unit_id`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        row_tMysqlSCD_1.name = resultSet_tMysqlSCD_1.getString(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.business_unit_id = resultSet_tMysqlSCD_1.getInt(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(4);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `updated_at`, `created_at`, `name`, `business_unit_id`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
            insertionStatement_tMysqlSCD_1.setTimestamp(7, new java.sql.Timestamp(start_Hash.get("tMysqlSCD_1")));
            insertionStatement_tMysqlSCD_1.setNull(8, java.sql.Types.DATE);
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<businessunitidStruct> tHash_Lookup_businessunitid = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<businessunitidStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<businessunitidStruct>) 
					globalMap.get( "tHash_Lookup_businessunitid" ))
					;					
					
	

businessunitidStruct businessunitidHashKey = new businessunitidStruct();
businessunitidStruct businessunitidDefault = new businessunitidStruct();
// ###############################        
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/asset_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.business_unit_id = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'business_unit_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "businessunitid" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopbusinessunitid = false;
       		  	    	
       		  	    	
 							businessunitidStruct businessunitidObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_businessunitid__id = row1.business_unit_id ;
	                        		    	if(exprKeyValue_businessunitid__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			businessunitidHashKey.id = (int)(Integer) exprKeyValue_businessunitid__id;
                        		    		}
                        		    		

								
		                        	businessunitidHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_businessunitid.lookup( businessunitidHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_businessunitid.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_businessunitid != null && tHash_Lookup_businessunitid.getCount(businessunitidHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'businessunitid' and it contains more one result from keys :  businessunitid.id = '" + businessunitidHashKey.id + "'");
								} // G 071
							

							businessunitidStruct businessunitid = null;
                    		  	 
							   
                    		  	 
	       		  	    	businessunitidStruct fromLookup_businessunitid = null;
							businessunitid = businessunitidDefault;
										 
							
								 
							
							
								if (tHash_Lookup_businessunitid !=null && tHash_Lookup_businessunitid.hasNext()) { // G 099
								
							
								
								fromLookup_businessunitid = tHash_Lookup_businessunitid.next();
							...
							if(fromLookup_businessunitid != null) {
								businessunitid = fromLookup_businessunitid;
							}
...
scd1_tmp.business_unit_id = row1.business_unit_id;
...
insertionStatement_tMysqlSCD_1.setString(4, scd1.name);
}

                    insertionStatement_tMysqlSCD_1.setInt(5, scd1.business_unit_id);

                int version_tMysqlSCD_1 = 1;
                insertionStatement_tMysqlSCD_1.setInt(6, version_tMysqlSCD_1);

        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tMysqlSCD_1.name == null && scd1.name!= null) || (lookUpValue_tMysqlSCD_1.name != null && !lookUpValue_tMysqlSCD_1.name.equals(scd1.name)) || lookUpValue_tMysqlSCD_1.business_unit_id != scd1.business_unit_id) {
                    if(scd1.code == null) {
...
insertionStatement_tMysqlSCD_1.setString(4, scd1.name);
                        ...
                        insertionStatement_tMysqlSCD_1.setInt(6, maxVersion_tMysqlSCD_1);
                ...
                lookUpValue_tMysqlSCD_1.name = scd1.name;
                lookUpValue_tMysqlSCD_1.business_unit_id = scd1.business_unit_id;
...
// # Lookup hashes releasing
					if(tHash_Lookup_businessunitid != null) {
						tHash_Lookup_businessunitid.endGet();
					}
					globalMap.remove( "tHash_Lookup_businessunitid" );
...
public static class businessunitidStruct implements routines.system.IPersistableComparableLookupRow<businessunitidStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_asset_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_asset_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final businessunitidStruct other = (businessunitidStruct) obj;
	...
	public void copyDataTo(businessunitidStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(businessunitidStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(businessunitidStruct other) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.current_flag = dis.readBoolean();
						...
						this.version_no = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.version_no,dos);
...
businessunitidStruct businessunitid = new businessunitidStruct();
	...
	/**
	 * [tAdvancedHash_businessunitid begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_businessunitid", false);
		start_Hash.put("tAdvancedHash_businessunitid", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_businessunitid";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("businessunitid" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_businessunitid = 0;
		
    	class BytesLimit65535_tAdvancedHash_businessunitid{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_businessunitid().limitLog4jByte();

			   		// connection name:businessunitid
			   		// source node:tMap_2 - inputs:(row2) outputs:(businessunitid,businessunitid) | target node:tAdvancedHash_businessunitid - inputs:(businessunitid) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,businessunitid) outputs:(scd1)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_businessunitid = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<businessunitidStruct> tHash_Lookup_businessunitid =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<businessunitidStruct>getLookup(matchingModeEnum_businessunitid);
	   						   
		   	   	   globalMap.put("tHash_Lookup_businessunitid", tHash_Lookup_businessunitid);
...
/**
 * [tAdvancedHash_businessunitid begin ] stop
 */
...
// ###############################
// # Outputs initialization
businessunitidStruct businessunitid_tmp = new businessunitidStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT \n  `business_unit`.`id`, \n  `business_unit`.`start_dt`, \n  `business_unit`.`current_flag`, \n  `business_unit`.`version_no`, \n  `business_unit`.`name`, \n  `business_unit`.`description`, \n  `business_unit`.`end_dt`, \n  `business_unit`.`created_at`, \n  `business_unit`.`updated_at`\nFROM `business_unit`";
		...
		try{
	        ...
	        if(rs_tMysqlInput_1.getString(2) != null) {
	            String dateString_tMysqlInput_1 = rs_tMysqlInput_1.getString(2);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.start_dt = rs_tMysqlInput_1.getTimestamp(2);
	            } else {
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row2.current_flag = rs_tMysqlInput_1.getBoolean(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 4) {
								row2.version_no = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row2.version_no = rs_tMysqlInput_1.getInt(4);
            } else {
                    row2.version_no = null;
            }
		                    }
        	...
        	row2.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 6) {
								row2.description = null;
							} else {
	                         		
        	row2.description = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 6, false);
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(7) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.end_dt = rs_tMysqlInput_1.getTimestamp(7);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(8) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.created_at = rs_tMysqlInput_1.getTimestamp(8);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(9) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.updated_at = rs_tMysqlInput_1.getTimestamp(9);
	            } else {
...
// # Output table : 'businessunitid'
businessunitid_tmp.id = row2.id ;
businessunitid = businessunitid_tmp;
// ###############################
 ...
 * [tMap_2 main ] stop
 */
// Start of branch "businessunitid"
if(businessunitid != null) { 
	...
	/**
	 * [tAdvancedHash_businessunitid main ] start
	 */
	...
	currentComponent="tAdvancedHash_businessunitid";
			...
			//businessunitid
				...
				if(execStat){
					runStat.updateStatOnConnection("businessunitid"+iterateId,1, 1);
				} 
					...
					businessunitidStruct businessunitid_HashRow = new businessunitidStruct();
		   	   	   
				
				businessunitid_HashRow.id = businessunitid.id;
				
			tHash_Lookup_businessunitid.put(businessunitid_HashRow);
	...
	tos_count_tAdvancedHash_businessunitid++;

/**
 * [tAdvancedHash_businessunitid main ] stop
 */

} // End of branch "businessunitid"
 ...
 */
	...
	/**
	 * [tAdvancedHash_businessunitid end ] start
	 */
...
tHash_Lookup_businessunitid.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("businessunitid"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_businessunitid", true);
end_Hash.put("tAdvancedHash_businessunitid", System.currentTimeMillis());




/**
 * [tAdvancedHash_businessunitid end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_businessunitid finally ] start
	 */
...
/**
 * [tAdvancedHash_businessunitid finally ] stop
 */
 ...
 */
    ...
    public static void main(String[] args){
        final jb_asset_refdt jb_asset_refdtClass = new jb_asset_refdt();

        int exitCode = jb_asset_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_asset_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_asset_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_asset_refdt");
        }
...
/************************************************************************************************
 *     131037 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 November 2017 14:09:37 GMT
 ************************************************************************************************/