...
package barrier_project.jb_barrier_element_refdt_0_1;
...
/**
 * Job: jb_barrier_element_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_element_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_element_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_element_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_element_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class fgtStruct implements routines.system.IPersistableRow<fgtStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_element_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_element_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_element_refdt) {
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "barrier_element";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `name`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `created_at`, `updated_at`, `name`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, b'1', ?, ?, ?)";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/barrier_element_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'fgt'
fgt_tmp.id = row1.id;
fgt_tmp.start_dt = null;
fgt_tmp.current_flag = false;
fgt_tmp.version_no = 0;
fgt_tmp.name = row1.name;
fgt_tmp.end_dt = null;
fgt_tmp.created_at = row1.created_at;
fgt_tmp.updated_at = row1.updated_at;
fgt_tmp.code = row1.name ;
fgt = fgt_tmp;
// ###############################
...
if(fgt != null) { 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = fgt.code;
...
insertionStatement_tMysqlSCD_1.setString(1, fgt.code);
}
...
if(fgt.created_at != null) {
date_tMysqlSCD_1 = fgt.created_at.getTime();
...
if(fgt.updated_at != null) {
date_tMysqlSCD_1 = fgt.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setString(4, fgt.name);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.name == null && fgt.name!= null) || (lookUpValue_tMysqlSCD_1.name != null && !lookUpValue_tMysqlSCD_1.name.equals(fgt.name))) {
                    if(fgt.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, fgt.code);
}
...
insertionStatement_tMysqlSCD_1.setString(4, fgt.name);
                ...
                lookUpValue_tMysqlSCD_1.name = fgt.name;
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_element_refdt jb_barrier_element_refdtClass = new jb_barrier_element_refdt();

        int exitCode = jb_barrier_element_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_element_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_element_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_element_refdt");
        }
...
/************************************************************************************************
 *     90617 characters generated by Talend Open Studio for Data Integration 
