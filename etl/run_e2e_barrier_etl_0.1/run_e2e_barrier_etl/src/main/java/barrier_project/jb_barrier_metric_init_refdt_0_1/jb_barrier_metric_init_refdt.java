...
package barrier_project.jb_barrier_metric_init_refdt_0_1;
...
/**
 * Job: jb_barrier_metric_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_metric_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_metric_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_metric_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_metric_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class kliStruct implements routines.system.IPersistableRow<kliStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_metric_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final kliStruct other = (kliStruct) obj;
	...
	public void copyDataTo(kliStruct other) {
	...
	public void copyKeysDataTo(kliStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_metric_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_metric_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(kliStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("kli" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "barrier_metric";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "barrier_metric" + "` (`id`,`barrier_element_id`,`name`,`description`,`display_order`,`current_flag`,`version_no`,`start_dt`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `barrier_element_id` = ?,`name` = ?,`description` = ?,`display_order` = ?,`start_dt` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
	    java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1.prepareStatement(insertIgnore_tMysqlOutput_1);
...
kliStruct kli_tmp = new kliStruct();
// ###############################
...
// # Output table : 'kli'
kli_tmp.id = row1.id;
kli_tmp.barrier_element_id = row1.barrier_element_id;
kli_tmp.name = row1.name;
kli_tmp.description = null;
kli_tmp.display_order = row1.display_order;
kli_tmp.current_flag = 1;
kli_tmp.version_no = 1;
kli_tmp.start_dt = Var.var1 ;
kli_tmp.end_dt = null;
kli_tmp.created_at = row1.created_at;
kli_tmp.updated_at = row1.updated_at;
kli = kli_tmp;
// ###############################
...
if(kli != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//kli
				...
				if(execStat){
					runStat.updateStatOnConnection("kli"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setInt(1, kli.id);

                    pstmt_tMysqlOutput_1.setInt(2, kli.barrier_element_id);

                    if(kli.name == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, kli.name);
}

                    if(kli.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, kli.description);
}

                    pstmt_tMysqlOutput_1.setInt(5, kli.display_order);

                    pstmt_tMysqlOutput_1.setInt(6, kli.current_flag);

                    pstmt_tMysqlOutput_1.setInt(7, kli.version_no);

                    if(kli.start_dt != null) {
date_tMysqlOutput_1 = kli.start_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(8, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(8, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.DATE);
}

                    if(kli.end_dt != null) {
date_tMysqlOutput_1 = kli.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                    ...
                    if(kli.created_at != null) {
date_tMysqlOutput_1 = kli.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.DATE);
                    ...
                    if(kli.updated_at != null) {
date_tMysqlOutput_1 = kli.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                    ...
                    pstmt_tMysqlOutput_1.setInt(12, kli.barrier_element_id);

                    if(kli.name == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, kli.name);
}

                    if(kli.description == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, kli.description);
}

                    pstmt_tMysqlOutput_1.setInt(15, kli.display_order);
...
date_tMysqlOutput_1 = kli.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(17, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(17, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(17, java.sql.Types.DATE);
}
...
pstmt_tMysqlOutput_1.setNull(19, java.sql.Types.DATE);
            ...
            try {
                count_on_duplicate_key_tMysqlOutput_1 = pstmt_tMysqlOutput_1.executeUpdate();
            } catch(java.lang.Exception e) {
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("kli"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_metric_init_refdt jb_barrier_metric_init_refdtClass = new jb_barrier_metric_init_refdt();

        int exitCode = jb_barrier_metric_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_metric_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_metric_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_metric_init_refdt");
        }
...
/************************************************************************************************
 *     94858 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 November 2017 14:09:35 GMT
 ************************************************************************************************/