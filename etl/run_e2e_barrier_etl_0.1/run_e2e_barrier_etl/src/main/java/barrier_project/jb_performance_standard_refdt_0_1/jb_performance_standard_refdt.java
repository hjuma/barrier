...
package barrier_project.jb_performance_standard_refdt_0_1;
...
/**
 * Job: jb_performance_standard_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_performance_standard_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_performance_standard_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_performance_standard_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_performance_standard_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_barriertypeid_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class scdStruct implements routines.system.IPersistableRow<scdStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final scdStruct other = (scdStruct) obj;
	...
	public void copyDataTo(scdStruct other) {
	...
	public void copyKeysDataTo(scdStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(scdStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("scd" + iterateId, 0, 0);
...
hashCode = prime * hashCode + asset_id;
hashCode = prime * hashCode + (code == null ? 0 : code.hashCode());
hashCodeDirty = false;
}
return hashCode;
}
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "performance_standard";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `barrier_type_id`, `asset_id`, `code`, `description`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        sk_tMysqlSCD_1.asset_id = resultSet_tMysqlSCD_1.getInt(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        sk_tMysqlSCD_1.code = resultSet_tMysqlSCD_1.getString(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.description = resultSet_tMysqlSCD_1.getString(4);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(5);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`barrier_type_id`, `asset_id`, `code`, `created_at`, `updated_at`, `description`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `barrier_type_id` = ? AND `asset_id` = ? AND `code` = ? AND `end_dt` IS NULL";
...
assetidStruct assetidDefault = new assetidStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barriertypeidStruct> tHash_Lookup_barriertypeid = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barriertypeidStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barriertypeidStruct>) 
					globalMap.get( "tHash_Lookup_barriertypeid" ))
					;					
					
	

barriertypeidStruct barriertypeidHashKey = new barriertypeidStruct();
barriertypeidStruct barriertypeidDefault = new barriertypeidStruct();
// ###############################        
...
scdStruct scd_tmp = new scdStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/performance_standard_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.barrier_type_id = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'barrier_type_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
	...
	currentComponent="tMap_2";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_2 = false;
 					    ...
 					    boolean forceLoopassetid = false;
 							...
 							assetidStruct assetidObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_2 || !tHash_Lookup_assetid.hasNext()) { // G_TM_M_090
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "barriertypeid" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopbarriertypeid = false;
       		  	    	
       		  	    	
 							barriertypeidStruct barriertypeidObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
	                        		    	...
	                        		    	Object exprKeyValue_barriertypeid__id = row1.barrier_type_id ;
	                        		    	if(exprKeyValue_barriertypeid__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_2 = true;
	                        		    	} else {
                        		    			barriertypeidHashKey.id = (int)(Integer) exprKeyValue_barriertypeid__id;
                        		    		}
                        		    		

								
		                        	barriertypeidHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_barriertypeid.lookup( barriertypeidHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_2 || !tHash_Lookup_barriertypeid.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_barriertypeid != null && tHash_Lookup_barriertypeid.getCount(barriertypeidHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'barriertypeid' and it contains more one result from keys :  barriertypeid.id = '" + barriertypeidHashKey.id + "'");
								} // G 071
							

							barriertypeidStruct barriertypeid = null;
                    		  	 
							   
                    		  	 
	       		  	    	barriertypeidStruct fromLookup_barriertypeid = null;
							barriertypeid = barriertypeidDefault;
										 
							
								 
							
							
								if (tHash_Lookup_barriertypeid !=null && tHash_Lookup_barriertypeid.hasNext()) { // G 099
								
							
								
								fromLookup_barriertypeid = tHash_Lookup_barriertypeid.next();
							...
							if(fromLookup_barriertypeid != null) {
								barriertypeid = fromLookup_barriertypeid;
							}
...
// # Output table : 'scd'
scd_tmp.id = row1.id;
scd_tmp.code = row1.code;
scd_tmp.asset_id = row1.asset_id;
scd_tmp.barrier_type_id = row1.barrier_type_id;
scd_tmp.description = row1.description;
scd_tmp.current_flag = 0;
scd_tmp.version_no = 0;
scd_tmp.start_dt = null;
scd_tmp.end_dt = null;
scd_tmp.created_at = row1.created_at;
scd_tmp.updated_at = row1.updated_at;
scd = scd_tmp;
...
if(scd != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//scd
				...
				if(execStat){
					runStat.updateStatOnConnection("scd"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.barrier_type_id = scd.barrier_type_id;
            lookUpKey_tMysqlSCD_1.asset_id = scd.asset_id;
            lookUpKey_tMysqlSCD_1.code = scd.code;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, scd.barrier_type_id);

                    insertionStatement_tMysqlSCD_1.setInt(2, scd.asset_id);

                    if(scd.code == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(3, scd.code);
}

                    if(scd.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
} else {
if(scd.created_at != null) {
date_tMysqlSCD_1 = scd.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
                    ...
                    if(scd.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
} else {
if(scd.updated_at != null) {
date_tMysqlSCD_1 = scd.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
                    ...
                    if(scd.description == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(6, scd.description);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.description == null && scd.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(scd.description))) {
                    updateForType2_tMysqlSCD_1.setInt(2, scd.barrier_type_id);

                    updateForType2_tMysqlSCD_1.setInt(3, scd.asset_id);

                    if(scd.code == null) {
updateForType2_tMysqlSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(4, scd.code);
}
...
insertionStatement_tMysqlSCD_1.setString(6, scd.description);
                ...
                lookUpValue_tMysqlSCD_1.description = scd.description;
...
// # Lookup hashes releasing
					...
					if(tHash_Lookup_barriertypeid != null) {
						tHash_Lookup_barriertypeid.endGet();
					}
					globalMap.remove( "tHash_Lookup_barriertypeid" );
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("scd"+iterateId,2, 0); 
			 	}
			}
...
assetidStruct assetid = new assetidStruct();
	...
	currentComponent="tAdvancedHash_assetid";
        ...
        new BytesLimit65535_tAdvancedHash_assetid().limitLog4jByte();
			   		...
			   		// source node:tMap_1 - inputs:(row3) outputs:(assetid,assetid) | target node:tAdvancedHash_assetid - inputs:(assetid) outputs:()
			   		// linked node: tMap_2 - inputs:(row1,assetid,barriertypeid) outputs:(scd)
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = context.barrier_Password; 
		...
		try{
        	...
        	row3.code = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 2, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 3) {
								row3.business_unit_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(3) != null) {
                row3.business_unit_id = rs_tMysqlInput_2.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 4, false);
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(5) != null) {
                row3.current_flag = rs_tMysqlInput_2.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(6) != null) {
                row3.version_no = rs_tMysqlInput_2.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	        ...
	        if(rs_tMysqlInput_2.getString(7) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.start_dt = rs_tMysqlInput_2.getTimestamp(7);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(8) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.end_dt = rs_tMysqlInput_2.getTimestamp(8);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(9) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.created_at = rs_tMysqlInput_2.getTimestamp(9);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(10) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.updated_at = rs_tMysqlInput_2.getTimestamp(10);
	            } else {
...
public static class barriertypeidStruct implements routines.system.IPersistableComparableLookupRow<barriertypeidStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final barriertypeidStruct other = (barriertypeidStruct) obj;
	...
	public void copyDataTo(barriertypeidStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(barriertypeidStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(barriertypeidStruct other) {
...
barriertypeidStruct barriertypeid = new barriertypeidStruct();
	...
	/**
	 * [tAdvancedHash_barriertypeid begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_barriertypeid", false);
		start_Hash.put("tAdvancedHash_barriertypeid", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_barriertypeid";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("barriertypeid" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_barriertypeid = 0;
		
    	class BytesLimit65535_tAdvancedHash_barriertypeid{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_barriertypeid().limitLog4jByte();

			   		// connection name:barriertypeid
			   		// source node:tMap_3 - inputs:(row2) outputs:(barriertypeid,barriertypeid) | target node:tAdvancedHash_barriertypeid - inputs:(barriertypeid) outputs:()
			   		// linked node: tMap_2 - inputs:(row1,assetid,barriertypeid) outputs:(scd)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_barriertypeid = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barriertypeidStruct> tHash_Lookup_barriertypeid =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<barriertypeidStruct>getLookup(matchingModeEnum_barriertypeid);
	   						   
		   	   	   globalMap.put("tHash_Lookup_barriertypeid", tHash_Lookup_barriertypeid);
...
/**
 * [tAdvancedHash_barriertypeid begin ] stop
 */
...
// ###############################
// # Outputs initialization
barriertypeidStruct barriertypeid_tmp = new barriertypeidStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT \n  `barrier_type`.`id`, \n  `barrier_type`.`asset_id`, \n  `barrier_type`.`barrier_id`, \n  `barrier_type`.`name`, \n  `barrier_type`.`description`, \n  `barrier_type`.`display_order`, \n  `barrier_type`.`current_flag`, \n  `barrier_type`.`version_no`, \n  `barrier_type`.`start_dt`, \n  `barrier_type`.`end_dt`, \n  `barrier_type`.`created_at`, \n  `barrier_type`.`updated_at`\nFROM `barrier_type`";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(2) != null) {
                row2.asset_id = rs_tMysqlInput_1.getInt(2);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row2.barrier_id = rs_tMysqlInput_1.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.description = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 6) {
								row2.display_order = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row2.display_order = rs_tMysqlInput_1.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(7) != null) {
                row2.current_flag = rs_tMysqlInput_1.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(8) != null) {
                row2.version_no = rs_tMysqlInput_1.getInt(8);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(9) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.start_dt = rs_tMysqlInput_1.getTimestamp(9);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(10) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.end_dt = rs_tMysqlInput_1.getTimestamp(10);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(11) != null) {
	            String dateString_tMysqlInput_1 = rs_tMysqlInput_1.getString(11);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.created_at = rs_tMysqlInput_1.getTimestamp(11);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(12) != null) {
	            String dateString_tMysqlInput_1 = rs_tMysqlInput_1.getString(12);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.updated_at = rs_tMysqlInput_1.getTimestamp(12);
	            } else {
...
// # Output table : 'barriertypeid'
barriertypeid_tmp.id = row2.id ;
barriertypeid = barriertypeid_tmp;
// ###############################
...
if(barriertypeid != null) { 
	...
	/**
	 * [tAdvancedHash_barriertypeid main ] start
	 */
	...
	currentComponent="tAdvancedHash_barriertypeid";
			...
			//barriertypeid
				...
				if(execStat){
					runStat.updateStatOnConnection("barriertypeid"+iterateId,1, 1);
				} 
					...
					barriertypeidStruct barriertypeid_HashRow = new barriertypeidStruct();
		   	   	   
				
				barriertypeid_HashRow.id = barriertypeid.id;
				
			tHash_Lookup_barriertypeid.put(barriertypeid_HashRow);
	...
	tos_count_tAdvancedHash_barriertypeid++;

/**
 * [tAdvancedHash_barriertypeid main ] stop
 */

} // End of branch "barriertypeid"
 ...
 */
	...
	/**
	 * [tAdvancedHash_barriertypeid end ] start
	 */
...
tHash_Lookup_barriertypeid.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("barriertypeid"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_barriertypeid", true);
end_Hash.put("tAdvancedHash_barriertypeid", System.currentTimeMillis());




/**
 * [tAdvancedHash_barriertypeid end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_barriertypeid finally ] start
	 */
...
/**
 * [tAdvancedHash_barriertypeid finally ] stop
 */
 ...
 */
    ...
    public static void main(String[] args){
        final jb_performance_standard_refdt jb_performance_standard_refdtClass = new jb_performance_standard_refdt();

        int exitCode = jb_performance_standard_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_performance_standard_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_performance_standard_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_performance_standard_refdt");
        }
...
/************************************************************************************************
 *     166248 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 November 2017 14:09:39 GMT
 ************************************************************************************************/