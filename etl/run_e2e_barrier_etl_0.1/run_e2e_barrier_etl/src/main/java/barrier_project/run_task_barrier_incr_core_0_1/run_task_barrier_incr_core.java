...
package barrier_project.run_task_barrier_incr_core_0_1;
...
/**
 * Job: run_task_barrier_incr_core Purpose: runs a task taking into account task dependancies<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class run_task_barrier_incr_core implements TalendJob {
...
public String getBarrier_control_conn_Server(){
	...
	private final String jobName = "run_task_barrier_incr_core";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				run_task_barrier_incr_core.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(run_task_barrier_incr_core.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_run_task_barrier_incr_core = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core.length == 0) {
   					commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_run_task_barrier_incr_core, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_run_task_barrier_incr_core) {
		...
		String classpathSeparator_tRunJob_1 = System.getProperty("path.separator");
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_abc_indicator_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_abc_indicator_refdt_0_1.jb_abc_indicator_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_abc_indicator_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.0.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;../lib/trove.jar;jb_asset_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_asset_refdt_0_1.jb_asset_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_asset_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_asset_rule_set_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_asset_rule_set_refdt_0_1.jb_asset_rule_set_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_asset_rule_set_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_barrier_element_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_barrier_element_refdt_0_1.jb_barrier_element_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_barrier_element_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_barrier_metric_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_barrier_metric_refdt_0_1.jb_barrier_metric_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_barrier_metric_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_barrier_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_barrier_refdt_0_1.jb_barrier_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_barrier_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.0.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;../lib/trove.jar;jb_barrier_type_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_barrier_type_refdt_0_1.jb_barrier_type_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_barrier_type_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_business_unit_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_business_unit_refdt_0_1.jb_business_unit_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_business_unit_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_facility_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_facility_refdt_0_1.jb_facility_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_facility_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_facility_rule_set_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_facility_rule_set_refdt_0_1.jb_facility_rule_set_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_facility_rule_set_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.0.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;../lib/trove.jar;jb_performance_standard_mapping_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_performance_standard_mapping_refdt_0_1.jb_performance_standard_mapping_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_performance_standard_mapping_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.0.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;../lib/trove.jar;jb_performance_standard_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_performance_standard_refdt_0_1.jb_performance_standard_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_performance_standard_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_planner_group_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_planner_group_refdt_0_1.jb_planner_group_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_planner_group_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_role_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_role_refdt_0_1.jb_role_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_role_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;../lib/talend_file_enhanced_20070724.jar;../lib/talendcsv.jar;jb_user_refdt_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.jb_user_refdt_0_1.jb_user_refdt".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("jb_user_refdt",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;refresh_asset_level_data_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.refresh_asset_level_data_0_1.refresh_asset_level_data".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("refresh_asset_level_data",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;refresh_facility_level_data_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.refresh_facility_level_data_0_1.refresh_facility_level_data".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("refresh_facility_level_data",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;refresh_sap_work_order_data_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.refresh_sap_work_order_data_0_1.refresh_sap_work_order_data".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("refresh_sap_work_order_data",childJob_commandLine_tRunJob_1);	
				...
				childJob_commandLine_tRunJob_1 = new java.util.ArrayList<String>();
				    ...
				    childJob_commandLine_tRunJob_1.add("java");
				    		...
				    		childJob_commandLine_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/dom4j-1.6.1.jar;../lib/log4j-1.2.16.jar;../lib/mysql-connector-java-5.1.30-bin.jar;refresh_work_order_level_data_0_1.jar;sendemailjobprocessstatus_0_1.jar;").replaceAll(";",classpathSeparator_tRunJob_1));
				    
				    		childJob_commandLine_tRunJob_1.add("barrier_project.refresh_work_order_level_data_0_1.refresh_work_order_level_data".replaceAll(";",classpathSeparator_tRunJob_1));
				...
				childJob_commandLine_Mapper_tRunJob_1.put("refresh_work_order_level_data",childJob_commandLine_tRunJob_1);	
 ...
 */
    ...
    public static void main(String[] args){
        final run_task_barrier_incr_core run_task_barrier_incr_coreClass = new run_task_barrier_incr_core();

        int exitCode = run_task_barrier_incr_coreClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = run_task_barrier_incr_core.class.getClassLoader().getResourceAsStream("barrier_project/run_task_barrier_incr_core_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : run_task_barrier_incr_core");
        }
...
/************************************************************************************************
 *     100045 characters generated by Talend Open Studio for Data Integration 
 *     on the 28 November 2017 14:09:41 GMT
 ************************************************************************************************/