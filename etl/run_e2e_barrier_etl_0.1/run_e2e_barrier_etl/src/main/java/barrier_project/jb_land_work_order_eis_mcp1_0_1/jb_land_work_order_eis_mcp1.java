...
package barrier_project.jb_land_work_order_eis_mcp1_0_1;
...
/**
 * Job: jb_land_work_order_eis_mcp1 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_eis_mcp1 implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_land_work_order_eis_mcp1";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_eis_mcp1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_eis_mcp1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map_mcp1_tbStruct implements routines.system.IPersistableRow<map_mcp1_tbStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_eis_mcp1 = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1 = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mcp1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_eis_mcp1) {
     ...
     * Compare keys
     */
    public int compareTo(map_mcp1_tbStruct other) {
...
map_mcp1_tbStruct map_mcp1_tb = new map_mcp1_tbStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("map_mcp1_tb" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_eis_mcp1";
...
map_mcp1_tbStruct map_mcp1_tb_tmp = new map_mcp1_tbStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.etl_data_home+"barrier/database/barrier_landing/data/work_order_eis_mcp1.txt";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.etl_data_home+"barrier/database/barrier_landing/data/work_order_eis_mcp1.txt", "US-ASCII","\t","\n",false,1,0,-1,-1, false);
...
// # Output table : 'map_mcp1_tb'
map_mcp1_tb_tmp.functional_loc = null;
map_mcp1_tb_tmp.description = row1.Description;
map_mcp1_tb_tmp.order_type = row1.Order_Type;
map_mcp1_tb_tmp.Order = row1.Order;
map_mcp1_tb_tmp.maint_activ_type = row1.MaintActivType ;
map_mcp1_tb_tmp.description_4 = row1.Description4 ;
map_mcp1_tb_tmp.planner_group = row1.Planner_group;
map_mcp1_tb_tmp.main_work_ctr = row1.Main_WorkCtr ;
map_mcp1_tb_tmp.user_status = row1.User_status;
map_mcp1_tb_tmp.system_status = row1.System_status;
map_mcp1_tb_tmp.Priority = row1.Priority;
map_mcp1_tb_tmp.estimated_costs = row1.Estimated_costs;
map_mcp1_tb_tmp.total_act_costs = row1.Total_act_costs;
map_mcp1_tb_tmp.total_settlemt = row1.Total_settlemt;
map_mcp1_tb_tmp.total_plnnd_costs = row1.TotalPlnndCosts ;
map_mcp1_tb_tmp.tot_sum_plan = row1.TotSum__plan_ ;
map_mcp1_tb_tmp.total_rev_act = row1.Total_rev__act_ ;
map_mcp1_tb_tmp.tot_plan_rev = row1.Tot__plan__rev_ ;
map_mcp1_tb_tmp.tot_sum_actual = row1.TotSum__actual_ ;
map_mcp1_tb_tmp.abc_indic = row1.ABC_indic_ ;
map_mcp1_tb_tmp.reference_date = row1.Reference_Date;
map_mcp1_tb_tmp.ref_element_pm_ps = row1.Ref__Element_PM_PS ;
map_mcp1_tb_tmp.address_number = row1.Address_number;
map_mcp1_tb_tmp.reference_time = row1.Reference_time;
map_mcp1_tb_tmp.changed_on = row1.Changed_on;
map_mcp1_tb_tmp.changed_by = row1.Changed_by;
map_mcp1_tb_tmp.available_to = row1.Available_to;
map_mcp1_tb_tmp.avail_to_time = row1.Avail__to_time ;
map_mcp1_tb_tmp.asset = row1.Asset;
map_mcp1_tb_tmp.sub_number = row1.Subnumber ;
map_mcp1_tb_tmp.available_from = row1.Available_from;
map_mcp1_tb_tmp.available_from30 = row1.Available_from30;
map_mcp1_tb_tmp.system_condition = row1.SystemCondition ;
map_mcp1_tb_tmp.work_center = row1.Work_center;
map_mcp1_tb_tmp.priority_type = row1.PriorityType ;
map_mcp1_tb_tmp.res_purc_req = row1.Res__Purc__req_ ;
map_mcp1_tb_tmp.subnet_work_of = row1.Subnetwork_of ;
map_mcp1_tb_tmp.order_category = row1.Order_category;
map_mcp1_tb_tmp.plant_wk_cntr = row1.Plant_WkCntr ;
map_mcp1_tb_tmp.assembly = row1.Assembly;
map_mcp1_tb_tmp.assembly_desc = row1.Assembly_desc_ ;
map_mcp1_tb_tmp.plant_section = row1.Plant_section;
map_mcp1_tb_tmp.acctg_indicator = row1.Acctg_Indicator;
map_mcp1_tb_tmp.po_date = row1.PO_date;
map_mcp1_tb_tmp.po_number = row1.PO_number;
map_mcp1_tb_tmp.company_code = row1.Company_Code;
map_mcp1_tb_tmp.city = row1.City;
map_mcp1_tb_tmp.district = row1.District;
map_mcp1_tb_tmp.country = row1.Country;
map_mcp1_tb_tmp.device_data = row1.Device_data;
map_mcp1_tb_tmp.sort_field = row1.Sort_field;
map_mcp1_tb_tmp.description_50 = row1.Description50 ;
map_mcp1_tb_tmp.equipment = row1.Equipment;
map_mcp1_tb_tmp.created_on = row1.Created_on;
map_mcp1_tb_tmp.entered_by = row1.Entered_by;
map_mcp1_tb_tmp.billingform = row1.Billing_form ;
map_mcp1_tb_tmp.actual_release = row1.Actual_release;
map_mcp1_tb_tmp.actual_finish = row1.Actual_Finish;
map_mcp1_tb_tmp.actual_finish1 = row1.Actual_finish ;
map_mcp1_tb_tmp.basic_fin_date = row1.Basic_fin__date ;
map_mcp1_tb_tmp.sched_finish = row1.Sched__finish ;
map_mcp1_tb_tmp.basic_fin_time = row1.Basic_fin__time ;
map_mcp1_tb_tmp.finish_time = row1.Finish_time;
map_mcp1_tb_tmp.business_area = row1.Business_Area;
map_mcp1_tb_tmp.actual_start = row1.Actual_start;
map_mcp1_tb_tmp.bas_start_date = row1.Bas__start_date ;
map_mcp1_tb_tmp.sched_start = row1.Sched__start ;
map_mcp1_tb_tmp.actual_start1 = row1.ActualStart ;
map_mcp1_tb_tmp.start_time = row1.Start_time;
map_mcp1_tb_tmp.sched_start_time = row1.SchedStartTime ;
map_mcp1_tb_tmp.hist_fr = row1.Hist_fr_ ;
map_mcp1_tb_tmp.planning_plant = row1.Planning_plant;
map_mcp1_tb_tmp.costing_sheet = row1.Costing_Sheet;
map_mcp1_tb_tmp.sales_document = row1.Sales_Document;
map_mcp1_tb_tmp.item = row1.Item;
map_mcp1_tb_tmp.co_Area = row1.CO_Area;
map_mcp1_tb_tmp.cost_center = row1.Cost_Center;
map_mcp1_tb_tmp.resp_cost_cntr = row1.Resp__cost_cntr ;
map_mcp1_tb_tmp.customer = row1.Customer;
map_mcp1_tb_tmp.leading_order = row1.Leading_order;
map_mcp1_tb_tmp.deletion_flag = row1.Deletion_flag;
map_mcp1_tb_tmp.long_txt_exists = row1.Long_txt_exists;
map_mcp1_tb_tmp.description_81 = row1.Description81 ;
map_mcp1_tb_tmp.superior_order = row1.Superior_order;
map_mcp1_tb_tmp.base_unit = row1.Base_Unit;
map_mcp1_tb_tmp.quantity = row1.Quantity;
map_mcp1_tb_tmp.room = row1.Room;
map_mcp1_tb_tmp.list_name = row1.List_name;
map_mcp1_tb_tmp.object_number = row1.Object_number;
map_mcp1_tb_tmp.paging_status = row1.Paging_status;
map_mcp1_tb_tmp.pgrp_task_list = row1.PGrp_Task_List;
map_mcp1_tb_tmp.order_plan_ind = row1.OrderPlanInd_ ;
map_mcp1_tb_tmp.group_counter = row1.Group_Counter;
map_mcp1_tb_tmp.group = row1.Group;
map_mcp1_tb_tmp.postal_code = row1.Postal_Code;
map_mcp1_tb_tmp.profit_center = row1.Profit_Center;
map_mcp1_tb_tmp.priority_95 = row1.Priority95 ;
map_mcp1_tb_tmp.wbs_element = row1.WBS_element;
map_mcp1_tb_tmp.wbs_ord_header = row1.WBS_ord__header ;
map_mcp1_tb_tmp.notification = row1.Notification;
map_mcp1_tb_tmp.region = row1.Region;
map_mcp1_tb_tmp.revision = row1.Revision;
map_mcp1_tb_tmp.serial_number = row1.Serial_Number;
map_mcp1_tb_tmp.material = row1.Material;
map_mcp1_tb_tmp.service_product = row1.Service_product;
map_mcp1_tb_tmp.service_product_104 = row1.Service_product104 ;
map_mcp1_tb_tmp.division = row1.Division;
map_mcp1_tb_tmp.division_sales = row1.Division___Sales ;
map_mcp1_tb_tmp.location = row1.Location;
map_mcp1_tb_tmp.street = row1.Street;
map_mcp1_tb_tmp.maint_plant = row1.MaintPlant ;
map_mcp1_tb_tmp.telephone = row1.Telephone;
map_mcp1_tb_tmp.sales_office = row1.Sales_Office;
map_mcp1_tb_tmp.sales_group = row1.Sales_Group;
map_mcp1_tb_tmp.sales_org = row1.Sales_Org_ ;
map_mcp1_tb_tmp.sales_org_sales = row1.Sales_Org____Sales ;
map_mcp1_tb_tmp.superior_act = row1.Superior_act_ ;
map_mcp1_tb_tmp.distr_channel = row1.Distr__Channel ;
map_mcp1_tb_tmp.distr_channel_sal = row1.Distr__Channel___Sal ;
map_mcp1_tb_tmp.currency = row1.Currency;
map_mcp1_tb_tmp.maint_item = row1.MaintItem ;
map_mcp1_tb_tmp.maintenance_plan = row1.MaintenancePlan ;
map_mcp1_tb_tmp.plant = row1.Plant;
map_mcp1_tb_tmp.comp = row1.Comp;
map_mcp1_tb_tmp.overhead_key = row1.Overhead_key;
map_mcp1_tb_tmp.earlst_allow_fin_dat = row1.Earlst_Allow_Fin_Dat;
map_mcp1_tb_tmp.earl_allow_start_dat = row1.Earl_Allow_Start_Dat;
map_mcp1_tb_tmp.latest_allow_fin_dat = row1.Latest_Allow_Fin_Dat;
map_mcp1_tb_tmp.original_due_date = row1.Original_Due_Date;
map_mcp1_tb_tmp.object_list = row1.Object_list;
map_mcp1_tb_tmp.catalog_type = row1.Catalog_type;
map_mcp1_tb_tmp.code_group = row1.Code_group;
map_mcp1_tb_tmp.coding = row1.Coding;
map_mcp1_tb = map_mcp1_tb_tmp;
// ###############################
...
if(map_mcp1_tb != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//map_mcp1_tb
				...
				if(execStat){
					runStat.updateStatOnConnection("map_mcp1_tb"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(map_mcp1_tb.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, map_mcp1_tb.functional_loc);
}

                            if(map_mcp1_tb.description == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, map_mcp1_tb.description);
}

                            if(map_mcp1_tb.order_type == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, map_mcp1_tb.order_type);
}

                            if(map_mcp1_tb.Order == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, map_mcp1_tb.Order);
}

                            if(map_mcp1_tb.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, map_mcp1_tb.maint_activ_type);
}

                            if(map_mcp1_tb.description_4 == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, map_mcp1_tb.description_4);
}

                            if(map_mcp1_tb.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, map_mcp1_tb.planner_group);
}

                            if(map_mcp1_tb.main_work_ctr == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, map_mcp1_tb.main_work_ctr);
}

                            if(map_mcp1_tb.user_status == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, map_mcp1_tb.user_status);
}

                            if(map_mcp1_tb.system_status == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, map_mcp1_tb.system_status);
}

                            if(map_mcp1_tb.Priority == null) {
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(11, map_mcp1_tb.Priority);
}

                            if(map_mcp1_tb.estimated_costs == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, map_mcp1_tb.estimated_costs);
}

                            if(map_mcp1_tb.total_act_costs == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, map_mcp1_tb.total_act_costs);
}

                            if(map_mcp1_tb.total_settlemt == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, map_mcp1_tb.total_settlemt);
}

                            if(map_mcp1_tb.total_plnnd_costs == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, map_mcp1_tb.total_plnnd_costs);
}

                            if(map_mcp1_tb.tot_sum_plan == null) {
pstmt_tMysqlOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(16, map_mcp1_tb.tot_sum_plan);
}

                            if(map_mcp1_tb.total_rev_act == null) {
pstmt_tMysqlOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(17, map_mcp1_tb.total_rev_act);
}

                            if(map_mcp1_tb.tot_plan_rev == null) {
pstmt_tMysqlOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(18, map_mcp1_tb.tot_plan_rev);
}

                            if(map_mcp1_tb.tot_sum_actual == null) {
pstmt_tMysqlOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(19, map_mcp1_tb.tot_sum_actual);
}

                            if(map_mcp1_tb.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(20, map_mcp1_tb.abc_indic);
}

                            if(map_mcp1_tb.reference_date == null) {
pstmt_tMysqlOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(21, map_mcp1_tb.reference_date);
}

                            if(map_mcp1_tb.ref_element_pm_ps == null) {
pstmt_tMysqlOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(22, map_mcp1_tb.ref_element_pm_ps);
}

                            if(map_mcp1_tb.address_number == null) {
pstmt_tMysqlOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(23, map_mcp1_tb.address_number);
}

                            if(map_mcp1_tb.reference_time == null) {
pstmt_tMysqlOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(24, map_mcp1_tb.reference_time);
}

                            if(map_mcp1_tb.changed_on == null) {
pstmt_tMysqlOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(25, map_mcp1_tb.changed_on);
}

                            if(map_mcp1_tb.changed_by == null) {
pstmt_tMysqlOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(26, map_mcp1_tb.changed_by);
}

                            if(map_mcp1_tb.available_to == null) {
pstmt_tMysqlOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(27, map_mcp1_tb.available_to);
}

                            if(map_mcp1_tb.avail_to_time == null) {
pstmt_tMysqlOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(28, map_mcp1_tb.avail_to_time);
}

                            if(map_mcp1_tb.asset == null) {
pstmt_tMysqlOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(29, map_mcp1_tb.asset);
}

                            if(map_mcp1_tb.sub_number == null) {
pstmt_tMysqlOutput_1.setNull(30, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(30, map_mcp1_tb.sub_number);
}

                            if(map_mcp1_tb.available_from == null) {
pstmt_tMysqlOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(31, map_mcp1_tb.available_from);
}

                            if(map_mcp1_tb.available_from30 == null) {
pstmt_tMysqlOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(32, map_mcp1_tb.available_from30);
}

                            if(map_mcp1_tb.system_condition == null) {
pstmt_tMysqlOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(33, map_mcp1_tb.system_condition);
}

                            if(map_mcp1_tb.work_center == null) {
pstmt_tMysqlOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(34, map_mcp1_tb.work_center);
}

                            if(map_mcp1_tb.priority_type == null) {
pstmt_tMysqlOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(35, map_mcp1_tb.priority_type);
}

                            if(map_mcp1_tb.res_purc_req == null) {
pstmt_tMysqlOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(36, map_mcp1_tb.res_purc_req);
}

                            if(map_mcp1_tb.subnet_work_of == null) {
pstmt_tMysqlOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(37, map_mcp1_tb.subnet_work_of);
}

                            if(map_mcp1_tb.order_category == null) {
pstmt_tMysqlOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(38, map_mcp1_tb.order_category);
}

                            if(map_mcp1_tb.plant_wk_cntr == null) {
pstmt_tMysqlOutput_1.setNull(39, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(39, map_mcp1_tb.plant_wk_cntr);
}

                            if(map_mcp1_tb.assembly == null) {
pstmt_tMysqlOutput_1.setNull(40, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(40, map_mcp1_tb.assembly);
}

                            if(map_mcp1_tb.assembly_desc == null) {
pstmt_tMysqlOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(41, map_mcp1_tb.assembly_desc);
}

                            if(map_mcp1_tb.plant_section == null) {
pstmt_tMysqlOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(42, map_mcp1_tb.plant_section);
}

                            if(map_mcp1_tb.acctg_indicator == null) {
pstmt_tMysqlOutput_1.setNull(43, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(43, map_mcp1_tb.acctg_indicator);
}

                            if(map_mcp1_tb.po_date == null) {
pstmt_tMysqlOutput_1.setNull(44, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(44, map_mcp1_tb.po_date);
}

                            if(map_mcp1_tb.po_number == null) {
pstmt_tMysqlOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(45, map_mcp1_tb.po_number);
}

                            if(map_mcp1_tb.company_code == null) {
pstmt_tMysqlOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(46, map_mcp1_tb.company_code);
}

                            if(map_mcp1_tb.city == null) {
pstmt_tMysqlOutput_1.setNull(47, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(47, map_mcp1_tb.city);
}

                            if(map_mcp1_tb.district == null) {
pstmt_tMysqlOutput_1.setNull(48, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(48, map_mcp1_tb.district);
}

                            if(map_mcp1_tb.country == null) {
pstmt_tMysqlOutput_1.setNull(49, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(49, map_mcp1_tb.country);
}

                            if(map_mcp1_tb.device_data == null) {
pstmt_tMysqlOutput_1.setNull(50, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(50, map_mcp1_tb.device_data);
}

                            if(map_mcp1_tb.sort_field == null) {
pstmt_tMysqlOutput_1.setNull(51, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(51, map_mcp1_tb.sort_field);
}

                            if(map_mcp1_tb.description_50 == null) {
pstmt_tMysqlOutput_1.setNull(52, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(52, map_mcp1_tb.description_50);
}

                            if(map_mcp1_tb.equipment == null) {
pstmt_tMysqlOutput_1.setNull(53, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(53, map_mcp1_tb.equipment);
}

                            if(map_mcp1_tb.created_on == null) {
pstmt_tMysqlOutput_1.setNull(54, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(54, map_mcp1_tb.created_on);
}

                            if(map_mcp1_tb.entered_by == null) {
pstmt_tMysqlOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(55, map_mcp1_tb.entered_by);
}

                            if(map_mcp1_tb.billingform == null) {
pstmt_tMysqlOutput_1.setNull(56, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(56, map_mcp1_tb.billingform);
}

                            if(map_mcp1_tb.actual_release == null) {
pstmt_tMysqlOutput_1.setNull(57, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(57, map_mcp1_tb.actual_release);
}

                            if(map_mcp1_tb.actual_finish == null) {
pstmt_tMysqlOutput_1.setNull(58, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(58, map_mcp1_tb.actual_finish);
}

                            if(map_mcp1_tb.actual_finish1 == null) {
pstmt_tMysqlOutput_1.setNull(59, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(59, map_mcp1_tb.actual_finish1);
}

                            if(map_mcp1_tb.basic_fin_date == null) {
pstmt_tMysqlOutput_1.setNull(60, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(60, map_mcp1_tb.basic_fin_date);
}

                            if(map_mcp1_tb.sched_finish == null) {
pstmt_tMysqlOutput_1.setNull(61, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(61, map_mcp1_tb.sched_finish);
}

                            if(map_mcp1_tb.basic_fin_time == null) {
pstmt_tMysqlOutput_1.setNull(62, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(62, map_mcp1_tb.basic_fin_time);
}

                            if(map_mcp1_tb.finish_time == null) {
pstmt_tMysqlOutput_1.setNull(63, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(63, map_mcp1_tb.finish_time);
}

                            if(map_mcp1_tb.business_area == null) {
pstmt_tMysqlOutput_1.setNull(64, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(64, map_mcp1_tb.business_area);
}

                            if(map_mcp1_tb.actual_start == null) {
pstmt_tMysqlOutput_1.setNull(65, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(65, map_mcp1_tb.actual_start);
}

                            if(map_mcp1_tb.bas_start_date == null) {
pstmt_tMysqlOutput_1.setNull(66, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(66, map_mcp1_tb.bas_start_date);
}

                            if(map_mcp1_tb.sched_start == null) {
pstmt_tMysqlOutput_1.setNull(67, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(67, map_mcp1_tb.sched_start);
}

                            if(map_mcp1_tb.actual_start1 == null) {
pstmt_tMysqlOutput_1.setNull(68, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(68, map_mcp1_tb.actual_start1);
}

                            if(map_mcp1_tb.start_time == null) {
pstmt_tMysqlOutput_1.setNull(69, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(69, map_mcp1_tb.start_time);
}

                            if(map_mcp1_tb.sched_start_time == null) {
pstmt_tMysqlOutput_1.setNull(70, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(70, map_mcp1_tb.sched_start_time);
}

                            if(map_mcp1_tb.hist_fr == null) {
pstmt_tMysqlOutput_1.setNull(71, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(71, map_mcp1_tb.hist_fr);
}

                            if(map_mcp1_tb.planning_plant == null) {
pstmt_tMysqlOutput_1.setNull(72, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(72, map_mcp1_tb.planning_plant);
}

                            if(map_mcp1_tb.costing_sheet == null) {
pstmt_tMysqlOutput_1.setNull(73, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(73, map_mcp1_tb.costing_sheet);
}

                            if(map_mcp1_tb.sales_document == null) {
pstmt_tMysqlOutput_1.setNull(74, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(74, map_mcp1_tb.sales_document);
}

                            if(map_mcp1_tb.item == null) {
pstmt_tMysqlOutput_1.setNull(75, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(75, map_mcp1_tb.item);
}

                            if(map_mcp1_tb.co_Area == null) {
pstmt_tMysqlOutput_1.setNull(76, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(76, map_mcp1_tb.co_Area);
}

                            if(map_mcp1_tb.cost_center == null) {
pstmt_tMysqlOutput_1.setNull(77, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(77, map_mcp1_tb.cost_center);
}

                            if(map_mcp1_tb.resp_cost_cntr == null) {
pstmt_tMysqlOutput_1.setNull(78, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(78, map_mcp1_tb.resp_cost_cntr);
}

                            if(map_mcp1_tb.customer == null) {
pstmt_tMysqlOutput_1.setNull(79, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(79, map_mcp1_tb.customer);
}

                            if(map_mcp1_tb.leading_order == null) {
pstmt_tMysqlOutput_1.setNull(80, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(80, map_mcp1_tb.leading_order);
}

                            if(map_mcp1_tb.deletion_flag == null) {
pstmt_tMysqlOutput_1.setNull(81, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(81, map_mcp1_tb.deletion_flag);
}

                            if(map_mcp1_tb.long_txt_exists == null) {
pstmt_tMysqlOutput_1.setNull(82, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(82, map_mcp1_tb.long_txt_exists);
}

                            if(map_mcp1_tb.description_81 == null) {
pstmt_tMysqlOutput_1.setNull(83, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(83, map_mcp1_tb.description_81);
}

                            if(map_mcp1_tb.superior_order == null) {
pstmt_tMysqlOutput_1.setNull(84, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(84, map_mcp1_tb.superior_order);
}

                            if(map_mcp1_tb.base_unit == null) {
pstmt_tMysqlOutput_1.setNull(85, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(85, map_mcp1_tb.base_unit);
}

                            if(map_mcp1_tb.quantity == null) {
pstmt_tMysqlOutput_1.setNull(86, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(86, map_mcp1_tb.quantity);
}

                            if(map_mcp1_tb.room == null) {
pstmt_tMysqlOutput_1.setNull(87, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(87, map_mcp1_tb.room);
}

                            if(map_mcp1_tb.list_name == null) {
pstmt_tMysqlOutput_1.setNull(88, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(88, map_mcp1_tb.list_name);
}

                            if(map_mcp1_tb.object_number == null) {
pstmt_tMysqlOutput_1.setNull(89, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(89, map_mcp1_tb.object_number);
}

                            if(map_mcp1_tb.paging_status == null) {
pstmt_tMysqlOutput_1.setNull(90, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(90, map_mcp1_tb.paging_status);
}

                            if(map_mcp1_tb.pgrp_task_list == null) {
pstmt_tMysqlOutput_1.setNull(91, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(91, map_mcp1_tb.pgrp_task_list);
}

                            if(map_mcp1_tb.order_plan_ind == null) {
pstmt_tMysqlOutput_1.setNull(92, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(92, map_mcp1_tb.order_plan_ind);
}

                            if(map_mcp1_tb.group_counter == null) {
pstmt_tMysqlOutput_1.setNull(93, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(93, map_mcp1_tb.group_counter);
}

                            if(map_mcp1_tb.group == null) {
pstmt_tMysqlOutput_1.setNull(94, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(94, map_mcp1_tb.group);
}

                            if(map_mcp1_tb.postal_code == null) {
pstmt_tMysqlOutput_1.setNull(95, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(95, map_mcp1_tb.postal_code);
}

                            if(map_mcp1_tb.profit_center == null) {
pstmt_tMysqlOutput_1.setNull(96, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(96, map_mcp1_tb.profit_center);
}

                            if(map_mcp1_tb.priority_95 == null) {
pstmt_tMysqlOutput_1.setNull(97, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(97, map_mcp1_tb.priority_95);
}

                            if(map_mcp1_tb.wbs_element == null) {
pstmt_tMysqlOutput_1.setNull(98, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(98, map_mcp1_tb.wbs_element);
}

                            if(map_mcp1_tb.wbs_ord_header == null) {
pstmt_tMysqlOutput_1.setNull(99, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(99, map_mcp1_tb.wbs_ord_header);
}

                            if(map_mcp1_tb.notification == null) {
pstmt_tMysqlOutput_1.setNull(100, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(100, map_mcp1_tb.notification);
}

                            if(map_mcp1_tb.region == null) {
pstmt_tMysqlOutput_1.setNull(101, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(101, map_mcp1_tb.region);
}

                            if(map_mcp1_tb.revision == null) {
pstmt_tMysqlOutput_1.setNull(102, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(102, map_mcp1_tb.revision);
}

                            if(map_mcp1_tb.serial_number == null) {
pstmt_tMysqlOutput_1.setNull(103, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(103, map_mcp1_tb.serial_number);
}

                            if(map_mcp1_tb.material == null) {
pstmt_tMysqlOutput_1.setNull(104, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(104, map_mcp1_tb.material);
}

                            if(map_mcp1_tb.service_product == null) {
pstmt_tMysqlOutput_1.setNull(105, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(105, map_mcp1_tb.service_product);
}

                            if(map_mcp1_tb.service_product_104 == null) {
pstmt_tMysqlOutput_1.setNull(106, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(106, map_mcp1_tb.service_product_104);
}

                            if(map_mcp1_tb.division == null) {
pstmt_tMysqlOutput_1.setNull(107, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(107, map_mcp1_tb.division);
}

                            if(map_mcp1_tb.division_sales == null) {
pstmt_tMysqlOutput_1.setNull(108, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(108, map_mcp1_tb.division_sales);
}

                            if(map_mcp1_tb.location == null) {
pstmt_tMysqlOutput_1.setNull(109, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(109, map_mcp1_tb.location);
}

                            if(map_mcp1_tb.street == null) {
pstmt_tMysqlOutput_1.setNull(110, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(110, map_mcp1_tb.street);
}

                            if(map_mcp1_tb.maint_plant == null) {
pstmt_tMysqlOutput_1.setNull(111, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(111, map_mcp1_tb.maint_plant);
}

                            if(map_mcp1_tb.telephone == null) {
pstmt_tMysqlOutput_1.setNull(112, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(112, map_mcp1_tb.telephone);
}

                            if(map_mcp1_tb.sales_office == null) {
pstmt_tMysqlOutput_1.setNull(113, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(113, map_mcp1_tb.sales_office);
}

                            if(map_mcp1_tb.sales_group == null) {
pstmt_tMysqlOutput_1.setNull(114, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(114, map_mcp1_tb.sales_group);
}

                            if(map_mcp1_tb.sales_org == null) {
pstmt_tMysqlOutput_1.setNull(115, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(115, map_mcp1_tb.sales_org);
}

                            if(map_mcp1_tb.sales_org_sales == null) {
pstmt_tMysqlOutput_1.setNull(116, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(116, map_mcp1_tb.sales_org_sales);
}

                            if(map_mcp1_tb.superior_act == null) {
pstmt_tMysqlOutput_1.setNull(117, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(117, map_mcp1_tb.superior_act);
}

                            if(map_mcp1_tb.distr_channel == null) {
pstmt_tMysqlOutput_1.setNull(118, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(118, map_mcp1_tb.distr_channel);
}

                            if(map_mcp1_tb.distr_channel_sal == null) {
pstmt_tMysqlOutput_1.setNull(119, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(119, map_mcp1_tb.distr_channel_sal);
}

                            if(map_mcp1_tb.currency == null) {
pstmt_tMysqlOutput_1.setNull(120, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(120, map_mcp1_tb.currency);
}

                            if(map_mcp1_tb.maint_item == null) {
pstmt_tMysqlOutput_1.setNull(121, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(121, map_mcp1_tb.maint_item);
}

                            if(map_mcp1_tb.maintenance_plan == null) {
pstmt_tMysqlOutput_1.setNull(122, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(122, map_mcp1_tb.maintenance_plan);
}

                            if(map_mcp1_tb.plant == null) {
pstmt_tMysqlOutput_1.setNull(123, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(123, map_mcp1_tb.plant);
}

                            if(map_mcp1_tb.comp == null) {
pstmt_tMysqlOutput_1.setNull(124, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(124, map_mcp1_tb.comp);
}

                            if(map_mcp1_tb.overhead_key == null) {
pstmt_tMysqlOutput_1.setNull(125, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(125, map_mcp1_tb.overhead_key);
}

                            if(map_mcp1_tb.earlst_allow_fin_dat == null) {
pstmt_tMysqlOutput_1.setNull(126, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(126, map_mcp1_tb.earlst_allow_fin_dat);
}

                            if(map_mcp1_tb.earl_allow_start_dat == null) {
pstmt_tMysqlOutput_1.setNull(127, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(127, map_mcp1_tb.earl_allow_start_dat);
}

                            if(map_mcp1_tb.latest_allow_fin_dat == null) {
pstmt_tMysqlOutput_1.setNull(128, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(128, map_mcp1_tb.latest_allow_fin_dat);
}

                            if(map_mcp1_tb.original_due_date == null) {
pstmt_tMysqlOutput_1.setNull(129, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(129, map_mcp1_tb.original_due_date);
}

                            if(map_mcp1_tb.object_list == null) {
pstmt_tMysqlOutput_1.setNull(130, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(130, map_mcp1_tb.object_list);
}

                            if(map_mcp1_tb.catalog_type == null) {
pstmt_tMysqlOutput_1.setNull(131, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(131, map_mcp1_tb.catalog_type);
}

                            if(map_mcp1_tb.code_group == null) {
pstmt_tMysqlOutput_1.setNull(132, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(132, map_mcp1_tb.code_group);
}

                            if(map_mcp1_tb.coding == null) {
pstmt_tMysqlOutput_1.setNull(133, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(133, map_mcp1_tb.coding);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.etl_data_home+"barrier/database/barrier_landing/data/work_order_eis_mcp1.txt") instanceof java.io.InputStream)){
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("map_mcp1_tb"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_eis_mcp1 jb_land_work_order_eis_mcp1Class = new jb_land_work_order_eis_mcp1();

        int exitCode = jb_land_work_order_eis_mcp1Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_eis_mcp1.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_eis_mcp1_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_eis_mcp1");
        }
...
/************************************************************************************************
 *     211176 characters generated by Talend Open Studio for Data Integration 
