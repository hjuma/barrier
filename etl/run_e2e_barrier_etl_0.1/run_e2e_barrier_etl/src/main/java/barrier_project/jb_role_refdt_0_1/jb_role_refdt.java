...
package barrier_project.jb_role_refdt_0_1;
...
/**
 * Job: jb_role_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_role_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_role_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_role_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_role_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class df1Struct implements routines.system.IPersistableRow<df1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_role_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_role_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_role_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_role_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_role_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_role_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_role_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_role_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_role_refdt) {
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "role";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"/barrier/database/barrier_landing/data/role_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'df1'
df1_tmp.id = row1.id;
df1_tmp.current_flag = false;
df1_tmp.start_dt = null;
df1_tmp.version_no = 0;
df1_tmp.name = row1.name;
df1_tmp.description = row1.description;
df1_tmp.end_dt = null;
df1_tmp.created_at = row1.created_at;
df1_tmp.updated_at = row1.updated_at;
df1 = df1_tmp;
// ###############################
...
if(df1 != null) { 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.name = df1.name;
...
insertionStatement_tMysqlSCD_1.setString(1, df1.name);
}

                    if(df1.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
} else {
if(df1.created_at != null) {
date_tMysqlSCD_1 = df1.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
                    ...
                    if(df1.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(df1.updated_at != null) {
date_tMysqlSCD_1 = df1.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
                    ...
                    if(df1.description == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(4, df1.description);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.description == null && df1.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(df1.description))) {
                    if(df1.name == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, df1.name);
}
...
insertionStatement_tMysqlSCD_1.setString(4, df1.description);
                ...
                lookUpValue_tMysqlSCD_1.description = df1.description;
 ...
 */
    ...
    public static void main(String[] args){
        final jb_role_refdt jb_role_refdtClass = new jb_role_refdt();

        int exitCode = jb_role_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_role_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_role_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_role_refdt");
        }
...
/************************************************************************************************
 *     91146 characters generated by Talend Open Studio for Data Integration 
