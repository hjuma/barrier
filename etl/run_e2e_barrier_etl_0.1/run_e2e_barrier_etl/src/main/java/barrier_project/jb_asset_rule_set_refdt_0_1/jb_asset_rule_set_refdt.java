...
package barrier_project.jb_asset_rule_set_refdt_0_1;
...
/**
 * Job: jb_asset_rule_set_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_asset_rule_set_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_asset_rule_set_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_asset_rule_set_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_asset_rule_set_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class scd1Struct implements routines.system.IPersistableRow<scd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_asset_rule_set_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_asset_rule_set_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_asset_rule_set_refdt) {
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "asset_rule_set";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `id`, `amber_end`, `amber_start`, `barrier_id`, `update_comment`, `updated_by`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.id = resultSet_tMysqlSCD_1.getInt(1);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        row_tMysqlSCD_1.amber_end = resultSet_tMysqlSCD_1.getInt(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.amber_start = resultSet_tMysqlSCD_1.getInt(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.barrier_id = resultSet_tMysqlSCD_1.getInt(4);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.update_comment = resultSet_tMysqlSCD_1.getString(5);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(6) != null) {
                        row_tMysqlSCD_1.updated_by = resultSet_tMysqlSCD_1.getString(6);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(7) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(7);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`id`, `amber_end`, `amber_start`, `barrier_id`, `update_comment`, `updated_by`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `id` = ? AND `end_dt` IS NULL";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/asset_rule_set_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(temp.length() > 0){
										row1.update_comment = temp;
									}else{
										row1.update_comment = "Initial system load";
									}
...
// # Output table : 'scd1'
scd1_tmp.id = row1.id;
scd1_tmp.version_no = row1.version ;
scd1_tmp.barrier_id = row1.barrier_id;
scd1_tmp.amber_start = row1.amber_start;
scd1_tmp.amber_end = row1.amber_end;
scd1_tmp.updated_by = row1.updated_by;
scd1_tmp.update_comment = row1.update_comment;
scd1_tmp.current_flag = row1.current_flag;
scd1_tmp.start_dt = row1.start_dt;
scd1_tmp.end_dt = row1.end_dt;
scd1 = scd1_tmp;
// ###############################
...
if(scd1 != null) { 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.id = scd1.id;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, scd1.id);

                    insertionStatement_tMysqlSCD_1.setInt(2, scd1.amber_end);

                    insertionStatement_tMysqlSCD_1.setInt(3, scd1.amber_start);

                    insertionStatement_tMysqlSCD_1.setInt(4, scd1.barrier_id);

                    if(scd1.update_comment == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(5, scd1.update_comment);
}

                    if(scd1.updated_by == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(6, scd1.updated_by);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if(lookUpValue_tMysqlSCD_1.amber_end != scd1.amber_end || lookUpValue_tMysqlSCD_1.amber_start != scd1.amber_start || lookUpValue_tMysqlSCD_1.barrier_id != scd1.barrier_id || (lookUpValue_tMysqlSCD_1.update_comment == null && scd1.update_comment!= null) || (lookUpValue_tMysqlSCD_1.update_comment != null && !lookUpValue_tMysqlSCD_1.update_comment.equals(scd1.update_comment)) || (lookUpValue_tMysqlSCD_1.updated_by == null && scd1.updated_by!= null) || (lookUpValue_tMysqlSCD_1.updated_by != null && !lookUpValue_tMysqlSCD_1.updated_by.equals(scd1.updated_by))) {
                    updateForType2_tMysqlSCD_1.setInt(2, scd1.id);
...
insertionStatement_tMysqlSCD_1.setString(6, scd1.updated_by);
                ...
                lookUpValue_tMysqlSCD_1.amber_end = scd1.amber_end;
                lookUpValue_tMysqlSCD_1.amber_start = scd1.amber_start;
                lookUpValue_tMysqlSCD_1.barrier_id = scd1.barrier_id;
                lookUpValue_tMysqlSCD_1.update_comment = scd1.update_comment;
                lookUpValue_tMysqlSCD_1.updated_by = scd1.updated_by;
 ...
 */
    ...
    public static void main(String[] args){
        final jb_asset_rule_set_refdt jb_asset_rule_set_refdtClass = new jb_asset_rule_set_refdt();

        int exitCode = jb_asset_rule_set_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_asset_rule_set_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_asset_rule_set_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_asset_rule_set_refdt");
        }
...
/************************************************************************************************
 *     98534 characters generated by Talend Open Studio for Data Integration 
