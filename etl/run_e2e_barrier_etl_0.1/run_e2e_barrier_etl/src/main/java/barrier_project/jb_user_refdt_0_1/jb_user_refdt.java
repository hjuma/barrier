...
package barrier_project.jb_user_refdt_0_1;
...
/**
 * Job: jb_user_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_user_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_user_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_user_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_user_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class sd1Struct implements routines.system.IPersistableRow<sd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_user_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_user_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final sd1Struct other = (sd1Struct) obj;
	...
	public void copyDataTo(sd1Struct other) {
	...
	public void copyKeysDataTo(sd1Struct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_user_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_user_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_user_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_user_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_user_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_user_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_user_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(sd1Struct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("sd1" + iterateId, 0, 0);
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + (username == null ? 0 : username.hashCode());
hashCodeDirty = false;
}
return hashCode;
}
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "user";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `username`, `business_unit_id`, `email`, `first_name`, `last_login`, `salt`, `last_name`, `password`, `role_id`, `status`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.username = resultSet_tMysqlSCD_1.getString(1);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        row_tMysqlSCD_1.business_unit_id = resultSet_tMysqlSCD_1.getInt(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.email = resultSet_tMysqlSCD_1.getString(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.first_name = resultSet_tMysqlSCD_1.getString(4);
                    }
                    dateStr_tMysqlSCD_1 = resultSet_tMysqlSCD_1.getString(5);
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.last_login = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(5).getTime());
                        } else {
                            row_tMysqlSCD_1.last_login = (java.util.Date) dateYear0_tMysqlSCD_1.clone();
                        }
                    } else {
                        row_tMysqlSCD_1.last_login = null;
                    }
                    if(resultSet_tMysqlSCD_1.getObject(6) != null) {
                        row_tMysqlSCD_1.salt = resultSet_tMysqlSCD_1.getString(6);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(7) != null) {
                        row_tMysqlSCD_1.last_name = resultSet_tMysqlSCD_1.getString(7);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(8) != null) {
                        row_tMysqlSCD_1.password = resultSet_tMysqlSCD_1.getString(8);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(9) != null) {
                        row_tMysqlSCD_1.role_id = resultSet_tMysqlSCD_1.getInt(9);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(10) != null) {
                        row_tMysqlSCD_1.status = resultSet_tMysqlSCD_1.getObject(10);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(11) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(11);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`username`, `created_at`, `updated_at`, `business_unit_id`, `email`, `first_name`, `last_login`, `salt`, `last_name`, `password`, `role_id`, `status`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
            insertionStatement_tMysqlSCD_1.setTimestamp(14, new java.sql.Timestamp(start_Hash.get("tMysqlSCD_1")));
            insertionStatement_tMysqlSCD_1.setNull(15, java.sql.Types.DATE);
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `username` = ? AND `end_dt` IS NULL";
...
sd1Struct sd1_tmp = new sd1Struct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/user_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.role_id = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'role_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.username = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.password = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.salt = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.last_login = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "yyyy-MM-dd HH:mm:ss");
...
// # Output table : 'sd1'
sd1_tmp.id = row1.id;
sd1_tmp.current_flag = false;
sd1_tmp.start_dt = null;
sd1_tmp.version_no = 0;
sd1_tmp.business_unit_id = row1.business_unit_id;
sd1_tmp.role_id = row1.role_id;
sd1_tmp.first_name = row1.first_name;
sd1_tmp.last_name = row1.last_name;
sd1_tmp.username = row1.username;
sd1_tmp.email = row1.email;
sd1_tmp.password = row1.password;
sd1_tmp.salt = row1.salt;
sd1_tmp.last_login = row1.last_login;
sd1_tmp.status = row1.status;
sd1_tmp.end_dt = null;
sd1_tmp.created_at = row1.created_at;
sd1_tmp.updated_at = row1.updated_at;
sd1 = sd1_tmp;
// ###############################
...
if(sd1 != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//sd1
				...
				if(execStat){
					runStat.updateStatOnConnection("sd1"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.username = sd1.username;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    if(sd1.username == null) {
insertionStatement_tMysqlSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(1, sd1.username);
}

                    if(sd1.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
} else {
if(sd1.created_at != null) {
date_tMysqlSCD_1 = sd1.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
                    ...
                    if(sd1.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(sd1.updated_at != null) {
date_tMysqlSCD_1 = sd1.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(4, sd1.business_unit_id);

                    if(sd1.email == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(5, sd1.email);
}

                    if(sd1.first_name == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(6, sd1.first_name);
}

                    if(sd1.last_login == null) {
insertionStatement_tMysqlSCD_1.setNull(7, java.sql.Types.DATE);
} else {
if(sd1.last_login != null) {
date_tMysqlSCD_1 = sd1.last_login.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
insertionStatement_tMysqlSCD_1.setString(7, "0000-00-00 00:00:00");
} else {
insertionStatement_tMysqlSCD_1.setTimestamp(7, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
insertionStatement_tMysqlSCD_1.setNull(7, java.sql.Types.DATE);
}
...
insertionStatement_tMysqlSCD_1.setString(8, sd1.salt);
}

                    if(sd1.last_name == null) {
insertionStatement_tMysqlSCD_1.setNull(9, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(9, sd1.last_name);
}

                    if(sd1.password == null) {
insertionStatement_tMysqlSCD_1.setNull(10, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(10, sd1.password);
}

                    insertionStatement_tMysqlSCD_1.setInt(11, sd1.role_id);

                    if(sd1.status == null) {
insertionStatement_tMysqlSCD_1.setNull(12, java.sql.Types.OTHER);
} else {
insertionStatement_tMysqlSCD_1.setObject(12, sd1.status);
}

                int version_tMysqlSCD_1 = 1;
                insertionStatement_tMysqlSCD_1.setInt(13, version_tMysqlSCD_1);

        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
    } else {
            if(lookUpValue_tMysqlSCD_1.business_unit_id != sd1.business_unit_id || (lookUpValue_tMysqlSCD_1.email == null && sd1.email!= null) || (lookUpValue_tMysqlSCD_1.email != null && !lookUpValue_tMysqlSCD_1.email.equals(sd1.email)) || (lookUpValue_tMysqlSCD_1.first_name == null && sd1.first_name!= null) || (lookUpValue_tMysqlSCD_1.first_name != null && !lookUpValue_tMysqlSCD_1.first_name.equals(sd1.first_name)) || (lookUpValue_tMysqlSCD_1.last_login == null && sd1.last_login!= null) || ( ( lookUpValue_tMysqlSCD_1.last_login != null && sd1.last_login!= null ) && ( (( lookUpValue_tMysqlSCD_1.last_login.getTime()-sd1.last_login.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.last_login.getTime()-sd1.last_login.getTime() ) < -999) ))  || (lookUpValue_tMysqlSCD_1.salt == null && sd1.salt!= null) || (lookUpValue_tMysqlSCD_1.salt != null && !lookUpValue_tMysqlSCD_1.salt.equals(sd1.salt)) || (lookUpValue_tMysqlSCD_1.last_name == null && sd1.last_name!= null) || (lookUpValue_tMysqlSCD_1.last_name != null && !lookUpValue_tMysqlSCD_1.last_name.equals(sd1.last_name)) || (lookUpValue_tMysqlSCD_1.password == null && sd1.password!= null) || (lookUpValue_tMysqlSCD_1.password != null && !lookUpValue_tMysqlSCD_1.password.equals(sd1.password)) || lookUpValue_tMysqlSCD_1.role_id != sd1.role_id || (lookUpValue_tMysqlSCD_1.status == null && sd1.status!= null) || (lookUpValue_tMysqlSCD_1.status != null && !lookUpValue_tMysqlSCD_1.status.equals(sd1.status))) {
                    if(sd1.username == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, sd1.username);
}
...
insertionStatement_tMysqlSCD_1.setObject(12, sd1.status);
                        ...
                        insertionStatement_tMysqlSCD_1.setInt(13, maxVersion_tMysqlSCD_1);
                ...
                lookUpValue_tMysqlSCD_1.business_unit_id = sd1.business_unit_id;
                lookUpValue_tMysqlSCD_1.email = sd1.email;
                lookUpValue_tMysqlSCD_1.first_name = sd1.first_name;
                lookUpValue_tMysqlSCD_1.last_login = sd1.last_login;
                lookUpValue_tMysqlSCD_1.salt = sd1.salt;
                lookUpValue_tMysqlSCD_1.last_name = sd1.last_name;
                lookUpValue_tMysqlSCD_1.password = sd1.password;
                lookUpValue_tMysqlSCD_1.role_id = sd1.role_id;
                lookUpValue_tMysqlSCD_1.status = sd1.status;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("sd1"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_user_refdt jb_user_refdtClass = new jb_user_refdt();

        int exitCode = jb_user_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_user_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_user_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_user_refdt");
        }
...
/************************************************************************************************
 *     109190 characters generated by Talend Open Studio for Data Integration 
