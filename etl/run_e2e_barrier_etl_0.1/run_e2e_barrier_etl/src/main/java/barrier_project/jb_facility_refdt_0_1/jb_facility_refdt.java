...
package barrier_project.jb_facility_refdt_0_1;
...
/**
 * Job: jb_facility_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_facility_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_facility_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_facility_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_facility_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class scStruct implements routines.system.IPersistableRow<scStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_facility_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_facility_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final scStruct other = (scStruct) obj;
	...
	public void copyDataTo(scStruct other) {
	...
	public void copyKeysDataTo(scStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_facility_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_facility_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_facility_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_facility_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_facility_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_facility_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_facility_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(scStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("sc" + iterateId, 0, 0);
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "facility";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `asset_id`, `name`, `category`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.name = resultSet_tMysqlSCD_1.getString(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.category = resultSet_tMysqlSCD_1.getString(4);
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `asset_id`, `updated_at`, `created_at`, `name`, `category`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
...
// # Output table : 'sc'
sc_tmp.id = row1.id;
sc_tmp.code = row1.code;
sc_tmp.asset_id = row1.asset_id;
sc_tmp.name = row1.name;
sc_tmp.category = row1.category;
sc_tmp.current_flag = 0;
sc_tmp.version_no = 0;
sc_tmp.start_dt = null;
sc_tmp.end_dt = null;
sc_tmp.created_at = row1.created_at;
sc_tmp.updated_at = row1.updated_at;
sc = sc_tmp;
// ###############################
...
if(sc != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//sc
				...
				if(execStat){
					runStat.updateStatOnConnection("sc"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = sc.code;
            lookUpKey_tMysqlSCD_1.asset_id = sc.asset_id;
...
insertionStatement_tMysqlSCD_1.setString(1, sc.code);
}

                    insertionStatement_tMysqlSCD_1.setInt(2, sc.asset_id);

                    if(sc.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(sc.updated_at != null) {
date_tMysqlSCD_1 = sc.updated_at.getTime();
...
insertionStatement_tMysqlSCD_1.setString(5, sc.name);
}

                    if(sc.category == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(6, sc.category);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.name == null && sc.name!= null) || (lookUpValue_tMysqlSCD_1.name != null && !lookUpValue_tMysqlSCD_1.name.equals(sc.name)) || (lookUpValue_tMysqlSCD_1.category == null && sc.category!= null) || (lookUpValue_tMysqlSCD_1.category != null && !lookUpValue_tMysqlSCD_1.category.equals(sc.category))) {
                    if(sc.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, sc.code);
}

                    updateForType2_tMysqlSCD_1.setInt(3, sc.asset_id);
...
insertionStatement_tMysqlSCD_1.setString(6, sc.category);
                ...
                lookUpValue_tMysqlSCD_1.name = sc.name;
                lookUpValue_tMysqlSCD_1.category = sc.category;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("sc"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_facility_refdt jb_facility_refdtClass = new jb_facility_refdt();

        int exitCode = jb_facility_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_facility_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_facility_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_facility_refdt");
        }
...
/************************************************************************************************
 *     94977 characters generated by Talend Open Studio for Data Integration 
