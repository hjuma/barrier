...
package barrier_project.jb_land_work_order_nm01_chis_1_0;
...
/**
 * Job: jb_land_work_order_nm01_chis Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_nm01_chis implements TalendJob {
...
public String getSource_x_data_home(){
	...
	private final String jobName = "jb_land_work_order_nm01_chis";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_nm01_chis.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_nm01_chis.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("work_order_CHIS_*.txt");  
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("chis", 3, 0);
					}           			
...
public static class chisStruct implements routines.system.IPersistableRow<chisStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_chis = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_chis, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_chis) {
     ...
     * Compare keys
     */
    public int compareTo(chisStruct other) {
...
chisStruct chis = new chisStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("chis" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_nm01_chis";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "work_order_nm01_chis" + "` (`facility_code`,`order`,`functional_loc`,`description`,`order_type`,`planner_group`,`user_status`,`abc_indic`,`work_center`,`maint_activ_type`,`latest_allow_fin_dat`,`system_status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
chisStruct chis_tmp = new chisStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home + context.source_x_data_home   +  ((String)globalMap.get("tFileList_1_CURRENT_FILE"))/** End field tFileInputDelimited_1:FILENAME */;		
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.facility_code = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.work_order_number = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.functional_location = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.work_order_description = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.planner_group = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.abc_field = ParserUtils.parseTo_Character(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.work_centre = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.maint_activ_type = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.latest_allowable_finish_date = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "dd/MM/yyyy");
...
// # Output table : 'chis'
chis_tmp.facility_code = row1.facility_code;
chis_tmp.order = row1.work_order_number ;
chis_tmp.functional_loc = row1.functional_location ;
chis_tmp.description = row1.work_order_description ;
chis_tmp.order_type = row1.order_type;
chis_tmp.planner_group = row1.planner_group;
chis_tmp.user_status = row1.user_status;
chis_tmp.abc_indic = row1.abc_field ;
chis_tmp.work_center = row1.work_centre ;
chis_tmp.maint_activ_type = row1.maint_activ_type;
chis_tmp.latest_allow_fin_dat = row1.latest_allowable_finish_date ;
chis_tmp.system_status = row1.system_status;
chis = chis_tmp;
// ###############################
...
if(chis != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//chis
				...
				if(execStat){
					runStat.updateStatOnConnection("chis"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(chis.facility_code == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, chis.facility_code);
}

                            if(chis.order == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(2, chis.order);
}

                            if(chis.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, chis.functional_loc);
}

                            if(chis.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, chis.description);
}

                            if(chis.order_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, chis.order_type);
}

                            if(chis.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, chis.planner_group);
}

                            if(chis.user_status == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, chis.user_status);
}

                            if(chis.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else {if(chis.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(chis.abc_indic == ' '){
pstmt_tMysqlOutput_1.setString(8, "");
} else {
pstmt_tMysqlOutput_1.setString(8, String.valueOf(chis.abc_indic));
}}

                            if(chis.work_center == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, chis.work_center);
}

                            if(chis.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, chis.maint_activ_type);
}

                            if(chis.latest_allow_fin_dat != null) {
date_tMysqlOutput_1 = chis.latest_allow_fin_dat.getTime();
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                            ...
                            if(chis.system_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, chis.system_status);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("chis"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_nm01_chis jb_land_work_order_nm01_chisClass = new jb_land_work_order_nm01_chis();

        int exitCode = jb_land_work_order_nm01_chisClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_nm01_chis.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_nm01_chis_1_0/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_nm01_chis");
        }
