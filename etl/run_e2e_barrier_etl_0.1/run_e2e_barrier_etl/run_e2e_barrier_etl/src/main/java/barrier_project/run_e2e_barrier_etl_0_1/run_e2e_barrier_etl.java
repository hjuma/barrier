...
package barrier_project.run_e2e_barrier_etl_0_1;
...
/**
 * Job: run_e2e_barrier_etl Purpose: runs a task taking into account task dependancies<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class run_e2e_barrier_etl implements TalendJob {
...
public String getThis_level_job_post(){
	...
	private final String jobName = "run_e2e_barrier_etl";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				run_e2e_barrier_etl.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(run_e2e_barrier_etl.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		barrier_project.run_task_landing_0_1.run_task_landing childJob_tRunJob_1 = new barrier_project.run_task_landing_0_1.run_task_landing();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		barrier_project.run_task_ods_0_1.run_task_ods childJob_tRunJob_4 = new barrier_project.run_task_ods_0_1.run_task_ods();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		barrier_project.run_task_barrier_main_core_0_1.run_task_barrier_main_core childJob_tRunJob_6 = new barrier_project.run_task_barrier_main_core_0_1.run_task_barrier_main_core();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final run_e2e_barrier_etl run_e2e_barrier_etlClass = new run_e2e_barrier_etl();

        int exitCode = run_e2e_barrier_etlClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = run_e2e_barrier_etl.class.getClassLoader().getResourceAsStream("barrier_project/run_e2e_barrier_etl_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : run_e2e_barrier_etl");
        }
...
/************************************************************************************************
 *     61831 characters generated by Talend Open Studio for Data Integration 
