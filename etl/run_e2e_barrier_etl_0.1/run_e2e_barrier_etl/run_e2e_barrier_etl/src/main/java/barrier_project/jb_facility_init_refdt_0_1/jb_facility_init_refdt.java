...
package barrier_project.jb_facility_init_refdt_0_1;
...
/**
 * Job: jb_facility_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_facility_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_facility_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_facility_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_facility_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class vbStruct implements routines.system.IPersistableRow<vbStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_facility_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final vbStruct other = (vbStruct) obj;
	...
	public void copyDataTo(vbStruct other) {
	...
	public void copyKeysDataTo(vbStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_facility_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_facility_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(vbStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("vb" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "facility";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "facility" + "` (`id`,`code`,`asset_id`,`name`,`category`,`current_flag`,`version_no`,`start_dt`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `code` = ?,`asset_id` = ?,`name` = ?,`category` = ?,`start_dt` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/facility_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'vb'
vb_tmp.id = row1.id;
vb_tmp.code = row1.code;
vb_tmp.asset_id = row1.asset_id;
vb_tmp.name = row1.name;
vb_tmp.category = row1.category;
vb_tmp.current_flag = 1;
vb_tmp.version_no = 1;
vb_tmp.start_dt = Var.var1 ;
vb_tmp.end_dt = null;
vb_tmp.created_at = row1.created_at;
vb_tmp.updated_at = row1.updated_at;
vb = vb_tmp;
// ###############################
...
if(vb != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//vb
				...
				if(execStat){
					runStat.updateStatOnConnection("vb"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setInt(1, vb.id);

                    if(vb.code == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, vb.code);
}

                    pstmt_tMysqlOutput_1.setInt(3, vb.asset_id);

                    if(vb.name == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, vb.name);
}

                    if(vb.category == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, vb.category);
}

                    pstmt_tMysqlOutput_1.setInt(6, vb.current_flag);

                    pstmt_tMysqlOutput_1.setInt(7, vb.version_no);

                    if(vb.start_dt != null) {
date_tMysqlOutput_1 = vb.start_dt.getTime();
...
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.DATE);
                    ...
                    if(vb.end_dt != null) {
date_tMysqlOutput_1 = vb.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                    ...
                    if(vb.created_at != null) {
date_tMysqlOutput_1 = vb.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.DATE);
                    ...
                    if(vb.updated_at != null) {
date_tMysqlOutput_1 = vb.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
} else {pstmt_tMysqlOutput_1.setString(12, vb.code);
}

                    pstmt_tMysqlOutput_1.setInt(13, vb.asset_id);

                    if(vb.name == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, vb.name);
}

                    if(vb.category == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, vb.category);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("vb"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_facility_init_refdt jb_facility_init_refdtClass = new jb_facility_init_refdt();

        int exitCode = jb_facility_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_facility_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_facility_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_facility_init_refdt");
        }
...
/************************************************************************************************
 *     94260 characters generated by Talend Open Studio for Data Integration 
