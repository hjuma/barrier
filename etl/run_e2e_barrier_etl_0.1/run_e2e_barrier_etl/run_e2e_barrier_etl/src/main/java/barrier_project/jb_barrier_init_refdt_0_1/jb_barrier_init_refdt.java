...
package barrier_project.jb_barrier_init_refdt_0_1;
...
/**
 * Job: jb_barrier_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class initxStruct implements routines.system.IPersistableRow<initxStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_init_refdt) {
...
String tableName_tMysqlOutput_1 = "barrier";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "barrier" + "` (`id`,`start_dt`,`current_flag`,`version_no`,`code`,`name`,`description`,`display_order`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `version_no` = ?,`code` = ?,`name` = ?,`description` = ?,`display_order` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
...
initx_tmp.current_flag = true;
initx_tmp.version_no = 0;
initx_tmp.code = row1.code;
...
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.DATE);
                    ...
                    pstmt_tMysqlOutput_1.setBoolean(3, initx.current_flag);

                    pstmt_tMysqlOutput_1.setInt(4, initx.version_no);

                    if(initx.code == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, initx.code);
}

                    if(initx.name == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, initx.name);
}

                    if(initx.description == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, initx.description);
}

                    pstmt_tMysqlOutput_1.setInt(8, initx.display_order);
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                    ...
                    pstmt_tMysqlOutput_1.setInt(12, initx.version_no);

                    if(initx.code == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, initx.code);
}

                    if(initx.name == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, initx.name);
}

                    if(initx.description == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, initx.description);
}

                    pstmt_tMysqlOutput_1.setInt(16, initx.display_order);
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_init_refdt jb_barrier_init_refdtClass = new jb_barrier_init_refdt();

        int exitCode = jb_barrier_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_init_refdt");
        }
...
/************************************************************************************************
 *     94475 characters generated by Talend Open Studio for Data Integration 
