...
package barrier_project.jb_land_work_order_nm01_grow_1_0;
...
/**
 * Job: jb_land_work_order_nm01_grow Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_nm01_grow implements TalendJob {
...
public String getSource_x_data_home(){
	...
	private final String jobName = "jb_land_work_order_nm01_grow";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_nm01_grow.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_nm01_grow.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("work_order_GROW_*.txt");  
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("grow", 3, 0);
					}           			
...
public static class growStruct implements routines.system.IPersistableRow<growStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_grow = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_grow, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_grow) {
     ...
     * Compare keys
     */
    public int compareTo(growStruct other) {
...
growStruct grow = new growStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("grow" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_nm01_grow";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "work_order_nm01_grow" + "` (`facility_code`,`order`,`functional_loc`,`description`,`order_type`,`planner_group`,`user_status`,`abc_indic`,`work_center`,`maint_activ_type`,`latest_allow_fin_dat`,`system_status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
growStruct grow_tmp = new growStruct();
// ###############################
...
// # Output table : 'grow'
grow_tmp.facility_code = row1.facility_code;
grow_tmp.order = row1.work_order_number ;
grow_tmp.functional_loc = row1.functional_location ;
grow_tmp.description = row1.work_order_description ;
grow_tmp.order_type = row1.order_type;
grow_tmp.planner_group = row1.planner_group;
grow_tmp.user_status = row1.user_status;
grow_tmp.abc_indic = row1.abc_field ;
grow_tmp.work_center = row1.work_centre ;
grow_tmp.maint_activ_type = row1.maint_activ_type;
grow_tmp.latest_allow_fin_dat = row1.latest_allowable_finish_date ;
grow_tmp.system_status = row1.system_status;
grow = grow_tmp;
// ###############################
...
if(grow != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//grow
				...
				if(execStat){
					runStat.updateStatOnConnection("grow"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(grow.facility_code == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, grow.facility_code);
}

                            if(grow.order == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(2, grow.order);
}

                            if(grow.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, grow.functional_loc);
}

                            if(grow.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, grow.description);
}

                            if(grow.order_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, grow.order_type);
}

                            if(grow.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, grow.planner_group);
}

                            if(grow.user_status == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, grow.user_status);
}

                            if(grow.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else {if(grow.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(grow.abc_indic == ' '){
pstmt_tMysqlOutput_1.setString(8, "");
} else {
pstmt_tMysqlOutput_1.setString(8, String.valueOf(grow.abc_indic));
}}

                            if(grow.work_center == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, grow.work_center);
}

                            if(grow.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, grow.maint_activ_type);
}

                            if(grow.latest_allow_fin_dat != null) {
date_tMysqlOutput_1 = grow.latest_allow_fin_dat.getTime();
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                            ...
                            if(grow.system_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, grow.system_status);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("grow"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_nm01_grow jb_land_work_order_nm01_growClass = new jb_land_work_order_nm01_grow();

        int exitCode = jb_land_work_order_nm01_growClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_nm01_grow.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_nm01_grow_1_0/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_nm01_grow");
        }
