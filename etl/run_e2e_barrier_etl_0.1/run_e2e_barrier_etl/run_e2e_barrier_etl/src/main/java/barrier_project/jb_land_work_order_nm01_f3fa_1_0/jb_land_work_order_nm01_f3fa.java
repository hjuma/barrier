...
package barrier_project.jb_land_work_order_nm01_f3fa_1_0;
...
/**
 * Job: jb_land_work_order_nm01_f3fa Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_nm01_f3fa implements TalendJob {
...
public String getSource_x_data_home(){
	...
	private final String jobName = "jb_land_work_order_nm01_f3fa";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_nm01_f3fa.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_nm01_f3fa.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("work_order_F3FA_*.txt");  
 ...
 */
	NB_ITERATE_tSetGlobalVar_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("f3fa", 3, 0);
					}           			
...
public static class f3faStruct implements routines.system.IPersistableRow<f3faStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_nm01_f3fa) {
     ...
     * Compare keys
     */
    public int compareTo(f3faStruct other) {
...
f3faStruct f3fa = new f3faStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("f3fa" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_nm01_f3fa";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "work_order_nm01_f3fa" + "` (`facility_code`,`order`,`functional_loc`,`description`,`order_type`,`planner_group`,`user_status`,`abc_indic`,`work_center`,`maint_activ_type`,`latest_allow_fin_dat`,`system_status`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
f3faStruct f3fa_tmp = new f3faStruct();
// ###############################
...
// # Output table : 'f3fa'
f3fa_tmp.facility_code = row1.facility_code;
f3fa_tmp.order = row1.work_order_number ;
f3fa_tmp.functional_loc = row1.functional_location ;
f3fa_tmp.description = row1.work_order_description ;
f3fa_tmp.order_type = row1.order_type;
f3fa_tmp.planner_group = row1.planner_group;
f3fa_tmp.user_status = row1.user_status;
f3fa_tmp.abc_indic = row1.abc_field ;
f3fa_tmp.work_center = row1.work_centre ;
f3fa_tmp.maint_activ_type = row1.maint_activ_type;
f3fa_tmp.latest_allow_fin_dat = row1.latest_allowable_finish_date ;
f3fa_tmp.system_status = row1.system_status;
f3fa = f3fa_tmp;
// ###############################
...
if(f3fa != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//f3fa
				...
				if(execStat){
					runStat.updateStatOnConnection("f3fa"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(f3fa.facility_code == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, f3fa.facility_code);
}

                            if(f3fa.order == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(2, f3fa.order);
}

                            if(f3fa.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, f3fa.functional_loc);
}

                            if(f3fa.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, f3fa.description);
}

                            if(f3fa.order_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, f3fa.order_type);
}

                            if(f3fa.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, f3fa.planner_group);
}

                            if(f3fa.user_status == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, f3fa.user_status);
}

                            if(f3fa.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else {if(f3fa.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.CHAR);
} else if(f3fa.abc_indic == ' '){
pstmt_tMysqlOutput_1.setString(8, "");
} else {
pstmt_tMysqlOutput_1.setString(8, String.valueOf(f3fa.abc_indic));
}}

                            if(f3fa.work_center == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, f3fa.work_center);
}

                            if(f3fa.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, f3fa.maint_activ_type);
}

                            if(f3fa.latest_allow_fin_dat != null) {
date_tMysqlOutput_1 = f3fa.latest_allow_fin_dat.getTime();
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                            ...
                            if(f3fa.system_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, f3fa.system_status);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("f3fa"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_nm01_f3fa jb_land_work_order_nm01_f3faClass = new jb_land_work_order_nm01_f3fa();

        int exitCode = jb_land_work_order_nm01_f3faClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_nm01_f3fa.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_nm01_f3fa_1_0/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_nm01_f3fa");
        }
