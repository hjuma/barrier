...
package barrier_project.jb_abc_indicator_init_refdt_0_1;
...
/**
 * Job: jb_abc_indicator_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_abc_indicator_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_abc_indicator_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_abc_indicator_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_abc_indicator_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class initStruct implements routines.system.IPersistableRow<initStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_abc_indicator_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final initStruct other = (initStruct) obj;
	...
	public void copyDataTo(initStruct other) {
	...
	public void copyKeysDataTo(initStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_abc_indicator_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_abc_indicator_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(initStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("init" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "abc_indicator";
...
int count_tMysqlOutput_1=0;
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "abc_indicator" + "` (`id`,`code`,`asset_id`,`description`,`created_at`,`updated_at`,`current_flag`,`start_dt`,`end_dt`,`version_no`) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
initStruct init_tmp = new initStruct();
// ###############################
...
// # Output table : 'init'
init_tmp.id = row1.id;
init_tmp.code = row1.code;
init_tmp.asset_id = row1.asset_id;
init_tmp.description = row1.description;
init_tmp.created_at = row1.created_at;
init_tmp.updated_at = row1.updated_at;
init_tmp.current_flag = 1;
init_tmp.start_dt = Var.var1 ;
init_tmp.end_dt = null;
init_tmp.version_no = 1;
init = init_tmp;
// ###############################
...
if(init != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//init
				...
				if(execStat){
					runStat.updateStatOnConnection("init"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            pstmt_tMysqlOutput_1.setInt(1, init.id);

                            if(init.code == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, init.code);
}

                            pstmt_tMysqlOutput_1.setInt(3, init.asset_id);

                            if(init.description == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, init.description);
}

                            if(init.created_at != null) {
date_tMysqlOutput_1 = init.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(5, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(5, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.DATE);
}

                            if(init.updated_at != null) {
date_tMysqlOutput_1 = init.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(6, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(6, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.DATE);
}

                            if(init.current_flag == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(7, init.current_flag);
}

                            if(init.start_dt != null) {
date_tMysqlOutput_1 = init.start_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.DATE);
                            ...
                            if(init.end_dt != null) {
date_tMysqlOutput_1 = init.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                            ...
                            if(init.version_no == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.INTEGER);
} else {pstmt_tMysqlOutput_1.setInt(10, init.version_no);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("init"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_abc_indicator_init_refdt jb_abc_indicator_init_refdtClass = new jb_abc_indicator_init_refdt();

        int exitCode = jb_abc_indicator_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_abc_indicator_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_abc_indicator_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_abc_indicator_init_refdt");
        }
...
/************************************************************************************************
 *     93728 characters generated by Talend Open Studio for Data Integration 
