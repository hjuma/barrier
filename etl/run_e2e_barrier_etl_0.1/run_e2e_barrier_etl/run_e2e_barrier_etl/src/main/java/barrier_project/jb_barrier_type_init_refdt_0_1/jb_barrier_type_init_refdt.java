...
package barrier_project.jb_barrier_type_init_refdt_0_1;
...
/**
 * Job: jb_barrier_type_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_type_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_type_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_type_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_type_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class initxStruct implements routines.system.IPersistableRow<initxStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final initxStruct other = (initxStruct) obj;
	...
	public void copyDataTo(initxStruct other) {
	...
	public void copyKeysDataTo(initxStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_type_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(initxStruct other) {
...
initxStruct initx = new initxStruct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("initx" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "barrier_type";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "barrier_type" + "` (`id`,`asset_id`,`barrier_id`,`name`,`description`,`display_order`,`current_flag`,`version_no`,`start_dt`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `asset_id` = ?,`barrier_id` = ?,`name` = ?,`description` = ?,`display_order` = ?,`start_dt` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
...
initxStruct initx_tmp = new initxStruct();
// ###############################
...
// # Output table : 'initx'
initx_tmp.id = row1.id;
initx_tmp.asset_id = row1.asset_id;
initx_tmp.barrier_id = row1.barrier_id;
initx_tmp.name = row1.name;
initx_tmp.description = row1.name ;
initx_tmp.display_order = row1.display_order;
initx_tmp.current_flag = 1;
initx_tmp.version_no = 1;
initx_tmp.start_dt = Var.var1 ;
initx_tmp.end_dt = null;
initx_tmp.created_at = row1.created_at;
initx_tmp.updated_at = row1.updated_at;
initx = initx_tmp;
// ###############################
...
if(initx != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//initx
				...
				if(execStat){
					runStat.updateStatOnConnection("initx"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setInt(1, initx.id);

                    pstmt_tMysqlOutput_1.setInt(2, initx.asset_id);

                    pstmt_tMysqlOutput_1.setInt(3, initx.barrier_id);

                    if(initx.name == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, initx.name);
}

                    if(initx.description == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, initx.description);
}

                    pstmt_tMysqlOutput_1.setInt(6, initx.display_order);

                    pstmt_tMysqlOutput_1.setInt(7, initx.current_flag);

                    pstmt_tMysqlOutput_1.setInt(8, initx.version_no);

                    if(initx.start_dt != null) {
date_tMysqlOutput_1 = initx.start_dt.getTime();
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                    ...
                    if(initx.end_dt != null) {
date_tMysqlOutput_1 = initx.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.DATE);
                    ...
                    if(initx.created_at != null) {
date_tMysqlOutput_1 = initx.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.DATE);
                    ...
                    if(initx.updated_at != null) {
date_tMysqlOutput_1 = initx.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.DATE);
                    ...
                    pstmt_tMysqlOutput_1.setInt(13, initx.asset_id);

                    pstmt_tMysqlOutput_1.setInt(14, initx.barrier_id);

                    if(initx.name == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, initx.name);
}

                    if(initx.description == null) {
pstmt_tMysqlOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(16, initx.description);
}

                    pstmt_tMysqlOutput_1.setInt(17, initx.display_order);
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("initx"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_type_init_refdt jb_barrier_type_init_refdtClass = new jb_barrier_type_init_refdt();

        int exitCode = jb_barrier_type_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_type_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_type_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_type_init_refdt");
        }
...
/************************************************************************************************
 *     102120 characters generated by Talend Open Studio for Data Integration 
