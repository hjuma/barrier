...
package barrier_project.jb_land_work_order_eis_mdp1_0_1;
...
/**
 * Job: jb_land_work_order_eis_mdp1 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_land_work_order_eis_mdp1 implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_land_work_order_eis_mdp1";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_land_work_order_eis_mdp1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_land_work_order_eis_mdp1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map_eis_mdp1Struct implements routines.system.IPersistableRow<map_eis_mdp1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_eis_mdp1 = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1 = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_land_work_order_eis_mdp1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_land_work_order_eis_mdp1) {
     ...
     * Compare keys
     */
    public int compareTo(map_eis_mdp1Struct other) {
...
map_eis_mdp1Struct map_eis_mdp1 = new map_eis_mdp1Struct();
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("map_eis_mdp1" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "work_order_eis_mdp1";
...
map_eis_mdp1Struct map_eis_mdp1_tmp = new map_eis_mdp1Struct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.etl_data_home+"/barrier/database/barrier_landing/data/work_order_eis_mdp1.txt";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.etl_data_home+"/barrier/database/barrier_landing/data/work_order_eis_mdp1.txt", "US-ASCII","\t","\n",false,1,0,-1,-1, false);
...
// # Output table : 'map_eis_mdp1'
map_eis_mdp1_tmp.functional_loc = null;
map_eis_mdp1_tmp.description = row1.Description;
map_eis_mdp1_tmp.order_type = row1.Order_Type;
map_eis_mdp1_tmp.Order = row1.Order;
map_eis_mdp1_tmp.maint_activ_type = row1.MaintActivType ;
map_eis_mdp1_tmp.description_4 = row1.Description4 ;
map_eis_mdp1_tmp.planner_group = row1.Planner_group;
map_eis_mdp1_tmp.main_work_ctr = row1.Main_WorkCtr ;
map_eis_mdp1_tmp.user_status = row1.User_status;
map_eis_mdp1_tmp.system_status = row1.System_status;
map_eis_mdp1_tmp.Priority = row1.Priority;
map_eis_mdp1_tmp.estimated_costs = row1.Estimated_costs;
map_eis_mdp1_tmp.total_act_costs = row1.Total_act_costs;
map_eis_mdp1_tmp.total_settlemt = row1.Total_settlemt;
map_eis_mdp1_tmp.total_plnnd_costs = row1.TotalPlnndCosts ;
map_eis_mdp1_tmp.tot_sum_plan = row1.TotSum__plan_ ;
map_eis_mdp1_tmp.total_rev_act = row1.Total_rev__act_ ;
map_eis_mdp1_tmp.tot_plan_rev = row1.Tot__plan__rev_ ;
map_eis_mdp1_tmp.tot_sum_actual = row1.TotSum__actual_ ;
map_eis_mdp1_tmp.abc_indic = row1.ABC_indic_ ;
map_eis_mdp1_tmp.reference_date = row1.Reference_Date;
map_eis_mdp1_tmp.ref_element_pm_ps = row1.Ref__Element_PM_PS ;
map_eis_mdp1_tmp.address_number = row1.Address_number;
map_eis_mdp1_tmp.reference_time = row1.Reference_time;
map_eis_mdp1_tmp.changed_on = row1.Changed_on;
map_eis_mdp1_tmp.changed_by = row1.Changed_by;
map_eis_mdp1_tmp.available_to = row1.Available_to;
map_eis_mdp1_tmp.avail_to_time = row1.Avail__to_time ;
map_eis_mdp1_tmp.asset = row1.Asset;
map_eis_mdp1_tmp.sub_number = row1.Subnumber ;
map_eis_mdp1_tmp.available_from = row1.Available_from;
map_eis_mdp1_tmp.available_from30 = row1.Available_from30;
map_eis_mdp1_tmp.system_condition = row1.SystemCondition ;
map_eis_mdp1_tmp.work_center = row1.Work_center;
map_eis_mdp1_tmp.priority_type = row1.PriorityType ;
map_eis_mdp1_tmp.res_purc_req = row1.Res__Purc__req_ ;
map_eis_mdp1_tmp.subnet_work_of = row1.Subnetwork_of ;
map_eis_mdp1_tmp.order_category = row1.Order_category;
map_eis_mdp1_tmp.plant_wk_cntr = row1.Plant_WkCntr ;
map_eis_mdp1_tmp.assembly = row1.Assembly;
map_eis_mdp1_tmp.assembly_desc = row1.Assembly_desc_ ;
map_eis_mdp1_tmp.plant_section = row1.Plant_section;
map_eis_mdp1_tmp.acctg_indicator = row1.Acctg_Indicator;
map_eis_mdp1_tmp.po_date = row1.PO_date;
map_eis_mdp1_tmp.po_number = row1.PO_number;
map_eis_mdp1_tmp.company_code = row1.Company_Code;
map_eis_mdp1_tmp.city = row1.City;
map_eis_mdp1_tmp.district = row1.District;
map_eis_mdp1_tmp.country = row1.Country;
map_eis_mdp1_tmp.device_data = row1.Device_data;
map_eis_mdp1_tmp.sort_field = row1.Sort_field;
map_eis_mdp1_tmp.description_50 = row1.Description50 ;
map_eis_mdp1_tmp.equipment = row1.Equipment;
map_eis_mdp1_tmp.created_on = row1.Created_on;
map_eis_mdp1_tmp.entered_by = row1.Entered_by;
map_eis_mdp1_tmp.billingform = row1.Billing_form ;
map_eis_mdp1_tmp.actual_release = row1.Actual_release;
map_eis_mdp1_tmp.actual_finish = row1.Actual_Finish;
map_eis_mdp1_tmp.actual_finish1 = row1.Actual_finish ;
map_eis_mdp1_tmp.basic_fin_date = row1.Basic_fin__date ;
map_eis_mdp1_tmp.sched_finish = row1.Sched__finish ;
map_eis_mdp1_tmp.basic_fin_time = row1.Basic_fin__time ;
map_eis_mdp1_tmp.finish_time = row1.Finish_time;
map_eis_mdp1_tmp.business_area = row1.Business_Area;
map_eis_mdp1_tmp.actual_start = row1.Actual_start;
map_eis_mdp1_tmp.bas_start_date = row1.Bas__start_date ;
map_eis_mdp1_tmp.sched_start = row1.Sched__start ;
map_eis_mdp1_tmp.actual_start1 = row1.ActualStart ;
map_eis_mdp1_tmp.start_time = row1.Start_time;
map_eis_mdp1_tmp.sched_start_time = row1.SchedStartTime ;
map_eis_mdp1_tmp.hist_fr = row1.Hist_fr_ ;
map_eis_mdp1_tmp.planning_plant = row1.Planning_plant;
map_eis_mdp1_tmp.costing_sheet = row1.Costing_Sheet;
map_eis_mdp1_tmp.sales_document = row1.Sales_Document;
map_eis_mdp1_tmp.item = row1.Item;
map_eis_mdp1_tmp.co_Area = row1.CO_Area;
map_eis_mdp1_tmp.cost_center = row1.Cost_Center;
map_eis_mdp1_tmp.resp_cost_cntr = row1.Resp__cost_cntr ;
map_eis_mdp1_tmp.customer = row1.Customer;
map_eis_mdp1_tmp.leading_order = row1.Leading_order;
map_eis_mdp1_tmp.deletion_flag = row1.Deletion_flag;
map_eis_mdp1_tmp.long_txt_exists = row1.Long_txt_exists;
map_eis_mdp1_tmp.description_81 = row1.Description81 ;
map_eis_mdp1_tmp.superior_order = row1.Superior_order;
map_eis_mdp1_tmp.base_unit = row1.Base_Unit;
map_eis_mdp1_tmp.quantity = row1.Quantity;
map_eis_mdp1_tmp.room = row1.Room;
map_eis_mdp1_tmp.list_name = row1.List_name;
map_eis_mdp1_tmp.object_number = row1.Object_number;
map_eis_mdp1_tmp.paging_status = row1.Paging_status;
map_eis_mdp1_tmp.pgrp_task_list = row1.PGrp_Task_List;
map_eis_mdp1_tmp.order_plan_ind = row1.OrderPlanInd_ ;
map_eis_mdp1_tmp.group_counter = row1.Group_Counter;
map_eis_mdp1_tmp.group = row1.Group;
map_eis_mdp1_tmp.postal_code = row1.Postal_Code;
map_eis_mdp1_tmp.profit_center = row1.Profit_Center;
map_eis_mdp1_tmp.priority_95 = row1.Priority95 ;
map_eis_mdp1_tmp.wbs_element = row1.WBS_element;
map_eis_mdp1_tmp.wbs_ord_header = row1.WBS_ord__header ;
map_eis_mdp1_tmp.notification = row1.Notification;
map_eis_mdp1_tmp.region = row1.Region;
map_eis_mdp1_tmp.revision = row1.Revision;
map_eis_mdp1_tmp.serial_number = row1.Serial_Number;
map_eis_mdp1_tmp.material = row1.Material;
map_eis_mdp1_tmp.service_product = row1.Service_product;
map_eis_mdp1_tmp.service_product_104 = row1.Service_product104 ;
map_eis_mdp1_tmp.division = row1.Division;
map_eis_mdp1_tmp.division_sales = row1.Division___Sales ;
map_eis_mdp1_tmp.location = row1.Location;
map_eis_mdp1_tmp.street = row1.Street;
map_eis_mdp1_tmp.maint_plant = row1.MaintPlant ;
map_eis_mdp1_tmp.telephone = row1.Telephone;
map_eis_mdp1_tmp.sales_office = row1.Sales_Office;
map_eis_mdp1_tmp.sales_group = row1.Sales_Group;
map_eis_mdp1_tmp.sales_org = row1.Sales_Org_ ;
map_eis_mdp1_tmp.sales_org_sales = row1.Sales_Org____Sales ;
map_eis_mdp1_tmp.superior_act = row1.Superior_act_ ;
map_eis_mdp1_tmp.distr_channel = row1.Distr__Channel ;
map_eis_mdp1_tmp.distr_channel_sal = row1.Distr__Channel___Sal ;
map_eis_mdp1_tmp.currency = row1.Currency;
map_eis_mdp1_tmp.maint_item = row1.MaintItem ;
map_eis_mdp1_tmp.maintenance_plan = row1.MaintenancePlan ;
map_eis_mdp1_tmp.plant = row1.Plant;
map_eis_mdp1_tmp.comp = row1.Comp;
map_eis_mdp1_tmp.overhead_key = row1.Overhead_key;
map_eis_mdp1_tmp.earlst_allow_fin_dat = row1.Earlst_Allow_Fin_Dat;
map_eis_mdp1_tmp.earl_allow_start_dat = row1.Earl_Allow_Start_Dat;
map_eis_mdp1_tmp.latest_allow_fin_dat = row1.Latest_Allow_Fin_Dat;
map_eis_mdp1_tmp.original_due_date = row1.Original_Due_Date;
map_eis_mdp1_tmp.object_list = row1.Object_list;
map_eis_mdp1_tmp.catalog_type = row1.Catalog_type;
map_eis_mdp1_tmp.code_group = row1.Code_group;
map_eis_mdp1_tmp.coding = row1.Coding;
map_eis_mdp1 = map_eis_mdp1_tmp;
// ###############################
 ...
 * [tMap_1 main ] stop
 */
// Start of branch "map_eis_mdp1"
if(map_eis_mdp1 != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//map_eis_mdp1
				...
				if(execStat){
					runStat.updateStatOnConnection("map_eis_mdp1"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(map_eis_mdp1.functional_loc == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, map_eis_mdp1.functional_loc);
}

                            if(map_eis_mdp1.description == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, map_eis_mdp1.description);
}

                            if(map_eis_mdp1.order_type == null) {
pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(3, map_eis_mdp1.order_type);
}

                            if(map_eis_mdp1.Order == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, map_eis_mdp1.Order);
}

                            if(map_eis_mdp1.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, map_eis_mdp1.maint_activ_type);
}

                            if(map_eis_mdp1.description_4 == null) {
pstmt_tMysqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(6, map_eis_mdp1.description_4);
}

                            if(map_eis_mdp1.planner_group == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, map_eis_mdp1.planner_group);
}

                            if(map_eis_mdp1.main_work_ctr == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, map_eis_mdp1.main_work_ctr);
}

                            if(map_eis_mdp1.user_status == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, map_eis_mdp1.user_status);
}

                            if(map_eis_mdp1.system_status == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, map_eis_mdp1.system_status);
}

                            if(map_eis_mdp1.Priority == null) {
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(11, map_eis_mdp1.Priority);
}

                            if(map_eis_mdp1.estimated_costs == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, map_eis_mdp1.estimated_costs);
}

                            if(map_eis_mdp1.total_act_costs == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, map_eis_mdp1.total_act_costs);
}

                            if(map_eis_mdp1.total_settlemt == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, map_eis_mdp1.total_settlemt);
}

                            if(map_eis_mdp1.total_plnnd_costs == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, map_eis_mdp1.total_plnnd_costs);
}

                            if(map_eis_mdp1.tot_sum_plan == null) {
pstmt_tMysqlOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(16, map_eis_mdp1.tot_sum_plan);
}

                            if(map_eis_mdp1.total_rev_act == null) {
pstmt_tMysqlOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(17, map_eis_mdp1.total_rev_act);
}

                            if(map_eis_mdp1.tot_plan_rev == null) {
pstmt_tMysqlOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(18, map_eis_mdp1.tot_plan_rev);
}

                            if(map_eis_mdp1.tot_sum_actual == null) {
pstmt_tMysqlOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(19, map_eis_mdp1.tot_sum_actual);
}

                            if(map_eis_mdp1.abc_indic == null) {
pstmt_tMysqlOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(20, map_eis_mdp1.abc_indic);
}

                            if(map_eis_mdp1.reference_date == null) {
pstmt_tMysqlOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(21, map_eis_mdp1.reference_date);
}

                            if(map_eis_mdp1.ref_element_pm_ps == null) {
pstmt_tMysqlOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(22, map_eis_mdp1.ref_element_pm_ps);
}

                            if(map_eis_mdp1.address_number == null) {
pstmt_tMysqlOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(23, map_eis_mdp1.address_number);
}

                            if(map_eis_mdp1.reference_time == null) {
pstmt_tMysqlOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(24, map_eis_mdp1.reference_time);
}

                            if(map_eis_mdp1.changed_on == null) {
pstmt_tMysqlOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(25, map_eis_mdp1.changed_on);
}

                            if(map_eis_mdp1.changed_by == null) {
pstmt_tMysqlOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(26, map_eis_mdp1.changed_by);
}

                            if(map_eis_mdp1.available_to == null) {
pstmt_tMysqlOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(27, map_eis_mdp1.available_to);
}

                            if(map_eis_mdp1.avail_to_time == null) {
pstmt_tMysqlOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(28, map_eis_mdp1.avail_to_time);
}

                            if(map_eis_mdp1.asset == null) {
pstmt_tMysqlOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(29, map_eis_mdp1.asset);
}

                            if(map_eis_mdp1.sub_number == null) {
pstmt_tMysqlOutput_1.setNull(30, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(30, map_eis_mdp1.sub_number);
}

                            if(map_eis_mdp1.available_from == null) {
pstmt_tMysqlOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(31, map_eis_mdp1.available_from);
}

                            if(map_eis_mdp1.available_from30 == null) {
pstmt_tMysqlOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(32, map_eis_mdp1.available_from30);
}

                            if(map_eis_mdp1.system_condition == null) {
pstmt_tMysqlOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(33, map_eis_mdp1.system_condition);
}

                            if(map_eis_mdp1.work_center == null) {
pstmt_tMysqlOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(34, map_eis_mdp1.work_center);
}

                            if(map_eis_mdp1.priority_type == null) {
pstmt_tMysqlOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(35, map_eis_mdp1.priority_type);
}

                            if(map_eis_mdp1.res_purc_req == null) {
pstmt_tMysqlOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(36, map_eis_mdp1.res_purc_req);
}

                            if(map_eis_mdp1.subnet_work_of == null) {
pstmt_tMysqlOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(37, map_eis_mdp1.subnet_work_of);
}

                            if(map_eis_mdp1.order_category == null) {
pstmt_tMysqlOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(38, map_eis_mdp1.order_category);
}

                            if(map_eis_mdp1.plant_wk_cntr == null) {
pstmt_tMysqlOutput_1.setNull(39, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(39, map_eis_mdp1.plant_wk_cntr);
}

                            if(map_eis_mdp1.assembly == null) {
pstmt_tMysqlOutput_1.setNull(40, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(40, map_eis_mdp1.assembly);
}

                            if(map_eis_mdp1.assembly_desc == null) {
pstmt_tMysqlOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(41, map_eis_mdp1.assembly_desc);
}

                            if(map_eis_mdp1.plant_section == null) {
pstmt_tMysqlOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(42, map_eis_mdp1.plant_section);
}

                            if(map_eis_mdp1.acctg_indicator == null) {
pstmt_tMysqlOutput_1.setNull(43, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(43, map_eis_mdp1.acctg_indicator);
}

                            if(map_eis_mdp1.po_date == null) {
pstmt_tMysqlOutput_1.setNull(44, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(44, map_eis_mdp1.po_date);
}

                            if(map_eis_mdp1.po_number == null) {
pstmt_tMysqlOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(45, map_eis_mdp1.po_number);
}

                            if(map_eis_mdp1.company_code == null) {
pstmt_tMysqlOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(46, map_eis_mdp1.company_code);
}

                            if(map_eis_mdp1.city == null) {
pstmt_tMysqlOutput_1.setNull(47, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(47, map_eis_mdp1.city);
}

                            if(map_eis_mdp1.district == null) {
pstmt_tMysqlOutput_1.setNull(48, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(48, map_eis_mdp1.district);
}

                            if(map_eis_mdp1.country == null) {
pstmt_tMysqlOutput_1.setNull(49, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(49, map_eis_mdp1.country);
}

                            if(map_eis_mdp1.device_data == null) {
pstmt_tMysqlOutput_1.setNull(50, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(50, map_eis_mdp1.device_data);
}

                            if(map_eis_mdp1.sort_field == null) {
pstmt_tMysqlOutput_1.setNull(51, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(51, map_eis_mdp1.sort_field);
}

                            if(map_eis_mdp1.description_50 == null) {
pstmt_tMysqlOutput_1.setNull(52, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(52, map_eis_mdp1.description_50);
}

                            if(map_eis_mdp1.equipment == null) {
pstmt_tMysqlOutput_1.setNull(53, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(53, map_eis_mdp1.equipment);
}

                            if(map_eis_mdp1.created_on == null) {
pstmt_tMysqlOutput_1.setNull(54, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(54, map_eis_mdp1.created_on);
}

                            if(map_eis_mdp1.entered_by == null) {
pstmt_tMysqlOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(55, map_eis_mdp1.entered_by);
}

                            if(map_eis_mdp1.billingform == null) {
pstmt_tMysqlOutput_1.setNull(56, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(56, map_eis_mdp1.billingform);
}

                            if(map_eis_mdp1.actual_release == null) {
pstmt_tMysqlOutput_1.setNull(57, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(57, map_eis_mdp1.actual_release);
}

                            if(map_eis_mdp1.actual_finish == null) {
pstmt_tMysqlOutput_1.setNull(58, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(58, map_eis_mdp1.actual_finish);
}

                            if(map_eis_mdp1.actual_finish1 == null) {
pstmt_tMysqlOutput_1.setNull(59, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(59, map_eis_mdp1.actual_finish1);
}

                            if(map_eis_mdp1.basic_fin_date == null) {
pstmt_tMysqlOutput_1.setNull(60, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(60, map_eis_mdp1.basic_fin_date);
}

                            if(map_eis_mdp1.sched_finish == null) {
pstmt_tMysqlOutput_1.setNull(61, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(61, map_eis_mdp1.sched_finish);
}

                            if(map_eis_mdp1.basic_fin_time == null) {
pstmt_tMysqlOutput_1.setNull(62, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(62, map_eis_mdp1.basic_fin_time);
}

                            if(map_eis_mdp1.finish_time == null) {
pstmt_tMysqlOutput_1.setNull(63, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(63, map_eis_mdp1.finish_time);
}

                            if(map_eis_mdp1.business_area == null) {
pstmt_tMysqlOutput_1.setNull(64, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(64, map_eis_mdp1.business_area);
}

                            if(map_eis_mdp1.actual_start == null) {
pstmt_tMysqlOutput_1.setNull(65, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(65, map_eis_mdp1.actual_start);
}

                            if(map_eis_mdp1.bas_start_date == null) {
pstmt_tMysqlOutput_1.setNull(66, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(66, map_eis_mdp1.bas_start_date);
}

                            if(map_eis_mdp1.sched_start == null) {
pstmt_tMysqlOutput_1.setNull(67, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(67, map_eis_mdp1.sched_start);
}

                            if(map_eis_mdp1.actual_start1 == null) {
pstmt_tMysqlOutput_1.setNull(68, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(68, map_eis_mdp1.actual_start1);
}

                            if(map_eis_mdp1.start_time == null) {
pstmt_tMysqlOutput_1.setNull(69, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(69, map_eis_mdp1.start_time);
}

                            if(map_eis_mdp1.sched_start_time == null) {
pstmt_tMysqlOutput_1.setNull(70, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(70, map_eis_mdp1.sched_start_time);
}

                            if(map_eis_mdp1.hist_fr == null) {
pstmt_tMysqlOutput_1.setNull(71, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(71, map_eis_mdp1.hist_fr);
}

                            if(map_eis_mdp1.planning_plant == null) {
pstmt_tMysqlOutput_1.setNull(72, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(72, map_eis_mdp1.planning_plant);
}

                            if(map_eis_mdp1.costing_sheet == null) {
pstmt_tMysqlOutput_1.setNull(73, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(73, map_eis_mdp1.costing_sheet);
}

                            if(map_eis_mdp1.sales_document == null) {
pstmt_tMysqlOutput_1.setNull(74, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(74, map_eis_mdp1.sales_document);
}

                            if(map_eis_mdp1.item == null) {
pstmt_tMysqlOutput_1.setNull(75, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(75, map_eis_mdp1.item);
}

                            if(map_eis_mdp1.co_Area == null) {
pstmt_tMysqlOutput_1.setNull(76, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(76, map_eis_mdp1.co_Area);
}

                            if(map_eis_mdp1.cost_center == null) {
pstmt_tMysqlOutput_1.setNull(77, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(77, map_eis_mdp1.cost_center);
}

                            if(map_eis_mdp1.resp_cost_cntr == null) {
pstmt_tMysqlOutput_1.setNull(78, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(78, map_eis_mdp1.resp_cost_cntr);
}

                            if(map_eis_mdp1.customer == null) {
pstmt_tMysqlOutput_1.setNull(79, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(79, map_eis_mdp1.customer);
}

                            if(map_eis_mdp1.leading_order == null) {
pstmt_tMysqlOutput_1.setNull(80, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(80, map_eis_mdp1.leading_order);
}

                            if(map_eis_mdp1.deletion_flag == null) {
pstmt_tMysqlOutput_1.setNull(81, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(81, map_eis_mdp1.deletion_flag);
}

                            if(map_eis_mdp1.long_txt_exists == null) {
pstmt_tMysqlOutput_1.setNull(82, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(82, map_eis_mdp1.long_txt_exists);
}

                            if(map_eis_mdp1.description_81 == null) {
pstmt_tMysqlOutput_1.setNull(83, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(83, map_eis_mdp1.description_81);
}

                            if(map_eis_mdp1.superior_order == null) {
pstmt_tMysqlOutput_1.setNull(84, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(84, map_eis_mdp1.superior_order);
}

                            if(map_eis_mdp1.base_unit == null) {
pstmt_tMysqlOutput_1.setNull(85, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(85, map_eis_mdp1.base_unit);
}

                            if(map_eis_mdp1.quantity == null) {
pstmt_tMysqlOutput_1.setNull(86, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(86, map_eis_mdp1.quantity);
}

                            if(map_eis_mdp1.room == null) {
pstmt_tMysqlOutput_1.setNull(87, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(87, map_eis_mdp1.room);
}

                            if(map_eis_mdp1.list_name == null) {
pstmt_tMysqlOutput_1.setNull(88, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(88, map_eis_mdp1.list_name);
}

                            if(map_eis_mdp1.object_number == null) {
pstmt_tMysqlOutput_1.setNull(89, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(89, map_eis_mdp1.object_number);
}

                            if(map_eis_mdp1.paging_status == null) {
pstmt_tMysqlOutput_1.setNull(90, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(90, map_eis_mdp1.paging_status);
}

                            if(map_eis_mdp1.pgrp_task_list == null) {
pstmt_tMysqlOutput_1.setNull(91, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(91, map_eis_mdp1.pgrp_task_list);
}

                            if(map_eis_mdp1.order_plan_ind == null) {
pstmt_tMysqlOutput_1.setNull(92, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(92, map_eis_mdp1.order_plan_ind);
}

                            if(map_eis_mdp1.group_counter == null) {
pstmt_tMysqlOutput_1.setNull(93, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(93, map_eis_mdp1.group_counter);
}

                            if(map_eis_mdp1.group == null) {
pstmt_tMysqlOutput_1.setNull(94, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(94, map_eis_mdp1.group);
}

                            if(map_eis_mdp1.postal_code == null) {
pstmt_tMysqlOutput_1.setNull(95, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(95, map_eis_mdp1.postal_code);
}

                            if(map_eis_mdp1.profit_center == null) {
pstmt_tMysqlOutput_1.setNull(96, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(96, map_eis_mdp1.profit_center);
}

                            if(map_eis_mdp1.priority_95 == null) {
pstmt_tMysqlOutput_1.setNull(97, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(97, map_eis_mdp1.priority_95);
}

                            if(map_eis_mdp1.wbs_element == null) {
pstmt_tMysqlOutput_1.setNull(98, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(98, map_eis_mdp1.wbs_element);
}

                            if(map_eis_mdp1.wbs_ord_header == null) {
pstmt_tMysqlOutput_1.setNull(99, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(99, map_eis_mdp1.wbs_ord_header);
}

                            if(map_eis_mdp1.notification == null) {
pstmt_tMysqlOutput_1.setNull(100, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(100, map_eis_mdp1.notification);
}

                            if(map_eis_mdp1.region == null) {
pstmt_tMysqlOutput_1.setNull(101, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(101, map_eis_mdp1.region);
}

                            if(map_eis_mdp1.revision == null) {
pstmt_tMysqlOutput_1.setNull(102, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(102, map_eis_mdp1.revision);
}

                            if(map_eis_mdp1.serial_number == null) {
pstmt_tMysqlOutput_1.setNull(103, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(103, map_eis_mdp1.serial_number);
}

                            if(map_eis_mdp1.material == null) {
pstmt_tMysqlOutput_1.setNull(104, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(104, map_eis_mdp1.material);
}

                            if(map_eis_mdp1.service_product == null) {
pstmt_tMysqlOutput_1.setNull(105, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(105, map_eis_mdp1.service_product);
}

                            if(map_eis_mdp1.service_product_104 == null) {
pstmt_tMysqlOutput_1.setNull(106, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(106, map_eis_mdp1.service_product_104);
}

                            if(map_eis_mdp1.division == null) {
pstmt_tMysqlOutput_1.setNull(107, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(107, map_eis_mdp1.division);
}

                            if(map_eis_mdp1.division_sales == null) {
pstmt_tMysqlOutput_1.setNull(108, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(108, map_eis_mdp1.division_sales);
}

                            if(map_eis_mdp1.location == null) {
pstmt_tMysqlOutput_1.setNull(109, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(109, map_eis_mdp1.location);
}

                            if(map_eis_mdp1.street == null) {
pstmt_tMysqlOutput_1.setNull(110, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(110, map_eis_mdp1.street);
}

                            if(map_eis_mdp1.maint_plant == null) {
pstmt_tMysqlOutput_1.setNull(111, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(111, map_eis_mdp1.maint_plant);
}

                            if(map_eis_mdp1.telephone == null) {
pstmt_tMysqlOutput_1.setNull(112, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(112, map_eis_mdp1.telephone);
}

                            if(map_eis_mdp1.sales_office == null) {
pstmt_tMysqlOutput_1.setNull(113, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(113, map_eis_mdp1.sales_office);
}

                            if(map_eis_mdp1.sales_group == null) {
pstmt_tMysqlOutput_1.setNull(114, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(114, map_eis_mdp1.sales_group);
}

                            if(map_eis_mdp1.sales_org == null) {
pstmt_tMysqlOutput_1.setNull(115, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(115, map_eis_mdp1.sales_org);
}

                            if(map_eis_mdp1.sales_org_sales == null) {
pstmt_tMysqlOutput_1.setNull(116, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(116, map_eis_mdp1.sales_org_sales);
}

                            if(map_eis_mdp1.superior_act == null) {
pstmt_tMysqlOutput_1.setNull(117, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(117, map_eis_mdp1.superior_act);
}

                            if(map_eis_mdp1.distr_channel == null) {
pstmt_tMysqlOutput_1.setNull(118, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(118, map_eis_mdp1.distr_channel);
}

                            if(map_eis_mdp1.distr_channel_sal == null) {
pstmt_tMysqlOutput_1.setNull(119, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(119, map_eis_mdp1.distr_channel_sal);
}

                            if(map_eis_mdp1.currency == null) {
pstmt_tMysqlOutput_1.setNull(120, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(120, map_eis_mdp1.currency);
}

                            if(map_eis_mdp1.maint_item == null) {
pstmt_tMysqlOutput_1.setNull(121, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(121, map_eis_mdp1.maint_item);
}

                            if(map_eis_mdp1.maintenance_plan == null) {
pstmt_tMysqlOutput_1.setNull(122, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(122, map_eis_mdp1.maintenance_plan);
}

                            if(map_eis_mdp1.plant == null) {
pstmt_tMysqlOutput_1.setNull(123, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(123, map_eis_mdp1.plant);
}

                            if(map_eis_mdp1.comp == null) {
pstmt_tMysqlOutput_1.setNull(124, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(124, map_eis_mdp1.comp);
}

                            if(map_eis_mdp1.overhead_key == null) {
pstmt_tMysqlOutput_1.setNull(125, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(125, map_eis_mdp1.overhead_key);
}

                            if(map_eis_mdp1.earlst_allow_fin_dat == null) {
pstmt_tMysqlOutput_1.setNull(126, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(126, map_eis_mdp1.earlst_allow_fin_dat);
}

                            if(map_eis_mdp1.earl_allow_start_dat == null) {
pstmt_tMysqlOutput_1.setNull(127, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(127, map_eis_mdp1.earl_allow_start_dat);
}

                            if(map_eis_mdp1.latest_allow_fin_dat == null) {
pstmt_tMysqlOutput_1.setNull(128, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(128, map_eis_mdp1.latest_allow_fin_dat);
}

                            if(map_eis_mdp1.original_due_date == null) {
pstmt_tMysqlOutput_1.setNull(129, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(129, map_eis_mdp1.original_due_date);
}

                            if(map_eis_mdp1.object_list == null) {
pstmt_tMysqlOutput_1.setNull(130, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(130, map_eis_mdp1.object_list);
}

                            if(map_eis_mdp1.catalog_type == null) {
pstmt_tMysqlOutput_1.setNull(131, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(131, map_eis_mdp1.catalog_type);
}

                            if(map_eis_mdp1.code_group == null) {
pstmt_tMysqlOutput_1.setNull(132, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(132, map_eis_mdp1.code_group);
}

                            if(map_eis_mdp1.coding == null) {
pstmt_tMysqlOutput_1.setNull(133, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(133, map_eis_mdp1.coding);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.etl_data_home+"/barrier/database/barrier_landing/data/work_order_eis_mdp1.txt") instanceof java.io.InputStream)){
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("map_eis_mdp1"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_land_work_order_eis_mdp1 jb_land_work_order_eis_mdp1Class = new jb_land_work_order_eis_mdp1();

        int exitCode = jb_land_work_order_eis_mdp1Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_land_work_order_eis_mdp1.class.getClassLoader().getResourceAsStream("barrier_project/jb_land_work_order_eis_mdp1_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_land_work_order_eis_mdp1");
        }
...
/************************************************************************************************
 *     211599 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:43:48 GMT
 ************************************************************************************************/