...
package barrier_project.refresh_facility_level_data_0_1;
...
/**
 * Job: refresh_facility_level_data Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class refresh_facility_level_data implements TalendJob {
...
public String getBarrier_Port(){
	...
	private final String jobName = "refresh_facility_level_data";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				refresh_facility_level_data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(refresh_facility_level_data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_refresh_facility_level_data.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_refresh_facility_level_data.length == 0) {
   					commonByteArray_BARRIER_PROJECT_refresh_facility_level_data = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_refresh_facility_level_data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_refresh_facility_level_data, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_refresh_facility_level_data, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_refresh_facility_level_data) {
...
public static class fgStruct implements routines.system.IPersistableRow<fgStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.barrier_metric_id;
    ...
    public int compareTo(fgStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.barrier_metric_id, other.barrier_metric_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + barrier_metric_id;
hashCode = prime * hashCode + facility_id;
hashCode = prime * hashCode + barrier_type_id;
hashCodeDirty = false;
}
return hashCode;
}
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "facility_level_data_version";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `barrier_metric_id`, `facility_id`, `barrier_type_id`, `snapshot_pid`, `count_of_data`, `snapshot_date`, `rag_status`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.barrier_metric_id = resultSet_tMysqlSCD_1.getInt(1);
                    }
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        sk_tMysqlSCD_1.barrier_type_id = resultSet_tMysqlSCD_1.getInt(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.snapshot_pid = resultSet_tMysqlSCD_1.getString(4);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.count_of_data = resultSet_tMysqlSCD_1.getInt(5);
                    }
                    dateStr_tMysqlSCD_1 = resultSet_tMysqlSCD_1.getString(6);
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.snapshot_date = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(6).getTime());
                        } else {
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(7) != null) {
                        row_tMysqlSCD_1.rag_status = resultSet_tMysqlSCD_1.getString(7);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(8) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(8);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`barrier_metric_id`, `facility_id`, `barrier_type_id`, `updated_at`, `created_at`, `snapshot_pid`, `count_of_data`, `snapshot_date`, `rag_status`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
            insertionStatement_tMysqlSCD_1.setTimestamp(11, new java.sql.Timestamp(start_Hash.get("tMysqlSCD_1")));
            insertionStatement_tMysqlSCD_1.setNull(12, java.sql.Types.DATE);
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `barrier_metric_id` = ? AND `facility_id` = ? AND `barrier_type_id` = ? AND `end_dt` IS NULL";
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT \n  `vw_facility_level_data`.`facility_id`, \n  `vw_facility_level_data`.`barrier_type_id`, \n  `vw_facility_level_data`.`barrier_metric_id`, \n  `vw_facility_level_data`.`count_of_data`, \n  `vw_facility_level_data`.`rag_status`, \n  `vw_facility_level_data`.`created_at`, \n  `vw_facility_level_data`.`updated_at`\nFROM `vw_facility_level_data`";
		...
		try{
                ...
                row1.barrier_type_id = rs_tMysqlInput_1.getInt(2);
                    ...
                    row1.barrier_type_id = null;
							...
							if(colQtyInRs_tMysqlInput_1 < 3) {
								row1.barrier_metric_id = null;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row1.barrier_metric_id = rs_tMysqlInput_1.getInt(3);
            } else {
                    row1.barrier_metric_id = null;
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row1.count_of_data = rs_tMysqlInput_1.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.rag_status = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 5, false);
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(6) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.created_at = rs_tMysqlInput_1.getTimestamp(6);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(7) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.updated_at = rs_tMysqlInput_1.getTimestamp(7);
	            } else {
...
// # Output table : 'fg'
fg_tmp.snapshot_date = Var.snapshot_date ;
fg_tmp.facility_id = row1.facility_id;
fg_tmp.barrier_type_id = row1.barrier_type_id;
fg_tmp.barrier_metric_id = row1.barrier_metric_id;
fg_tmp.count_of_data = row1.count_of_data;
fg_tmp.rag_status = row1.rag_status;
fg_tmp.end_dt = null;
fg_tmp.created_at = row1.created_at;
fg_tmp.updated_at = row1.updated_at;
fg_tmp.start_dt = null;
fg_tmp.snapshot_pid = Var.snapshot_pid ;
fg_tmp.version_no = 0;
fg_tmp.current_flag = false;
fg = fg_tmp;
// ###############################
...
if(fg != null) { 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.barrier_metric_id = fg.barrier_metric_id;
            lookUpKey_tMysqlSCD_1.facility_id = fg.facility_id;
            lookUpKey_tMysqlSCD_1.barrier_type_id = fg.barrier_type_id;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, fg.barrier_metric_id);

                    insertionStatement_tMysqlSCD_1.setInt(2, fg.facility_id);

                    insertionStatement_tMysqlSCD_1.setInt(3, fg.barrier_type_id);

                    if(fg.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
} else {
if(fg.updated_at != null) {
date_tMysqlSCD_1 = fg.updated_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
                    ...
                    if(fg.snapshot_pid == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(6, fg.snapshot_pid);
}

                    insertionStatement_tMysqlSCD_1.setInt(7, fg.count_of_data);

                    if(fg.snapshot_date == null) {
insertionStatement_tMysqlSCD_1.setNull(8, java.sql.Types.DATE);
} else {
if(fg.snapshot_date != null) {
date_tMysqlSCD_1 = fg.snapshot_date.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
insertionStatement_tMysqlSCD_1.setString(8, "0000-00-00 00:00:00");
} else {
insertionStatement_tMysqlSCD_1.setTimestamp(8, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
insertionStatement_tMysqlSCD_1.setNull(8, java.sql.Types.DATE);
}
                    ...
                    if(fg.rag_status == null) {
insertionStatement_tMysqlSCD_1.setNull(9, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(9, fg.rag_status);
}

                int version_tMysqlSCD_1 = 1;
                insertionStatement_tMysqlSCD_1.setInt(10, version_tMysqlSCD_1);

        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tMysqlSCD_1.snapshot_pid == null && fg.snapshot_pid!= null) || (lookUpValue_tMysqlSCD_1.snapshot_pid != null && !lookUpValue_tMysqlSCD_1.snapshot_pid.equals(fg.snapshot_pid)) || lookUpValue_tMysqlSCD_1.count_of_data != fg.count_of_data || (lookUpValue_tMysqlSCD_1.snapshot_date == null && fg.snapshot_date!= null) || ( ( lookUpValue_tMysqlSCD_1.snapshot_date != null && fg.snapshot_date!= null ) && ( (( lookUpValue_tMysqlSCD_1.snapshot_date.getTime()-fg.snapshot_date.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.snapshot_date.getTime()-fg.snapshot_date.getTime() ) < -999) ))  || (lookUpValue_tMysqlSCD_1.rag_status == null && fg.rag_status!= null) || (lookUpValue_tMysqlSCD_1.rag_status != null && !lookUpValue_tMysqlSCD_1.rag_status.equals(fg.rag_status))) {
                    updateForType2_tMysqlSCD_1.setInt(2, fg.barrier_metric_id);

                    updateForType2_tMysqlSCD_1.setInt(3, fg.facility_id);

                    updateForType2_tMysqlSCD_1.setInt(4, fg.barrier_type_id);
...
insertionStatement_tMysqlSCD_1.setString(9, fg.rag_status);
                        ...
                        insertionStatement_tMysqlSCD_1.setInt(10, maxVersion_tMysqlSCD_1);
                ...
                lookUpValue_tMysqlSCD_1.snapshot_pid = fg.snapshot_pid;
                lookUpValue_tMysqlSCD_1.count_of_data = fg.count_of_data;
                lookUpValue_tMysqlSCD_1.snapshot_date = fg.snapshot_date;
                lookUpValue_tMysqlSCD_1.rag_status = fg.rag_status;
...
public static class kloStruct implements routines.system.IPersistableRow<kloStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_refresh_facility_level_data = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final kloStruct other = (kloStruct) obj;
	...
	public void copyDataTo(kloStruct other) {
	...
	public void copyKeysDataTo(kloStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(kloStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("klo" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "facility_level_data";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "facility_level_data" + "` (`snapshot_date`,`facility_id`,`barrier_type_id`,`barrier_metric_id`,`current_flag`,`count_of_data`,`snapshot_pid`,`rag_status`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
kloStruct klo_tmp = new kloStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_2 = "SELECT \n  `facility_level_data_version`.`snapshot_date`, \n  `facility_level_data_version`.`facility_id`, \n  `facility_level_data_version`.`barrier_type_id`, \n  `facility_level_data_version`.`barrier_metric_id`, \n  `facility_level_data_version`.`count_of_data`, \n  `facility_level_data_version`.`rag_status`, \n  `facility_level_data_version`.`end_dt`, \n  `facility_level_data_version`.`created_at`, \n  `facility_level_data_version`.`updated_at`, \n  `facility_level_data_version`.`start_dt`, \n  `facility_level_data_version`.`snapshot_pid`, \n  `facility_level_data_version`.`version_no`, \n  `facility_level_data_version`.`current_flag`\nFROM `facility_level_data_version`\nWhere  `facility_level_data_version`.`current_flag` = 1\n";
		...
		try{
                ...
                row2.barrier_type_id = rs_tMysqlInput_2.getInt(3);
                    ...
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tMysqlInput_2 < 4) {
								row2.barrier_metric_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(4) != null) {
                row2.barrier_metric_id = rs_tMysqlInput_2.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(5) != null) {
                row2.count_of_data = rs_tMysqlInput_2.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.rag_status = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 6, false);
		                    }
	        ...
	        if(rs_tMysqlInput_2.getString(7) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.end_dt = rs_tMysqlInput_2.getTimestamp(7);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(10) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.start_dt = rs_tMysqlInput_2.getTimestamp(10);
	            } else {
        	...
        	row2.snapshot_pid = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 11, false);
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(12) != null) {
                row2.version_no = rs_tMysqlInput_2.getInt(12);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(13) != null) {
                row2.current_flag = rs_tMysqlInput_2.getBoolean(13);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
// # Output table : 'klo'
klo_tmp.snapshot_date = row2.snapshot_date;
klo_tmp.facility_id = row2.facility_id;
klo_tmp.barrier_type_id = row2.barrier_type_id;
klo_tmp.barrier_metric_id = row2.barrier_metric_id;
klo_tmp.current_flag = row2.current_flag;
klo_tmp.count_of_data = row2.count_of_data;
klo_tmp.snapshot_pid = row2.snapshot_pid;
klo_tmp.rag_status = row2.rag_status;
klo_tmp.end_dt = row2.end_dt;
klo_tmp.created_at = row2.created_at;
klo_tmp.updated_at = row2.updated_at;
klo = klo_tmp;
// ###############################
...
if(klo != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//klo
				...
				if(execStat){
					runStat.updateStatOnConnection("klo"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(klo.snapshot_date != null) {
date_tMysqlOutput_1 = klo.snapshot_date.getTime();
...
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.DATE);
                            ...
                            pstmt_tMysqlOutput_1.setInt(2, klo.facility_id);

                            pstmt_tMysqlOutput_1.setInt(3, klo.barrier_type_id);

                            pstmt_tMysqlOutput_1.setInt(4, klo.barrier_metric_id);

                            pstmt_tMysqlOutput_1.setBoolean(5, klo.current_flag);

                            pstmt_tMysqlOutput_1.setInt(6, klo.count_of_data);

                            if(klo.snapshot_pid == null) {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(7, klo.snapshot_pid);
}

                            if(klo.rag_status == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, klo.rag_status);
}

                            if(klo.end_dt != null) {
date_tMysqlOutput_1 = klo.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                            ...
                            if(klo.created_at != null) {
date_tMysqlOutput_1 = klo.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.DATE);
                            ...
                            if(klo.updated_at != null) {
date_tMysqlOutput_1 = klo.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("klo"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final refresh_facility_level_data refresh_facility_level_dataClass = new refresh_facility_level_data();

        int exitCode = refresh_facility_level_dataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = refresh_facility_level_data.class.getClassLoader().getResourceAsStream("barrier_project/refresh_facility_level_data_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : refresh_facility_level_data");
        }
...
/************************************************************************************************
 *     154683 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:11 GMT
 ************************************************************************************************/