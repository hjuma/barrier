...
package barrier_project.jb_barrier_type_refdt_0_1;
...
/**
 * Job: jb_barrier_type_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_type_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_type_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_type_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_type_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_assetid_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_barrierid_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class scd1Struct implements routines.system.IPersistableRow<scd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final scd1Struct other = (scd1Struct) obj;
	...
	public void copyDataTo(scd1Struct other) {
		...
		other.id = this.id;
	            ...
	            other.display_order = this.display_order;
	...
	public void copyKeysDataTo(scd1Struct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_refdt) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.display_order = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.display_order);
    ...
    public String toString() {
		...
		sb.append(",display_order="+String.valueOf(display_order));
     ...
     * Compare keys
     */
    public int compareTo(scd1Struct other) {
...
scd1Struct scd1 = new scd1Struct();
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("scd1" + iterateId, 0, 0);
...
hashCode = prime * hashCode + barrier_id;
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "barrier_type";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `asset_id`, `barrier_id`, `name`, `display_order`, `description`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        sk_tMysqlSCD_1.barrier_id = resultSet_tMysqlSCD_1.getInt(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        sk_tMysqlSCD_1.name = resultSet_tMysqlSCD_1.getString(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.display_order = resultSet_tMysqlSCD_1.getInt(4);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.description = resultSet_tMysqlSCD_1.getString(5);
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`asset_id`, `barrier_id`, `name`, `updated_at`, `created_at`, `display_order`, `description`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
            insertionStatement_tMysqlSCD_1.setTimestamp(9, new java.sql.Timestamp(start_Hash.get("tMysqlSCD_1")));
            insertionStatement_tMysqlSCD_1.setNull(10, java.sql.Types.DATE);
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `asset_id` = ? AND `barrier_id` = ? AND `name` = ? AND `end_dt` IS NULL";
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetidStruct> tHash_Lookup_assetid = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetidStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetidStruct>) 
					globalMap.get( "tHash_Lookup_assetid" ))
					;					
					
	

assetidStruct assetidHashKey = new assetidStruct();
assetidStruct assetidDefault = new assetidStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barrieridStruct> tHash_Lookup_barrierid = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barrieridStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barrieridStruct>) 
					globalMap.get( "tHash_Lookup_barrierid" ))
					;					
					
	

barrieridStruct barrieridHashKey = new barrieridStruct();
barrieridStruct barrieridDefault = new barrieridStruct();
// ###############################        
...
scd1Struct scd1_tmp = new scd1Struct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/barrier_type_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.asset_id = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'asset_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.display_order = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'display_order' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.created_at = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "yyyy-MM-dd HH:mm:ss");
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.updated_at = ParserUtils.parseTo_Date(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], "yyyy-MM-dd HH:mm:ss");
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopassetid = false;
       		  	    	
       		  	    	
 							assetidStruct assetidObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_assetid__id = row1.asset_id ;
	                        		    	if(exprKeyValue_assetid__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			assetidHashKey.id = (int)(Integer) exprKeyValue_assetid__id;
                        		    		}
                        		    		

								
		                        	assetidHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_assetid.lookup( assetidHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_assetid.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_assetid != null && tHash_Lookup_assetid.getCount(assetidHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'assetid' and it contains more one result from keys :  assetid.id = '" + assetidHashKey.id + "'");
								} // G 071
							

							assetidStruct assetid = null;
                    		  	 
							   
                    		  	 
	       		  	    	assetidStruct fromLookup_assetid = null;
							assetid = assetidDefault;
								...
								if (tHash_Lookup_assetid !=null && tHash_Lookup_assetid.hasNext()) { // G 099
								
							
								
								fromLookup_assetid = tHash_Lookup_assetid.next();
							...
							if(fromLookup_assetid != null) {
								assetid = fromLookup_assetid;
							}
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "barrierid" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopbarrierid = false;
       		  	    	
       		  	    	
 							barrieridStruct barrieridObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_barrierid__id = row1.barrier_id ;
	                        		    	if(exprKeyValue_barrierid__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			barrieridHashKey.id = (int)(Integer) exprKeyValue_barrierid__id;
                        		    		}
                        		    		

								
		                        	barrieridHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_barrierid.lookup( barrieridHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_barrierid.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_barrierid != null && tHash_Lookup_barrierid.getCount(barrieridHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'barrierid' and it contains more one result from keys :  barrierid.id = '" + barrieridHashKey.id + "'");
								} // G 071
							

							barrieridStruct barrierid = null;
                    		  	 
							   
                    		  	 
	       		  	    	barrieridStruct fromLookup_barrierid = null;
							barrierid = barrieridDefault;
										 
							
								 
							
							
								if (tHash_Lookup_barrierid !=null && tHash_Lookup_barrierid.hasNext()) { // G 099
								
							
								
								fromLookup_barrierid = tHash_Lookup_barrierid.next();
							...
							if(fromLookup_barrierid != null) {
								barrierid = fromLookup_barrierid;
							}
...
// # Output table : 'scd1'
scd1_tmp.id = row1.id;
scd1_tmp.asset_id = row1.asset_id;
scd1_tmp.barrier_id = row1.barrier_id;
scd1_tmp.name = row1.name;
scd1_tmp.description = row1.name ;
scd1_tmp.display_order = row1.display_order;
scd1_tmp.current_flag = 0;
scd1_tmp.version_no = 0;
scd1_tmp.start_dt = null;
scd1_tmp.end_dt = null;
scd1_tmp.created_at = row1.created_at;
scd1_tmp.updated_at = row1.updated_at;
scd1 = scd1_tmp;
...
if(scd1 != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//scd1
				...
				if(execStat){
					runStat.updateStatOnConnection("scd1"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.asset_id = scd1.asset_id;
            lookUpKey_tMysqlSCD_1.barrier_id = scd1.barrier_id;
            lookUpKey_tMysqlSCD_1.name = scd1.name;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, scd1.asset_id);

                    insertionStatement_tMysqlSCD_1.setInt(2, scd1.barrier_id);

                    if(scd1.name == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(3, scd1.name);
}

                    if(scd1.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
} else {
if(scd1.updated_at != null) {
date_tMysqlSCD_1 = scd1.updated_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
                    ...
                    if(scd1.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
} else {
if(scd1.created_at != null) {
date_tMysqlSCD_1 = scd1.created_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(6, scd1.display_order);

                    if(scd1.description == null) {
insertionStatement_tMysqlSCD_1.setNull(7, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(7, scd1.description);
}

                int version_tMysqlSCD_1 = 1;
                insertionStatement_tMysqlSCD_1.setInt(8, version_tMysqlSCD_1);

        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
    } else {
            if(lookUpValue_tMysqlSCD_1.display_order != scd1.display_order || (lookUpValue_tMysqlSCD_1.description == null && scd1.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(scd1.description))) {
                    updateForType2_tMysqlSCD_1.setInt(2, scd1.asset_id);

                    updateForType2_tMysqlSCD_1.setInt(3, scd1.barrier_id);

                    if(scd1.name == null) {
updateForType2_tMysqlSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(4, scd1.name);
}
...
insertionStatement_tMysqlSCD_1.setString(7, scd1.description);
                        ...
                        insertionStatement_tMysqlSCD_1.setInt(8, maxVersion_tMysqlSCD_1);
                ...
                lookUpValue_tMysqlSCD_1.display_order = scd1.display_order;
                lookUpValue_tMysqlSCD_1.description = scd1.description;
...
// # Lookup hashes releasing
					if(tHash_Lookup_assetid != null) {
						tHash_Lookup_assetid.endGet();
					}
					globalMap.remove( "tHash_Lookup_assetid" );

					
					
				
					if(tHash_Lookup_barrierid != null) {
						tHash_Lookup_barrierid.endGet();
					}
					globalMap.remove( "tHash_Lookup_barrierid" );
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("scd1"+iterateId,2, 0); 
			 	}
			}
...
public static class assetidStruct implements routines.system.IPersistableComparableLookupRow<assetidStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final assetidStruct other = (assetidStruct) obj;
	...
	public void copyDataTo(assetidStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(assetidStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(assetidStruct other) {
...
assetidStruct assetid = new assetidStruct();
	...
	/**
	 * [tAdvancedHash_assetid begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_assetid", false);
		start_Hash.put("tAdvancedHash_assetid", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_assetid";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("assetid" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_assetid = 0;
		
    	class BytesLimit65535_tAdvancedHash_assetid{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_assetid().limitLog4jByte();

			   		// connection name:assetid
			   		// source node:tMap_2 - inputs:(row2) outputs:(assetid,assetid) | target node:tAdvancedHash_assetid - inputs:(assetid) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,assetid,barrierid) outputs:(scd1)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_assetid = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetidStruct> tHash_Lookup_assetid =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<assetidStruct>getLookup(matchingModeEnum_assetid);
	   						   
		   	   	   globalMap.put("tHash_Lookup_assetid", tHash_Lookup_assetid);
...
/**
 * [tAdvancedHash_assetid begin ] stop
 */
...
// ###############################
// # Outputs initialization
assetidStruct assetid_tmp = new assetidStruct();
// ###############################
...
// # Output table : 'assetid'
assetid_tmp.id = row2.id ;
assetid = assetid_tmp;
// ###############################
...
if(assetid != null) { 
	...
	/**
	 * [tAdvancedHash_assetid main ] start
	 */
	...
	currentComponent="tAdvancedHash_assetid";
			...
			//assetid
				...
				if(execStat){
					runStat.updateStatOnConnection("assetid"+iterateId,1, 1);
				} 
					...
					assetidStruct assetid_HashRow = new assetidStruct();
		   	   	   
				
				assetid_HashRow.id = assetid.id;
				
			tHash_Lookup_assetid.put(assetid_HashRow);
	...
	tos_count_tAdvancedHash_assetid++;

/**
 * [tAdvancedHash_assetid main ] stop
 */

} // End of branch "assetid"
 ...
 */
	...
	/**
	 * [tAdvancedHash_assetid end ] start
	 */
...
tHash_Lookup_assetid.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("assetid"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_assetid", true);
end_Hash.put("tAdvancedHash_assetid", System.currentTimeMillis());




/**
 * [tAdvancedHash_assetid end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_assetid finally ] start
	 */
...
/**
 * [tAdvancedHash_assetid finally ] stop
 */
...
public static class barrieridStruct implements routines.system.IPersistableComparableLookupRow<barrieridStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_type_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final barrieridStruct other = (barrieridStruct) obj;
	...
	public void copyDataTo(barrieridStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(barrieridStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(barrieridStruct other) {
...
barrieridStruct barrierid = new barrieridStruct();
	...
	/**
	 * [tAdvancedHash_barrierid begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_barrierid", false);
		start_Hash.put("tAdvancedHash_barrierid", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_barrierid";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("barrierid" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_barrierid = 0;
		
    	class BytesLimit65535_tAdvancedHash_barrierid{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_barrierid().limitLog4jByte();

			   		// connection name:barrierid
			   		// source node:tMap_3 - inputs:(row3) outputs:(barrierid,barrierid) | target node:tAdvancedHash_barrierid - inputs:(barrierid) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,assetid,barrierid) outputs:(scd1)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_barrierid = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<barrieridStruct> tHash_Lookup_barrierid =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<barrieridStruct>getLookup(matchingModeEnum_barrierid);
	   						   
		   	   	   globalMap.put("tHash_Lookup_barrierid", tHash_Lookup_barrierid);
...
/**
 * [tAdvancedHash_barrierid begin ] stop
 */
...
// ###############################
// # Outputs initialization
barrieridStruct barrierid_tmp = new barrieridStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_2 = "SELECT \n  `barrier`.`id`, \n  `barrier`.`start_dt`, \n  `barrier`.`current_flag`, \n  `barrier`.`version_no`, \n  `barrier`.`code`, \n  `barrier`.`name`, \n  `barrier`.`description`, \n  `barrier`.`display_order`, \n  `barrier`.`end_dt`, \n  `barrier`.`created_at`, \n  `barrier`.`updated_at`\nFROM `barrier`";
		...
		try{
	        ...
	        if(rs_tMysqlInput_2.getString(2) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.start_dt = rs_tMysqlInput_2.getTimestamp(2);
	            } else {
	                row3.start_dt = (java.util.Date) year0_tMysqlInput_2.clone();
	            }
	        } else {
	            row3.start_dt =  null;
	        }			 
							...
							if(colQtyInRs_tMysqlInput_2 < 3) {
								row3.current_flag = false;
							} else {
	                         		
            if(rs_tMysqlInput_2.getObject(3) != null) {
                row3.current_flag = rs_tMysqlInput_2.getBoolean(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(4) != null) {
                row3.version_no = rs_tMysqlInput_2.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.code = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 5, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 6) {
								row3.name = null;
							} else {
	                         		
        	row3.name = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 6, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 7) {
								row3.description = null;
							} else {
	                         		
        	row3.description = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 7, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 8) {
								row3.display_order = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(8) != null) {
                row3.display_order = rs_tMysqlInput_2.getInt(8);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	        ...
	        if(rs_tMysqlInput_2.getString(9) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.end_dt = rs_tMysqlInput_2.getTimestamp(9);
	            } else {
	                row3.end_dt = (java.util.Date) year0_tMysqlInput_2.clone();
	            }
	        } else {
	            row3.end_dt =  null;
	        }			 
	        ...
	        if(rs_tMysqlInput_2.getString(10) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.created_at = rs_tMysqlInput_2.getTimestamp(10);
	            } else {
	                row3.created_at = (java.util.Date) year0_tMysqlInput_2.clone();
	            }
	        } else {
	            row3.created_at =  null;
	        }			 
	        ...
	        if(rs_tMysqlInput_2.getString(11) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row3.updated_at = rs_tMysqlInput_2.getTimestamp(11);
	            } else {
	                row3.updated_at = (java.util.Date) year0_tMysqlInput_2.clone();
	            }
	        } else {
	            row3.updated_at =  null;
	        }			 
...
// # Output table : 'barrierid'
barrierid_tmp.id = row3.id ;
barrierid = barrierid_tmp;
// ###############################
...
if(barrierid != null) { 
	...
	/**
	 * [tAdvancedHash_barrierid main ] start
	 */
	...
	currentComponent="tAdvancedHash_barrierid";
			...
			//barrierid
				...
				if(execStat){
					runStat.updateStatOnConnection("barrierid"+iterateId,1, 1);
				} 
					...
					barrieridStruct barrierid_HashRow = new barrieridStruct();
		   	   	   
				
				barrierid_HashRow.id = barrierid.id;
				
			tHash_Lookup_barrierid.put(barrierid_HashRow);
	...
	tos_count_tAdvancedHash_barrierid++;

/**
 * [tAdvancedHash_barrierid main ] stop
 */

} // End of branch "barrierid"
 ...
 */
	...
	/**
	 * [tAdvancedHash_barrierid end ] start
	 */
...
tHash_Lookup_barrierid.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("barrierid"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_barrierid", true);
end_Hash.put("tAdvancedHash_barrierid", System.currentTimeMillis());




/**
 * [tAdvancedHash_barrierid end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_barrierid finally ] start
	 */
...
/**
 * [tAdvancedHash_barrierid finally ] stop
 */
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_type_refdt jb_barrier_type_refdtClass = new jb_barrier_type_refdt();

        int exitCode = jb_barrier_type_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_type_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_type_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_type_refdt");
        }
...
/************************************************************************************************
 *     166548 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:09 GMT
 ************************************************************************************************/