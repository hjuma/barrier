...
package barrier_project.jb_business_unit_refdt_0_1;
...
/**
 * Job: jb_business_unit_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_business_unit_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_business_unit_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_business_unit_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_business_unit_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class dfgStruct implements routines.system.IPersistableRow<dfgStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_business_unit_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final dfgStruct other = (dfgStruct) obj;
	...
	public void copyDataTo(dfgStruct other) {
	...
	public void copyKeysDataTo(dfgStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_business_unit_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_business_unit_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(dfgStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("dfg" + iterateId, 0, 0);
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "business_unit";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `name`, `description`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.version_no = resultSet_tMysqlSCD_1.getInt(3);
                    }
            cache_tMysqlSCD_1.put(sk_tMysqlSCD_1, row_tMysqlSCD_1);
        }
        resultSet_tMysqlSCD_1.close();
        statement_tMysqlSCD_1.close();
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`name`, `created_at`, `updated_at`, `description`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
            insertionStatement_tMysqlSCD_1.setTimestamp(6, new java.sql.Timestamp(start_Hash.get("tMysqlSCD_1")));
...
dfgStruct dfg_tmp = new dfgStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/business_unit_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'dfg'
dfg_tmp.id = row1.id;
dfg_tmp.start_dt = null;
dfg_tmp.current_flag = false;
dfg_tmp.version_no = null;
dfg_tmp.name = row1.name;
dfg_tmp.description = row1.description;
dfg_tmp.end_dt = null;
dfg_tmp.created_at = row1.created_at;
dfg_tmp.updated_at = row1.updated_at;
dfg = dfg_tmp;
// ###############################
...
if(dfg != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//dfg
				...
				if(execStat){
					runStat.updateStatOnConnection("dfg"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.name = dfg.name;
...
insertionStatement_tMysqlSCD_1.setString(1, dfg.name);
}

                    if(dfg.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
} else {
if(dfg.created_at != null) {
date_tMysqlSCD_1 = dfg.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
                    ...
                    if(dfg.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(dfg.updated_at != null) {
date_tMysqlSCD_1 = dfg.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
                    ...
                    if(dfg.description == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(4, dfg.description);
}

                int version_tMysqlSCD_1 = 1;
                insertionStatement_tMysqlSCD_1.setInt(5, version_tMysqlSCD_1);

        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tMysqlSCD_1.description == null && dfg.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(dfg.description))) {
                    if(dfg.name == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, dfg.name);
}
...
insertionStatement_tMysqlSCD_1.setString(4, dfg.description);
                        ...
                        insertionStatement_tMysqlSCD_1.setInt(5, maxVersion_tMysqlSCD_1);
                ...
                lookUpValue_tMysqlSCD_1.description = dfg.description;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("dfg"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_business_unit_refdt jb_business_unit_refdtClass = new jb_business_unit_refdt();

        int exitCode = jb_business_unit_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_business_unit_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_business_unit_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_business_unit_refdt");
        }
...
/************************************************************************************************
 *     91946 characters generated by Talend Open Studio for Data Integration 
