...
package barrier_project.jb_planner_group_refdt_0_1;
...
/**
 * Job: jb_planner_group_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_planner_group_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_planner_group_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_planner_group_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_planner_group_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class sdStruct implements routines.system.IPersistableRow<sdStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_planner_group_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final sdStruct other = (sdStruct) obj;
	...
	public void copyDataTo(sdStruct other) {
	...
	public void copyKeysDataTo(sdStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_planner_group_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_planner_group_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(sdStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("sd" + iterateId, 0, 0);
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "planner_group";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `asset_id`, `description`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `asset_id`, `created_at`, `updated_at`, `description`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, b'1', ?, ?, ?)";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/planner_group_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'sd'
sd_tmp.id = row1.id;
sd_tmp.code = row1.code;
sd_tmp.asset_id = row1.asset_id;
sd_tmp.description = row1.description;
sd_tmp.current_flag = false;
sd_tmp.version_no = 0;
sd_tmp.start_dt = null;
sd_tmp.end_dt = null;
sd_tmp.created_at = row1.created_at;
sd_tmp.updated_at = row1.updated_at;
sd = sd_tmp;
// ###############################
...
if(sd != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//sd
				...
				if(execStat){
					runStat.updateStatOnConnection("sd"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = sd.code;
            lookUpKey_tMysqlSCD_1.asset_id = sd.asset_id;
...
insertionStatement_tMysqlSCD_1.setString(1, sd.code);
}

                    insertionStatement_tMysqlSCD_1.setInt(2, sd.asset_id);

                    if(sd.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(sd.created_at != null) {
date_tMysqlSCD_1 = sd.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setString(5, sd.description);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.description == null && sd.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(sd.description))) {
                    if(sd.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, sd.code);
}

                    updateForType2_tMysqlSCD_1.setInt(3, sd.asset_id);
...
insertionStatement_tMysqlSCD_1.setString(5, sd.description);
                ...
                lookUpValue_tMysqlSCD_1.description = sd.description;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("sd"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_planner_group_refdt jb_planner_group_refdtClass = new jb_planner_group_refdt();

        int exitCode = jb_planner_group_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_planner_group_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_planner_group_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_planner_group_refdt");
        }
...
/************************************************************************************************
 *     93702 characters generated by Talend Open Studio for Data Integration 
