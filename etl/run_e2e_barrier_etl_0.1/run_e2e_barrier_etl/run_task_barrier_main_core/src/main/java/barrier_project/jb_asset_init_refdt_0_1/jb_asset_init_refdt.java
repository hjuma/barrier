...
package barrier_project.jb_asset_init_refdt_0_1;
...
/**
 * Job: jb_asset_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_asset_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_asset_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_asset_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_asset_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class ghyStruct implements routines.system.IPersistableRow<ghyStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_asset_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final ghyStruct other = (ghyStruct) obj;
	...
	public void copyDataTo(ghyStruct other) {
	...
	public void copyKeysDataTo(ghyStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_asset_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_asset_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(ghyStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("ghy" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "asset";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "asset" + "` (`id`,`code`,`business_unit_id`,`name`,`current_flag`,`version_no`,`start_dt`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `code` = ?,`business_unit_id` = ?,`name` = ?,`start_dt` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
...
ghyStruct ghy_tmp = new ghyStruct();
// ###############################
...
// # Output table : 'ghy'
ghy_tmp.id = row1.id;
ghy_tmp.code = row1.code;
ghy_tmp.business_unit_id = row1.business_unit_id;
ghy_tmp.name = row1.name;
ghy_tmp.current_flag = 1;
ghy_tmp.version_no = 1;
ghy_tmp.start_dt = Var.var1 ;
ghy_tmp.end_dt = null;
ghy_tmp.created_at = row1.created_at;
ghy_tmp.updated_at = row1.updated_at;
ghy = ghy_tmp;
// ###############################
...
if(ghy != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//ghy
				...
				if(execStat){
					runStat.updateStatOnConnection("ghy"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setInt(1, ghy.id);

                    if(ghy.code == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, ghy.code);
}

                    pstmt_tMysqlOutput_1.setInt(3, ghy.business_unit_id);

                    if(ghy.name == null) {
pstmt_tMysqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(4, ghy.name);
}

                    pstmt_tMysqlOutput_1.setInt(5, ghy.current_flag);

                    pstmt_tMysqlOutput_1.setInt(6, ghy.version_no);

                    if(ghy.start_dt != null) {
date_tMysqlOutput_1 = ghy.start_dt.getTime();
...
} else {pstmt_tMysqlOutput_1.setTimestamp(7, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(7, java.sql.Types.DATE);
                    ...
                    if(ghy.end_dt != null) {
date_tMysqlOutput_1 = ghy.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.DATE);
                    ...
                    if(ghy.created_at != null) {
date_tMysqlOutput_1 = ghy.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                    ...
                    if(ghy.updated_at != null) {
date_tMysqlOutput_1 = ghy.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
} else {pstmt_tMysqlOutput_1.setString(11, ghy.code);
}

                    pstmt_tMysqlOutput_1.setInt(12, ghy.business_unit_id);

                    if(ghy.name == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, ghy.name);
}

                    if(ghy.start_dt != null) {
date_tMysqlOutput_1 = ghy.start_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(14, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(14, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.DATE);
}

                    if(ghy.end_dt != null) {
date_tMysqlOutput_1 = ghy.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(15, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(15, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.DATE);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("ghy"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_asset_init_refdt jb_asset_init_refdtClass = new jb_asset_init_refdt();

        int exitCode = jb_asset_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_asset_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_asset_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_asset_init_refdt");
        }
...
/************************************************************************************************
 *     93042 characters generated by Talend Open Studio for Data Integration 
