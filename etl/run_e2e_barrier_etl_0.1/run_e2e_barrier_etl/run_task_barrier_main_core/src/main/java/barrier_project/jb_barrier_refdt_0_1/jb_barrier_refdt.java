...
package barrier_project.jb_barrier_refdt_0_1;
...
/**
 * Job: jb_barrier_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class tyiStruct implements routines.system.IPersistableRow<tyiStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final tyiStruct other = (tyiStruct) obj;
	...
	public void copyDataTo(tyiStruct other) {
	...
	public void copyKeysDataTo(tyiStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(tyiStruct other) {
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("tyi" + iterateId, 0, 0);
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "barrier";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `id`, `description`, `display_order`, `name`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        sk_tMysqlSCD_1.id = resultSet_tMysqlSCD_1.getInt(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.description = resultSet_tMysqlSCD_1.getString(3);
                    }
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.name = resultSet_tMysqlSCD_1.getString(5);
                    }
        ...
        int nextSurrogateKey_tMysqlSCD_1 = 1;
            if(cache_tMysqlSCD_1.size() > 0) {
        String tmpQuery_tMysqlSCD_1 = "SELECT MAX(`id`) FROM `" + tableName_tMysqlSCD_1 + "`";
        java.sql.Statement tmpStmt_tMysqlSCD_1 = connection_tMysqlSCD_1.createStatement();
        java.sql.ResultSet tmpRS_tMysqlSCD_1 = tmpStmt_tMysqlSCD_1.executeQuery(tmpQuery_tMysqlSCD_1);
        if(tmpRS_tMysqlSCD_1.next() && tmpRS_tMysqlSCD_1.getObject(1) != null) {
            nextSurrogateKey_tMysqlSCD_1 = tmpRS_tMysqlSCD_1.getInt(1) + 1;
        }
        tmpRS_tMysqlSCD_1.close();
        tmpStmt_tMysqlSCD_1.close();
            }            
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`id`, `code`, `created_at`, `updated_at`, `description`, `display_order`, `name`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `code` = ? AND `id` = ? AND `end_dt` IS NULL";
...
tyiStruct tyi_tmp = new tyiStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/barrier_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
// # Output table : 'tyi'
tyi_tmp.id = row1.id;
tyi_tmp.start_dt = null;
tyi_tmp.current_flag = false;
tyi_tmp.version_no = 0;
tyi_tmp.code = row1.code;
tyi_tmp.name = row1.name;
tyi_tmp.description = row1.name ;
tyi_tmp.display_order = row1.display_order;
tyi_tmp.end_dt = null;
tyi_tmp.created_at = row1.created_at;
tyi_tmp.updated_at = row1.updated_at;
tyi = tyi_tmp;
// ###############################
...
if(tyi != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//tyi
				...
				if(execStat){
					runStat.updateStatOnConnection("tyi"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = tyi.code;
            lookUpKey_tMysqlSCD_1.id = tyi.id;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, nextSurrogateKey_tMysqlSCD_1);

                    nextSurrogateKey_tMysqlSCD_1++;
                    if(tyi.code == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(2, tyi.code);
}

                    if(tyi.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
} else {
if(tyi.created_at != null) {
date_tMysqlSCD_1 = tyi.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
                    ...
                    if(tyi.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
} else {
if(tyi.updated_at != null) {
date_tMysqlSCD_1 = tyi.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
                    ...
                    if(tyi.description == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(5, tyi.description);
}

                    insertionStatement_tMysqlSCD_1.setInt(6, tyi.display_order);

                    if(tyi.name == null) {
insertionStatement_tMysqlSCD_1.setNull(7, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(7, tyi.name);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.description == null && tyi.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(tyi.description)) || lookUpValue_tMysqlSCD_1.display_order != tyi.display_order || (lookUpValue_tMysqlSCD_1.name == null && tyi.name!= null) || (lookUpValue_tMysqlSCD_1.name != null && !lookUpValue_tMysqlSCD_1.name.equals(tyi.name))) {
                    if(tyi.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, tyi.code);
}

                    updateForType2_tMysqlSCD_1.setInt(3, tyi.id);
...
insertionStatement_tMysqlSCD_1.setString(7, tyi.name);
                ...
                lookUpValue_tMysqlSCD_1.description = tyi.description;
                lookUpValue_tMysqlSCD_1.display_order = tyi.display_order;
                lookUpValue_tMysqlSCD_1.name = tyi.name;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("tyi"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_refdt jb_barrier_refdtClass = new jb_barrier_refdt();

        int exitCode = jb_barrier_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_refdt");
        }
...
/************************************************************************************************
 *     96755 characters generated by Talend Open Studio for Data Integration 
