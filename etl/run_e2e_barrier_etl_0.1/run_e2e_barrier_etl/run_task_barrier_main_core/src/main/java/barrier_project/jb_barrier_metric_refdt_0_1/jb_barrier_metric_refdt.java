...
package barrier_project.jb_barrier_metric_refdt_0_1;
...
/**
 * Job: jb_barrier_metric_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_barrier_metric_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_barrier_metric_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_barrier_metric_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_barrier_metric_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class scd1Struct implements routines.system.IPersistableRow<scd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_barrier_metric_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt = new byte[0];
    ...
    public String loopKey;
			    ...
			    public int barrier_element_id;

				public int getBarrier_element_id () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_barrier_metric_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_barrier_metric_refdt) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.barrier_element_id = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.barrier_element_id);
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + (name == null ? 0 : name.hashCode());
hashCodeDirty = false;
}
return hashCode;
}
...
private int barrier_element_id;
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "barrier_metric";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `name`, `updated_at`, `display_order`, `description`, `barrier_element_id`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.name = resultSet_tMysqlSCD_1.getString(1);
                    }
                    dateStr_tMysqlSCD_1 = resultSet_tMysqlSCD_1.getString(2);
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.updated_at = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(2).getTime());
                        } else {
                            row_tMysqlSCD_1.updated_at = (java.util.Date) dateYear0_tMysqlSCD_1.clone();
                        }
                    } else {
                        row_tMysqlSCD_1.updated_at = null;
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.display_order = resultSet_tMysqlSCD_1.getInt(3);
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`name`, `created_at`, `updated_at`, `display_order`, `description`, `barrier_element_id`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType1_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `updated_at` = ? WHERE `name` = ?";
        java.sql.PreparedStatement updateForType1_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(updateSQLForType1_tMysqlSCD_1);        
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `name` = ? AND `end_dt` IS NULL";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/barrier_metric_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.barrier_element_id = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
    										...
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'barrier_element_id' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
...
// # Output table : 'scd1'
scd1_tmp.id = row1.id;
scd1_tmp.barrier_element_id = row1.barrier_element_id;
scd1_tmp.name = row1.name;
scd1_tmp.description = null;
...
insertionStatement_tMysqlSCD_1.setString(1, scd1.name);
}
...
insertionStatement_tMysqlSCD_1.setNull(3, java.sql.Types.DATE);
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(4, scd1.display_order);

                    if(scd1.description == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(5, scd1.description);
}

                    insertionStatement_tMysqlSCD_1.setInt(6, scd1.barrier_element_id);
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.updated_at == null && scd1.updated_at!= null) || ((lookUpValue_tMysqlSCD_1.updated_at != null && scd1.updated_at!= null ) && ((( lookUpValue_tMysqlSCD_1.updated_at.getTime()-scd1.updated_at.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.updated_at.getTime()-scd1.updated_at.getTime() ) < -999) )) ) {
                    if(scd1.updated_at == null) {
updateForType1_tMysqlSCD_1.setNull(1, java.sql.Types.DATE);
} else {
if(scd1.updated_at != null) {
date_tMysqlSCD_1 = scd1.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
updateForType1_tMysqlSCD_1.setString(1, "0000-00-00 00:00:00");
} else {
updateForType1_tMysqlSCD_1.setTimestamp(1, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
updateForType1_tMysqlSCD_1.setNull(1, java.sql.Types.DATE);
}
                    ...
                    if(scd1.name == null) {
updateForType1_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType1_tMysqlSCD_1.setString(2, scd1.name);
}

                nb_line_update_tMysqlSCD_1 += updateForType1_tMysqlSCD_1.executeUpdate();
            }
            if(lookUpValue_tMysqlSCD_1.display_order != scd1.display_order || (lookUpValue_tMysqlSCD_1.description == null && scd1.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(scd1.description)) || lookUpValue_tMysqlSCD_1.barrier_element_id != scd1.barrier_element_id) {
                    if(scd1.name == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, scd1.name);
}
...
insertionStatement_tMysqlSCD_1.setString(5, scd1.description);
                ...
                lookUpValue_tMysqlSCD_1.updated_at = scd1.updated_at;
                lookUpValue_tMysqlSCD_1.display_order = scd1.display_order;
                lookUpValue_tMysqlSCD_1.description = scd1.description;
                lookUpValue_tMysqlSCD_1.barrier_element_id = scd1.barrier_element_id;
 ...
 */
    ...
    insertionStatement_tMysqlSCD_1.close();
        updateForType1_tMysqlSCD_1.close();
 ...
 */
    ...
    public static void main(String[] args){
        final jb_barrier_metric_refdt jb_barrier_metric_refdtClass = new jb_barrier_metric_refdt();

        int exitCode = jb_barrier_metric_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_barrier_metric_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_barrier_metric_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_barrier_metric_refdt");
        }
...
/************************************************************************************************
 *     97794 characters generated by Talend Open Studio for Data Integration 
