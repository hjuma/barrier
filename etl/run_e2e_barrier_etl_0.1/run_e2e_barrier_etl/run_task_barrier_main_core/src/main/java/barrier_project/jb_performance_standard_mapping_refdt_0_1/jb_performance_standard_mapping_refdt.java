...
package barrier_project.jb_performance_standard_mapping_refdt_0_1;
...
/**
 * Job: jb_performance_standard_mapping_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_performance_standard_mapping_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_performance_standard_mapping_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_performance_standard_mapping_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_performance_standard_mapping_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_fg_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_asset_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class scd1Struct implements routines.system.IPersistableRow<scd1Struct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_mapping_refdt) {
    ...
    public String toString() {
		...
		sb.append(",ps_id="+String.valueOf(ps_id));
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + (code == null ? 0 : code.hashCode());
hashCodeDirty = false;
}
return hashCode;
}
...
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "performance_standard_mapping";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `code`, `description`, `ps_id`, `asset_id`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.code = resultSet_tMysqlSCD_1.getString(1);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        row_tMysqlSCD_1.description = resultSet_tMysqlSCD_1.getString(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        row_tMysqlSCD_1.ps_id = resultSet_tMysqlSCD_1.getInt(3);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(4) != null) {
                        row_tMysqlSCD_1.asset_id = resultSet_tMysqlSCD_1.getInt(4);
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`code`, `created_at`, `updated_at`, `description`, `ps_id`, `asset_id`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `code` = ? AND `end_dt` IS NULL";
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<fgStruct> tHash_Lookup_fg = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<fgStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<fgStruct>) 
					globalMap.get( "tHash_Lookup_fg" ))
					;					
					
	

fgStruct fgHashKey = new fgStruct();
fgStruct fgDefault = new fgStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetStruct> tHash_Lookup_asset = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetStruct>) 
					globalMap.get( "tHash_Lookup_asset" ))
					;					
					
	

assetStruct assetHashKey = new assetStruct();
assetStruct assetDefault = new assetStruct();
// ###############################        
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.etl_data_home+"barrier/database/barrier_landing/data/performance_standard_mapping_refdt.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.ps_id = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_2 = false;
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopfg = false;
       		  	    	
       		  	    	
 							fgStruct fgObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
	                        		    	...
	                        		    	Object exprKeyValue_fg__id = row1.ps_id ;
	                        		    	if(exprKeyValue_fg__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_2 = true;
	                        		    	} else {
                        		    			fgHashKey.id = (int)(Integer) exprKeyValue_fg__id;
                        		    		}
                        		    		

								
		                        	fgHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_fg.lookup( fgHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_2 || !tHash_Lookup_fg.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_fg != null && tHash_Lookup_fg.getCount(fgHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'fg' and it contains more one result from keys :  fg.id = '" + fgHashKey.id + "'");
								} // G 071
							...
							fg = fgDefault;
								...
								if (tHash_Lookup_fg !=null && tHash_Lookup_fg.hasNext()) { // G 099
								
							
								
								fromLookup_fg = tHash_Lookup_fg.next();
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopasset = false;
       		  	    	
       		  	    	
 							assetStruct assetObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
	                        		    	...
	                        		    	Object exprKeyValue_asset__id = row1.asset_id ;
	                        		    	if(exprKeyValue_asset__id == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_2 = true;
	                        		    	} else {
                        		    			assetHashKey.id = (int)(Integer) exprKeyValue_asset__id;
                        		    		}
                        		    		

								
		                        	assetHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_asset.lookup( assetHashKey );
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_2 || !tHash_Lookup_asset.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_asset != null && tHash_Lookup_asset.getCount(assetHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'asset' and it contains more one result from keys :  asset.id = '" + assetHashKey.id + "'");
								} // G 071
							

							assetStruct asset = null;
                    		  	 
							   
                    		  	 
	       		  	    	assetStruct fromLookup_asset = null;
							asset = assetDefault;
								...
								if (tHash_Lookup_asset !=null && tHash_Lookup_asset.hasNext()) { // G 099
								
							
								
								fromLookup_asset = tHash_Lookup_asset.next();
							...
							if(fromLookup_asset != null) {
								asset = fromLookup_asset;
							}
...
// # Output table : 'scd1'
scd1_tmp.id = row1.id;
scd1_tmp.code = row1.code;
scd1_tmp.asset_id = row1.asset_id;
scd1_tmp.ps_id = row1.ps_id;
scd1_tmp.description = row1.description;
...
if(scd1 != null) { 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.code = scd1.code;
...
insertionStatement_tMysqlSCD_1.setString(1, scd1.code);
}

                    if(scd1.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
} else {
if(scd1.created_at != null) {
date_tMysqlSCD_1 = scd1.created_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
insertionStatement_tMysqlSCD_1.setString(2, "0000-00-00 00:00:00");
} else {
insertionStatement_tMysqlSCD_1.setTimestamp(2, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.DATE);
}
...
insertionStatement_tMysqlSCD_1.setString(4, scd1.description);
}

                    if(scd1.ps_id == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.INTEGER);
} else {
insertionStatement_tMysqlSCD_1.setInt(5, scd1.ps_id);
}

                    insertionStatement_tMysqlSCD_1.setInt(6, scd1.asset_id);
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.description == null && scd1.description!= null) || (lookUpValue_tMysqlSCD_1.description != null && !lookUpValue_tMysqlSCD_1.description.equals(scd1.description)) || (lookUpValue_tMysqlSCD_1.ps_id == null && scd1.ps_id!= null) || (lookUpValue_tMysqlSCD_1.ps_id != null && !lookUpValue_tMysqlSCD_1.ps_id.equals(scd1.ps_id)) || lookUpValue_tMysqlSCD_1.asset_id != scd1.asset_id) {
                    if(scd1.code == null) {
updateForType2_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(2, scd1.code);
}
...
insertionStatement_tMysqlSCD_1.setInt(5, scd1.ps_id);
                ...
                lookUpValue_tMysqlSCD_1.ps_id = scd1.ps_id;
                lookUpValue_tMysqlSCD_1.asset_id = scd1.asset_id;
...
// # Lookup hashes releasing
					if(tHash_Lookup_fg != null) {
						tHash_Lookup_fg.endGet();
					}
					globalMap.remove( "tHash_Lookup_fg" );

					
					
				
					if(tHash_Lookup_asset != null) {
						tHash_Lookup_asset.endGet();
					}
					globalMap.remove( "tHash_Lookup_asset" );
...
public static class fgStruct implements routines.system.IPersistableComparableLookupRow<fgStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final fgStruct other = (fgStruct) obj;
	...
	public void copyDataTo(fgStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(fgStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(fgStruct other) {
...
fgStruct fg = new fgStruct();
	 ...
	 */
		...
		ok_Hash.put("tAdvancedHash_fg", false);
		start_Hash.put("tAdvancedHash_fg", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_fg";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("fg" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_fg = 0;
		
    	class BytesLimit65535_tAdvancedHash_fg{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_fg().limitLog4jByte();

			   		// connection name:fg
			   		// source node:tMap_1 - inputs:(row2) outputs:(fg,fg) | target node:tAdvancedHash_fg - inputs:(fg) outputs:()
			   		// linked node: tMap_2 - inputs:(row1,fg,asset) outputs:(scd1)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_fg = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<fgStruct> tHash_Lookup_fg =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<fgStruct>getLookup(matchingModeEnum_fg);
	   						   
		   	   	   globalMap.put("tHash_Lookup_fg", tHash_Lookup_fg);
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_1 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_1 = "SELECT \n  `performance_standard`.`id`, \n  `performance_standard`.`code`, \n  `performance_standard`.`asset_id`, \n  `performance_standard`.`barrier_type_id`, \n  `performance_standard`.`description`, \n  `performance_standard`.`current_flag`, \n  `performance_standard`.`version_no`, \n  `performance_standard`.`start_dt`, \n  `performance_standard`.`end_dt`, \n  `performance_standard`.`created_at`, \n  `performance_standard`.`updated_at`\nFROM `performance_standard`";
		...
		try{
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row2.asset_id = rs_tMysqlInput_1.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row2.barrier_type_id = rs_tMysqlInput_1.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row2.current_flag = rs_tMysqlInput_1.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(7) != null) {
                row2.version_no = rs_tMysqlInput_1.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(8) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.start_dt = rs_tMysqlInput_1.getTimestamp(8);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(9) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.end_dt = rs_tMysqlInput_1.getTimestamp(9);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(10) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.created_at = rs_tMysqlInput_1.getTimestamp(10);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(11) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row2.updated_at = rs_tMysqlInput_1.getTimestamp(11);
	            } else {
...
if(fg != null) { 
	...
	currentComponent="tAdvancedHash_fg";
			...
			//fg
				...
				if(execStat){
					runStat.updateStatOnConnection("fg"+iterateId,1, 1);
				} 
					...
					fgStruct fg_HashRow = new fgStruct();
		   	   	   
				
				fg_HashRow.id = fg.id;
				
			tHash_Lookup_fg.put(fg_HashRow);
	...
	tos_count_tAdvancedHash_fg++;

/**
 * [tAdvancedHash_fg main ] stop
 */
...
tHash_Lookup_fg.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("fg"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_fg", true);
end_Hash.put("tAdvancedHash_fg", System.currentTimeMillis());




/**
 * [tAdvancedHash_fg end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_fg finally ] start
	 */
...
public static class assetStruct implements routines.system.IPersistableComparableLookupRow<assetStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_mapping_refdt = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final assetStruct other = (assetStruct) obj;
	...
	public void copyDataTo(assetStruct other) {

		other.id = this.id;
	            
	}

	public void copyKeysDataTo(assetStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(assetStruct other) {
...
assetStruct asset = new assetStruct();
	...
	/**
	 * [tAdvancedHash_asset begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_asset", false);
		start_Hash.put("tAdvancedHash_asset", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_asset";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("asset" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_asset = 0;
		
    	class BytesLimit65535_tAdvancedHash_asset{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tAdvancedHash_asset().limitLog4jByte();

			   		// connection name:asset
			   		// source node:tMap_3 - inputs:(row3) outputs:(asset,asset) | target node:tAdvancedHash_asset - inputs:(asset) outputs:()
			   		// linked node: tMap_2 - inputs:(row1,fg,asset) outputs:(scd1)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_asset = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<assetStruct> tHash_Lookup_asset =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<assetStruct>getLookup(matchingModeEnum_asset);
	   						   
		   	   	   globalMap.put("tHash_Lookup_asset", tHash_Lookup_asset);
...
/**
 * [tAdvancedHash_asset begin ] stop
 */
...
// ###############################
// # Outputs initialization
assetStruct asset_tmp = new assetStruct();
// ###############################
...
if(asset != null) { 
	...
	/**
	 * [tAdvancedHash_asset main ] start
	 */
	...
	currentComponent="tAdvancedHash_asset";
			...
			//asset
				...
				if(execStat){
					runStat.updateStatOnConnection("asset"+iterateId,1, 1);
				} 
					...
					assetStruct asset_HashRow = new assetStruct();
		   	   	   
				
				asset_HashRow.id = asset.id;
				
			tHash_Lookup_asset.put(asset_HashRow);
	...
	tos_count_tAdvancedHash_asset++;

/**
 * [tAdvancedHash_asset main ] stop
 */
...
tHash_Lookup_asset.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("asset"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_asset", true);
end_Hash.put("tAdvancedHash_asset", System.currentTimeMillis());




/**
 * [tAdvancedHash_asset end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_asset finally ] start
	 */
...
/**
 * [tAdvancedHash_asset finally ] stop
 */
 ...
 */
    ...
    public static void main(String[] args){
        final jb_performance_standard_mapping_refdt jb_performance_standard_mapping_refdtClass = new jb_performance_standard_mapping_refdt();

        int exitCode = jb_performance_standard_mapping_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_performance_standard_mapping_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_performance_standard_mapping_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_performance_standard_mapping_refdt");
        }
...
/************************************************************************************************
 *     165725 characters generated by Talend Open Studio for Data Integration 
