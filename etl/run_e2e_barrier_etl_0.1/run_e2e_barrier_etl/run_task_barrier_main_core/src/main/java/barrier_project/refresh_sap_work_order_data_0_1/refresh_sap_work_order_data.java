...
package barrier_project.refresh_sap_work_order_data_0_1;
...
/**
 * Job: refresh_sap_work_order_data Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class refresh_sap_work_order_data implements TalendJob {
...
public String getBarrier_Port(){
	...
	private final String jobName = "refresh_sap_work_order_data";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				refresh_sap_work_order_data.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(refresh_sap_work_order_data.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class fghStruct implements routines.system.IPersistableRow<fghStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String barrier_element;

				public String getBarrier_element () {
					return this.barrier_element;
				}
			    ...
			    public int performance_standard_id;

				public int getPerformance_standard_id () {
					return this.performance_standard_id;
				}
			    ...
			    public String barrier_metrics;

				public String getBarrier_metrics () {
					return this.barrier_metrics;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.asset_id;
	...
	public boolean equals(Object obj) {
		...
		final fghStruct other = (fghStruct) obj;
	...
	public void copyDataTo(fghStruct other) {
		...
		other.barrier_element = this.barrier_element;
	            ...
	            other.awaiting_deferrment = this.awaiting_deferrment;
	...
	public void copyKeysDataTo(fghStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data.length == 0) {
   					commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_refresh_sap_work_order_data) {

        	try {

        		int length = 0;
		
					this.barrier_element = readString(dis);
			        ...
			        this.performance_standard_id = dis.readInt();
					
			        this.planner_group_id = dis.readInt();
					
			        this.abc_indicator_id = dis.readInt();
					
					this.barrier_metrics = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.barrier_element,dos);
					...
					// int
		            	...
		            	dos.writeInt(this.performance_standard_id);
					...
					// String
						...
						writeString(this.barrier_metrics,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("barrier_element="+barrier_element);
     ...
     * Compare keys
     */
    public int compareTo(fghStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.asset_id, other.asset_id);
						if(returnValue != 0) {
							return returnValue;
						}
	...
	currentComponent="tMysqlSCD_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("fgh" + iterateId, 0, 0);
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + asset_id;
hashCode = prime * hashCode + (work_order_number == null ? 0 : work_order_number.hashCode());
...
private int performance_standard_id;
private int planner_group_id;
...
private int abc_indicator_id;
private String awaiting_deferrment;
private String barrier_element;
private String deferred;
private String barrier_metrics;
private int version_no;
    ...
    String tableName_tMysqlSCD_1 = "sap_work_order_data_version";
    ...
    String tmpValue_tMysqlSCD_1 = null;    
        String search_tMysqlSCD_1 = "SELECT `asset_id`, `work_order_number`, `facility_id`, `latest_allowable_finish_date`, `maint_activ_type`, `order_type`, `performance_standard_id`, `planner_group_id`, `functional_location`, `snapshot_date`, `snapshot_pid`, `user_status`, `work_centre`, `work_order_description`, `abc_indicator_id`, `awaiting_deferrment`, `barrier_element`, `deferred`, `barrier_metrics`, `version_no` FROM `" + tableName_tMysqlSCD_1 + "` WHERE `end_dt` IS NULL";
        ...
        while(resultSet_tMysqlSCD_1.next()) {
            ...
            SCDStruct_tMysqlSCD_1 row_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                    if(resultSet_tMysqlSCD_1.getObject(1) != null) {
                        sk_tMysqlSCD_1.asset_id = resultSet_tMysqlSCD_1.getInt(1);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(2) != null) {
                        sk_tMysqlSCD_1.work_order_number = resultSet_tMysqlSCD_1.getString(2);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(3) != null) {
                        sk_tMysqlSCD_1.facility_id = resultSet_tMysqlSCD_1.getInt(3);
                    }
                    dateStr_tMysqlSCD_1 = resultSet_tMysqlSCD_1.getString(4);
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.latest_allowable_finish_date = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(4).getTime());
                        } else {
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(5) != null) {
                        row_tMysqlSCD_1.maint_activ_type = resultSet_tMysqlSCD_1.getString(5);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(6) != null) {
                        row_tMysqlSCD_1.order_type = resultSet_tMysqlSCD_1.getString(6);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(7) != null) {
                        row_tMysqlSCD_1.performance_standard_id = resultSet_tMysqlSCD_1.getInt(7);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(8) != null) {
                        row_tMysqlSCD_1.planner_group_id = resultSet_tMysqlSCD_1.getInt(8);
                    }
                    ...
                    if(dateStr_tMysqlSCD_1 != null) {
                        if(!("0000-00-00").equals(dateStr_tMysqlSCD_1) && !("0000-00-00 00:00:00").equals(dateStr_tMysqlSCD_1)) {
                            row_tMysqlSCD_1.snapshot_date = new java.util.Date(resultSet_tMysqlSCD_1.getTimestamp(10).getTime());
                        } else {
                    ...
                    if(resultSet_tMysqlSCD_1.getObject(11) != null) {
                        row_tMysqlSCD_1.snapshot_pid = resultSet_tMysqlSCD_1.getString(11);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(12) != null) {
                        row_tMysqlSCD_1.user_status = resultSet_tMysqlSCD_1.getString(12);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(13) != null) {
                        row_tMysqlSCD_1.work_centre = resultSet_tMysqlSCD_1.getString(13);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(14) != null) {
                        row_tMysqlSCD_1.work_order_description = resultSet_tMysqlSCD_1.getString(14);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(15) != null) {
                        row_tMysqlSCD_1.abc_indicator_id = resultSet_tMysqlSCD_1.getInt(15);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(16) != null) {
                        row_tMysqlSCD_1.awaiting_deferrment = resultSet_tMysqlSCD_1.getString(16);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(17) != null) {
                        row_tMysqlSCD_1.barrier_element = resultSet_tMysqlSCD_1.getString(17);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(18) != null) {
                        row_tMysqlSCD_1.deferred = resultSet_tMysqlSCD_1.getString(18);
                    }
                    if(resultSet_tMysqlSCD_1.getObject(19) != null) {
                        row_tMysqlSCD_1.barrier_metrics = resultSet_tMysqlSCD_1.getString(19);
                    }
    ...
    String insertionSQL_tMysqlSCD_1 = "INSERT INTO `" + tableName_tMysqlSCD_1 + "`(`asset_id`, `work_order_number`, `facility_id`, `created_at`, `updated_at`, `latest_allowable_finish_date`, `maint_activ_type`, `order_type`, `performance_standard_id`, `planner_group_id`, `functional_location`, `snapshot_date`, `snapshot_pid`, `user_status`, `work_centre`, `work_order_description`, `abc_indicator_id`, `awaiting_deferrment`, `barrier_element`, `deferred`, `barrier_metrics`, `current_flag`, `version_no`, `start_dt`, `end_dt`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, b'1', ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tMysqlSCD_1 = connection_tMysqlSCD_1.prepareStatement(insertionSQL_tMysqlSCD_1);
        ...
        String updateSQLForType2_tMysqlSCD_1 = "UPDATE `" + tableName_tMysqlSCD_1 + "` SET `end_dt` = ?, `current_flag` = b'0' WHERE `asset_id` = ? AND `work_order_number` = ? AND `facility_id` = ? AND `end_dt` IS NULL";
...
fghStruct fgh_tmp = new fghStruct();
// ###############################
	...
	final String decryptedPassword_tMysqlInput_1 = context.barrier_Password; 
		...
		try{
		    ...
		    while (rs_tMysqlInput_1.next()) {
		        nb_line_tMysqlInput_1++;
							...
							if(colQtyInRs_tMysqlInput_1 < 1) {
								row1.barrier_element = null;
							} else {
	                         		
        	row1.barrier_element = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 1, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 2) {
								row1.functional_location = null;
							} else {
	                         		
        	row1.functional_location = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 2, false);
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(3) != null) {
                row1.asset_id = rs_tMysqlInput_1.getInt(3);
            } else {
            ...
            if(rs_tMysqlInput_1.getObject(4) != null) {
                row1.facility_id = rs_tMysqlInput_1.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 5) {
								row1.performance_standard_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_1.getObject(5) != null) {
                row1.performance_standard_id = rs_tMysqlInput_1.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(6) != null) {
                row1.planner_group_id = rs_tMysqlInput_1.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_1.getObject(7) != null) {
                row1.abc_indicator_id = rs_tMysqlInput_1.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_1 < 8) {
								row1.barrier_metrics = null;
							} else {
	                         		
        	row1.barrier_metrics = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 9) {
								row1.work_order_number = null;
							} else {
	                         		
        	row1.work_order_number = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 9, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 10) {
								row1.work_order_description = null;
							} else {
	                         		
        	row1.work_order_description = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 10, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 11) {
								row1.order_type = null;
							} else {
	                         		
        	row1.order_type = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 11, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 12) {
								row1.user_status = null;
							} else {
	                         		
        	row1.user_status = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 12, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 13) {
								row1.awaiting_deferrment = null;
							} else {
	                         		
        	row1.awaiting_deferrment = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 13, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 14) {
								row1.deferred = null;
							} else {
	                         		
        	row1.deferred = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 14, false);
		                    }
							if(colQtyInRs_tMysqlInput_1 < 15) {
								row1.work_centre = null;
							} else {
	                         		
        	row1.work_centre = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 15, false);
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(16) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.latest_allowable_finish_date = rs_tMysqlInput_1.getTimestamp(16);
	            } else {
	                row1.latest_allowable_finish_date = (java.util.Date) year0_tMysqlInput_1.clone();
	            }
	        } else {
	            row1.latest_allowable_finish_date =  null;
	        }			 
        	...
        	row1.maint_activ_type = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 17, false);
		                    }
	        ...
	        if(rs_tMysqlInput_1.getString(18) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.created_at = rs_tMysqlInput_1.getTimestamp(18);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(19) != null) {
	            String dateString_tMysqlInput_1 = rs_tMysqlInput_1.getString(19);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.updated_at = rs_tMysqlInput_1.getTimestamp(19);
	            } else {
	        ...
	        if(rs_tMysqlInput_1.getString(20) != null) {
	            ...
	            if (!("0000-00-00").equals(dateString_tMysqlInput_1) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_1)) {
	                row1.snapshot_date = rs_tMysqlInput_1.getTimestamp(20);
	            } else {
        	...
        	row1.snapshot_pid = routines.system.JDBCUtil.getString(rs_tMysqlInput_1, 21, false);
		                    }
...
// # Output table : 'fgh'
fgh_tmp.barrier_element = row1.barrier_element;
fgh_tmp.functional_location = row1.functional_location;
fgh_tmp.asset_id = row1.asset_id;
fgh_tmp.facility_id = row1.facility_id;
fgh_tmp.performance_standard_id = row1.performance_standard_id;
fgh_tmp.planner_group_id = row1.planner_group_id;
fgh_tmp.abc_indicator_id = row1.abc_indicator_id;
fgh_tmp.barrier_metrics = row1.barrier_metrics;
fgh_tmp.work_order_number = row1.work_order_number;
fgh_tmp.work_order_description = row1.work_order_description;
fgh_tmp.order_type = row1.order_type;
fgh_tmp.user_status = row1.user_status;
fgh_tmp.awaiting_deferrment = row1.awaiting_deferrment;
fgh_tmp.deferred = row1.deferred;
fgh_tmp.work_centre = row1.work_centre;
fgh_tmp.latest_allowable_finish_date = row1.latest_allowable_finish_date;
fgh_tmp.maint_activ_type = row1.maint_activ_type;
fgh_tmp.created_at = row1.created_at;
fgh_tmp.updated_at = row1.updated_at;
fgh_tmp.start_dt = null;
fgh_tmp.end_dt = null;
fgh_tmp.snapshot_date =  Var.snapshot_date ;
fgh_tmp.snapshot_pid =  Var.snapshot_pid ;
fgh_tmp.version_no = 0;
fgh_tmp.current_flag = false;
fgh = fgh_tmp;
// ###############################
...
if(fgh != null) { 
	...
	currentComponent="tMysqlSCD_1";
			...
			//fgh
				...
				if(execStat){
					runStat.updateStatOnConnection("fgh"+iterateId,1, 1);
				} 
	...
	try {
        lookUpKey_tMysqlSCD_1 = new SCDSK_tMysqlSCD_1();
            lookUpKey_tMysqlSCD_1.asset_id = fgh.asset_id;
            lookUpKey_tMysqlSCD_1.work_order_number = fgh.work_order_number;
            lookUpKey_tMysqlSCD_1.facility_id = fgh.facility_id;
    ...
    if(lookUpValue_tMysqlSCD_1 == null) {
            lookUpValue_tMysqlSCD_1 = new SCDStruct_tMysqlSCD_1();
                lookUpValue_tMysqlSCD_1.version_no = 1;
                    ...
                    insertionStatement_tMysqlSCD_1.setInt(1, fgh.asset_id);

                    if(fgh.work_order_number == null) {
insertionStatement_tMysqlSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(2, fgh.work_order_number);
}

                    insertionStatement_tMysqlSCD_1.setInt(3, fgh.facility_id);

                    if(fgh.created_at == null) {
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
} else {
if(fgh.created_at != null) {
date_tMysqlSCD_1 = fgh.created_at.getTime();
...
insertionStatement_tMysqlSCD_1.setNull(4, java.sql.Types.DATE);
                    ...
                    if(fgh.updated_at == null) {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
} else {
if(fgh.updated_at != null) {
date_tMysqlSCD_1 = fgh.updated_at.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
insertionStatement_tMysqlSCD_1.setString(5, "0000-00-00 00:00:00");
} else {
insertionStatement_tMysqlSCD_1.setTimestamp(5, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
insertionStatement_tMysqlSCD_1.setNull(5, java.sql.Types.DATE);
}
                    ...
                    if(fgh.latest_allowable_finish_date == null) {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.DATE);
} else {
if(fgh.latest_allowable_finish_date != null) {
date_tMysqlSCD_1 = fgh.latest_allowable_finish_date.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
insertionStatement_tMysqlSCD_1.setString(6, "0000-00-00 00:00:00");
} else {
insertionStatement_tMysqlSCD_1.setTimestamp(6, new java.sql.Timestamp(date_tMysqlSCD_1));
}
} else {
insertionStatement_tMysqlSCD_1.setNull(6, java.sql.Types.DATE);
}
                    ...
                    if(fgh.maint_activ_type == null) {
insertionStatement_tMysqlSCD_1.setNull(7, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(7, fgh.maint_activ_type);
}

                    if(fgh.order_type == null) {
insertionStatement_tMysqlSCD_1.setNull(8, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(8, fgh.order_type);
}

                    insertionStatement_tMysqlSCD_1.setInt(9, fgh.performance_standard_id);

                    insertionStatement_tMysqlSCD_1.setInt(10, fgh.planner_group_id);

                    if(fgh.functional_location == null) {
insertionStatement_tMysqlSCD_1.setNull(11, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(11, fgh.functional_location);
}

                    if(fgh.snapshot_date == null) {
insertionStatement_tMysqlSCD_1.setNull(12, java.sql.Types.DATE);
} else {
if(fgh.snapshot_date != null) {
date_tMysqlSCD_1 = fgh.snapshot_date.getTime();
if(date_tMysqlSCD_1 < year1_tMysqlSCD_1 || date_tMysqlSCD_1 >= year10000_tMysqlSCD_1) {
...
insertionStatement_tMysqlSCD_1.setNull(12, java.sql.Types.DATE);
                    ...
                    if(fgh.snapshot_pid == null) {
insertionStatement_tMysqlSCD_1.setNull(13, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(13, fgh.snapshot_pid);
}

                    if(fgh.user_status == null) {
insertionStatement_tMysqlSCD_1.setNull(14, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(14, fgh.user_status);
}

                    if(fgh.work_centre == null) {
insertionStatement_tMysqlSCD_1.setNull(15, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(15, fgh.work_centre);
}

                    if(fgh.work_order_description == null) {
insertionStatement_tMysqlSCD_1.setNull(16, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(16, fgh.work_order_description);
}

                    insertionStatement_tMysqlSCD_1.setInt(17, fgh.abc_indicator_id);

                    if(fgh.awaiting_deferrment == null) {
insertionStatement_tMysqlSCD_1.setNull(18, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(18, fgh.awaiting_deferrment);
}

                    if(fgh.barrier_element == null) {
insertionStatement_tMysqlSCD_1.setNull(19, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(19, fgh.barrier_element);
}

                    if(fgh.deferred == null) {
insertionStatement_tMysqlSCD_1.setNull(20, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(20, fgh.deferred);
}

                    if(fgh.barrier_metrics == null) {
insertionStatement_tMysqlSCD_1.setNull(21, java.sql.Types.VARCHAR);
} else {
insertionStatement_tMysqlSCD_1.setString(21, fgh.barrier_metrics);
}
        ...
        nb_line_inserted_tMysqlSCD_1 += insertionStatement_tMysqlSCD_1.executeUpdate();
            ...
            if((lookUpValue_tMysqlSCD_1.latest_allowable_finish_date == null && fgh.latest_allowable_finish_date!= null) || ( ( lookUpValue_tMysqlSCD_1.latest_allowable_finish_date != null && fgh.latest_allowable_finish_date!= null ) && ( (( lookUpValue_tMysqlSCD_1.latest_allowable_finish_date.getTime()-fgh.latest_allowable_finish_date.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.latest_allowable_finish_date.getTime()-fgh.latest_allowable_finish_date.getTime() ) < -999) ))  || (lookUpValue_tMysqlSCD_1.maint_activ_type == null && fgh.maint_activ_type!= null) || (lookUpValue_tMysqlSCD_1.maint_activ_type != null && !lookUpValue_tMysqlSCD_1.maint_activ_type.equals(fgh.maint_activ_type)) || (lookUpValue_tMysqlSCD_1.order_type == null && fgh.order_type!= null) || (lookUpValue_tMysqlSCD_1.order_type != null && !lookUpValue_tMysqlSCD_1.order_type.equals(fgh.order_type)) || lookUpValue_tMysqlSCD_1.performance_standard_id != fgh.performance_standard_id || lookUpValue_tMysqlSCD_1.planner_group_id != fgh.planner_group_id || (lookUpValue_tMysqlSCD_1.functional_location == null && fgh.functional_location!= null) || (lookUpValue_tMysqlSCD_1.functional_location != null && !lookUpValue_tMysqlSCD_1.functional_location.equals(fgh.functional_location)) || (lookUpValue_tMysqlSCD_1.snapshot_date == null && fgh.snapshot_date!= null) || ( ( lookUpValue_tMysqlSCD_1.snapshot_date != null && fgh.snapshot_date!= null ) && ( (( lookUpValue_tMysqlSCD_1.snapshot_date.getTime()-fgh.snapshot_date.getTime()) > 999) || (( lookUpValue_tMysqlSCD_1.snapshot_date.getTime()-fgh.snapshot_date.getTime() ) < -999) ))  || (lookUpValue_tMysqlSCD_1.snapshot_pid == null && fgh.snapshot_pid!= null) || (lookUpValue_tMysqlSCD_1.snapshot_pid != null && !lookUpValue_tMysqlSCD_1.snapshot_pid.equals(fgh.snapshot_pid)) || (lookUpValue_tMysqlSCD_1.user_status == null && fgh.user_status!= null) || (lookUpValue_tMysqlSCD_1.user_status != null && !lookUpValue_tMysqlSCD_1.user_status.equals(fgh.user_status)) || (lookUpValue_tMysqlSCD_1.work_centre == null && fgh.work_centre!= null) || (lookUpValue_tMysqlSCD_1.work_centre != null && !lookUpValue_tMysqlSCD_1.work_centre.equals(fgh.work_centre)) || (lookUpValue_tMysqlSCD_1.work_order_description == null && fgh.work_order_description!= null) || (lookUpValue_tMysqlSCD_1.work_order_description != null && !lookUpValue_tMysqlSCD_1.work_order_description.equals(fgh.work_order_description)) || lookUpValue_tMysqlSCD_1.abc_indicator_id != fgh.abc_indicator_id || (lookUpValue_tMysqlSCD_1.awaiting_deferrment == null && fgh.awaiting_deferrment!= null) || (lookUpValue_tMysqlSCD_1.awaiting_deferrment != null && !lookUpValue_tMysqlSCD_1.awaiting_deferrment.equals(fgh.awaiting_deferrment)) || (lookUpValue_tMysqlSCD_1.barrier_element == null && fgh.barrier_element!= null) || (lookUpValue_tMysqlSCD_1.barrier_element != null && !lookUpValue_tMysqlSCD_1.barrier_element.equals(fgh.barrier_element)) || (lookUpValue_tMysqlSCD_1.deferred == null && fgh.deferred!= null) || (lookUpValue_tMysqlSCD_1.deferred != null && !lookUpValue_tMysqlSCD_1.deferred.equals(fgh.deferred)) || (lookUpValue_tMysqlSCD_1.barrier_metrics == null && fgh.barrier_metrics!= null) || (lookUpValue_tMysqlSCD_1.barrier_metrics != null && !lookUpValue_tMysqlSCD_1.barrier_metrics.equals(fgh.barrier_metrics))) {
                    updateForType2_tMysqlSCD_1.setInt(2, fgh.asset_id);

                    if(fgh.work_order_number == null) {
updateForType2_tMysqlSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
updateForType2_tMysqlSCD_1.setString(3, fgh.work_order_number);
}

                    updateForType2_tMysqlSCD_1.setInt(4, fgh.facility_id);
...
insertionStatement_tMysqlSCD_1.setString(21, fgh.barrier_metrics);
                ...
                lookUpValue_tMysqlSCD_1.latest_allowable_finish_date = fgh.latest_allowable_finish_date;
                lookUpValue_tMysqlSCD_1.maint_activ_type = fgh.maint_activ_type;
                lookUpValue_tMysqlSCD_1.order_type = fgh.order_type;
                lookUpValue_tMysqlSCD_1.performance_standard_id = fgh.performance_standard_id;
                lookUpValue_tMysqlSCD_1.planner_group_id = fgh.planner_group_id;
                lookUpValue_tMysqlSCD_1.functional_location = fgh.functional_location;
                lookUpValue_tMysqlSCD_1.snapshot_date = fgh.snapshot_date;
                lookUpValue_tMysqlSCD_1.snapshot_pid = fgh.snapshot_pid;
                lookUpValue_tMysqlSCD_1.user_status = fgh.user_status;
                lookUpValue_tMysqlSCD_1.work_centre = fgh.work_centre;
                lookUpValue_tMysqlSCD_1.work_order_description = fgh.work_order_description;
                lookUpValue_tMysqlSCD_1.abc_indicator_id = fgh.abc_indicator_id;
                lookUpValue_tMysqlSCD_1.awaiting_deferrment = fgh.awaiting_deferrment;
                lookUpValue_tMysqlSCD_1.barrier_element = fgh.barrier_element;
                lookUpValue_tMysqlSCD_1.deferred = fgh.deferred;
                lookUpValue_tMysqlSCD_1.barrier_metrics = fgh.barrier_metrics;
 ...
 */
    ...
    globalMap.put("tMysqlSCD_1_NB_LINE_REJECTED",nb_line_rejected_tMysqlSCD_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("fgh"+iterateId,2, 0); 
			 	}
			}
...
public static class nmjStruct implements routines.system.IPersistableRow<nmjStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_refresh_sap_work_order_data = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final nmjStruct other = (nmjStruct) obj;
	...
	public void copyDataTo(nmjStruct other) {
	...
	public void copyKeysDataTo(nmjStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(nmjStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("nmj" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "sap_work_order_data";
...
int count_tMysqlOutput_1=0;
            ...
            stmtTrunc_tMysqlOutput_1.close();
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "sap_work_order_data" + "` (`barrier_element`,`functional_location`,`asset_id`,`facility_id`,`performance_standard_id`,`planner_group_id`,`abc_indicator_id`,`barrier_metrics`,`work_order_number`,`work_order_description`,`order_type`,`user_status`,`awaiting_deferrment`,`deferred`,`work_centre`,`latest_allowable_finish_date`,`maint_activ_type`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
nmjStruct nmj_tmp = new nmjStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tMysqlInput_2 = context.barrier_Password; 
		    ...
		    String dbquery_tMysqlInput_2 = "SELECT \n  `sap_work_order_data_version`.`barrier_element`, \n  `sap_work_order_data_version`.`functional_location`, \n  `sap_work_order_data_version`.`asset_id`, \n  `sap_work_order_data_version`.`facility_id`, \n  `sap_work_order_data_version`.`performance_standard_id`, \n  `sap_work_order_data_version`.`planner_group_id`, \n  `sap_work_order_data_version`.`abc_indicator_id`, \n  `sap_work_order_data_version`.`barrier_metrics`, \n  `sap_work_order_data_version`.`work_order_number`, \n  `sap_work_order_data_version`.`work_order_description`, \n  `sap_work_order_data_version`.`order_type`, \n  `sap_work_order_data_version`.`user_status`, \n  `sap_work_order_data_version`.`awaiting_deferrment`, \n  `sap_work_order_data_version`.`deferred`, \n  `sap_work_order_data_version`.`work_centre`, \n  `sap_work_order_data_version`.`latest_allowable_finish_date`, \n  `sap_work_order_data_version`.`maint_activ_type`, \n  `sap_work_order_data_version`.`created_at`, \n  `sap_work_order_data_version`.`updated_at`, \n  `sap_work_order_data_version`.`start_dt`, \n  `sap_work_order_data_version`.`end_dt`, \n  `sap_work_order_data_version`.`snapshot_date`, \n  `sap_work_order_data_version`.`snapshot_pid`, \n  `sap_work_order_data_version`.`version_no`, \n  `sap_work_order_data_version`.`current_flag`\nFROM `sap_work_order_data_version`\nWHERE `sap_work_order_data_version`.`current_flag` = 1\n";
		...
		try{
		    ...
		    while (rs_tMysqlInput_2.next()) {
		        nb_line_tMysqlInput_2++;
							...
							if(colQtyInRs_tMysqlInput_2 < 1) {
								row2.barrier_element = null;
							} else {
	                         		
        	row2.barrier_element = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 1, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 2) {
								row2.functional_location = null;
							} else {
	                         		
        	row2.functional_location = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 2, false);
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(3) != null) {
                row2.asset_id = rs_tMysqlInput_2.getInt(3);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(4) != null) {
                row2.facility_id = rs_tMysqlInput_2.getInt(4);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 5) {
								row2.performance_standard_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(5) != null) {
                row2.performance_standard_id = rs_tMysqlInput_2.getInt(5);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 6) {
								row2.planner_group_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(6) != null) {
                row2.planner_group_id = rs_tMysqlInput_2.getInt(6);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 7) {
								row2.abc_indicator_id = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(7) != null) {
                row2.abc_indicator_id = rs_tMysqlInput_2.getInt(7);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tMysqlInput_2 < 8) {
								row2.barrier_metrics = null;
							} else {
	                         		
        	row2.barrier_metrics = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 8, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 9) {
								row2.work_order_number = null;
							} else {
	                         		
        	row2.work_order_number = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 9, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 10) {
								row2.work_order_description = null;
							} else {
	                         		
        	row2.work_order_description = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 10, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 11) {
								row2.order_type = null;
							} else {
	                         		
        	row2.order_type = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 11, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 12) {
								row2.user_status = null;
							} else {
	                         		
        	row2.user_status = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 12, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 13) {
								row2.awaiting_deferrment = null;
							} else {
	                         		
        	row2.awaiting_deferrment = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 13, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 14) {
								row2.deferred = null;
							} else {
	                         		
        	row2.deferred = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 14, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 15) {
								row2.work_centre = null;
							} else {
	                         		
        	row2.work_centre = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 15, false);
		                    }
	        ...
	        if(rs_tMysqlInput_2.getString(16) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(16);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.latest_allowable_finish_date = rs_tMysqlInput_2.getTimestamp(16);
	            } else {
	                row2.latest_allowable_finish_date = (java.util.Date) year0_tMysqlInput_2.clone();
	            }
	        } else {
	            row2.latest_allowable_finish_date =  null;
	        }			 
        	...
        	row2.maint_activ_type = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 17, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 18) {
								row2.created_at = null;
							} else {
										
	        if(rs_tMysqlInput_2.getString(18) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(18);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.created_at = rs_tMysqlInput_2.getTimestamp(18);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(19) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(19);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.updated_at = rs_tMysqlInput_2.getTimestamp(19);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(20) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(20);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.start_dt = rs_tMysqlInput_2.getTimestamp(20);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(21) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(21);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.end_dt = rs_tMysqlInput_2.getTimestamp(21);
	            } else {
	        ...
	        if(rs_tMysqlInput_2.getString(22) != null) {
	            String dateString_tMysqlInput_2 = rs_tMysqlInput_2.getString(22);
	            if (!("0000-00-00").equals(dateString_tMysqlInput_2) && !("0000-00-00 00:00:00").equals(dateString_tMysqlInput_2)) {
	                row2.snapshot_date = rs_tMysqlInput_2.getTimestamp(22);
	            } else {
        	...
        	row2.snapshot_pid = routines.system.JDBCUtil.getString(rs_tMysqlInput_2, 23, false);
		                    }
							if(colQtyInRs_tMysqlInput_2 < 24) {
								row2.version_no = 0;
							} else {
		                          
            if(rs_tMysqlInput_2.getObject(24) != null) {
                row2.version_no = rs_tMysqlInput_2.getInt(24);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(rs_tMysqlInput_2.getObject(25) != null) {
                row2.current_flag = rs_tMysqlInput_2.getBoolean(25);
            } else {
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
// # Output table : 'nmj'
nmj_tmp.barrier_element = row2.barrier_element;
nmj_tmp.functional_location = row2.functional_location;
nmj_tmp.asset_id = row2.asset_id;
nmj_tmp.facility_id = row2.facility_id;
nmj_tmp.performance_standard_id = row2.performance_standard_id;
nmj_tmp.planner_group_id = row2.planner_group_id;
nmj_tmp.abc_indicator_id = row2.abc_indicator_id;
nmj_tmp.barrier_metrics = row2.barrier_metrics;
nmj_tmp.work_order_number = row2.work_order_number;
nmj_tmp.work_order_description = row2.work_order_description;
nmj_tmp.order_type = row2.order_type;
nmj_tmp.user_status = row2.user_status;
nmj_tmp.awaiting_deferrment = row2.awaiting_deferrment;
nmj_tmp.deferred = row2.deferred;
nmj_tmp.work_centre = row2.work_centre;
nmj_tmp.latest_allowable_finish_date = row2.latest_allowable_finish_date;
nmj_tmp.maint_activ_type = row2.maint_activ_type;
nmj_tmp.created_at = row2.created_at;
nmj_tmp.updated_at = row2.updated_at;
nmj = nmj_tmp;
// ###############################
...
if(nmj != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//nmj
				...
				if(execStat){
					runStat.updateStatOnConnection("nmj"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                            if(nmj.barrier_element == null) {
pstmt_tMysqlOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(1, nmj.barrier_element);
}

                            if(nmj.functional_location == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, nmj.functional_location);
}

                            pstmt_tMysqlOutput_1.setInt(3, nmj.asset_id);

                            pstmt_tMysqlOutput_1.setInt(4, nmj.facility_id);

                            pstmt_tMysqlOutput_1.setInt(5, nmj.performance_standard_id);

                            pstmt_tMysqlOutput_1.setInt(6, nmj.planner_group_id);

                            pstmt_tMysqlOutput_1.setInt(7, nmj.abc_indicator_id);

                            if(nmj.barrier_metrics == null) {
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(8, nmj.barrier_metrics);
}

                            if(nmj.work_order_number == null) {
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(9, nmj.work_order_number);
}

                            if(nmj.work_order_description == null) {
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(10, nmj.work_order_description);
}

                            if(nmj.order_type == null) {
pstmt_tMysqlOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(11, nmj.order_type);
}

                            if(nmj.user_status == null) {
pstmt_tMysqlOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(12, nmj.user_status);
}

                            if(nmj.awaiting_deferrment == null) {
pstmt_tMysqlOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(13, nmj.awaiting_deferrment);
}

                            if(nmj.deferred == null) {
pstmt_tMysqlOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(14, nmj.deferred);
}

                            if(nmj.work_centre == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, nmj.work_centre);
}

                            if(nmj.latest_allowable_finish_date != null) {
date_tMysqlOutput_1 = nmj.latest_allowable_finish_date.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(16, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(16, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(16, java.sql.Types.DATE);
}

                            if(nmj.maint_activ_type == null) {
pstmt_tMysqlOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(17, nmj.maint_activ_type);
}

                            if(nmj.created_at != null) {
date_tMysqlOutput_1 = nmj.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(18, java.sql.Types.DATE);
                            ...
                            if(nmj.updated_at != null) {
date_tMysqlOutput_1 = nmj.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
pstmt_tMysqlOutput_1.setString(19, "0000-00-00 00:00:00");
} else {pstmt_tMysqlOutput_1.setTimestamp(19, new java.sql.Timestamp(date_tMysqlOutput_1));
}
} else {
pstmt_tMysqlOutput_1.setNull(19, java.sql.Types.DATE);
}
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("nmj"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final refresh_sap_work_order_data refresh_sap_work_order_dataClass = new refresh_sap_work_order_data();

        int exitCode = refresh_sap_work_order_dataClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = refresh_sap_work_order_data.class.getClassLoader().getResourceAsStream("barrier_project/refresh_sap_work_order_data_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : refresh_sap_work_order_data");
        }
...
/************************************************************************************************
 *     196573 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 November 2017 08:42:12 GMT
 ************************************************************************************************/