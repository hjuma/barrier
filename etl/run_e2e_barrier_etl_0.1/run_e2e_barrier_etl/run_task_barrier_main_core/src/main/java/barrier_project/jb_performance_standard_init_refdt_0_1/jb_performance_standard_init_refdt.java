...
package barrier_project.jb_performance_standard_init_refdt_0_1;
...
/**
 * Job: jb_performance_standard_init_refdt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.4.1.20170623_1246
 * @status 
 */
public class jb_performance_standard_init_refdt implements TalendJob {
...
public String getEtl_data_home(){
	...
	private final String jobName = "jb_performance_standard_init_refdt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				jb_performance_standard_init_refdt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(jb_performance_standard_init_refdt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class fgtStruct implements routines.system.IPersistableRow<fgtStruct> {
    final static byte[] commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_init_refdt = new byte[0];
    static byte[] commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final fgtStruct other = (fgtStruct) obj;
	...
	public void copyDataTo(fgtStruct other) {
	...
	public void copyKeysDataTo(fgtStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt.length) {
				if(length < 1024 && commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt.length == 0) {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt = new byte[1024];
				} else {
   					commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt, 0, length);
			strReturn = new String(commonByteArray_BARRIER_PROJECT_jb_performance_standard_init_refdt, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BARRIER_PROJECT_jb_performance_standard_init_refdt) {
     ...
     * Compare keys
     */
    public int compareTo(fgtStruct other) {
	...
	currentComponent="tMysqlOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("fgt" + iterateId, 0, 0);
...
String tableName_tMysqlOutput_1 = "performance_standard";
...
int count_tMysqlOutput_1=0;
	    ...
	    String insertIgnore_tMysqlOutput_1 = "INSERT IGNORE INTO `" + "performance_standard" + "` (`id`,`code`,`asset_id`,`barrier_type_id`,`description`,`current_flag`,`version_no`,`start_dt`,`end_dt`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `code` = ?,`asset_id` = ?,`barrier_type_id` = ?,`description` = ?,`current_flag` = ?,`version_no` = ?,`start_dt` = ?,`end_dt` = ?,`created_at` = ?,`updated_at` = ?";
...
fgtStruct fgt_tmp = new fgtStruct();
// ###############################
...
// # Output table : 'fgt'
fgt_tmp.id = row1.id;
fgt_tmp.code = row1.code;
fgt_tmp.asset_id = row1.asset_id;
fgt_tmp.barrier_type_id = row1.barrier_type_id;
fgt_tmp.description = row1.description;
fgt_tmp.current_flag = 1;
fgt_tmp.version_no = 1;
fgt_tmp.start_dt = Var.var1 ;
fgt_tmp.end_dt = null;
fgt_tmp.created_at = row1.created_at;
fgt_tmp.updated_at = row1.updated_at;
fgt = fgt_tmp;
// ###############################
...
if(fgt != null) { 
	...
	currentComponent="tMysqlOutput_1";
			...
			//fgt
				...
				if(execStat){
					runStat.updateStatOnConnection("fgt"+iterateId,1, 1);
				} 
        ...
        whetherReject_tMysqlOutput_1 = false;
                    pstmt_tMysqlOutput_1.setInt(1, fgt.id);

                    if(fgt.code == null) {
pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(2, fgt.code);
}

                    pstmt_tMysqlOutput_1.setInt(3, fgt.asset_id);

                    pstmt_tMysqlOutput_1.setInt(4, fgt.barrier_type_id);

                    if(fgt.description == null) {
pstmt_tMysqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(5, fgt.description);
}

                    pstmt_tMysqlOutput_1.setInt(6, fgt.current_flag);

                    pstmt_tMysqlOutput_1.setInt(7, fgt.version_no);

                    if(fgt.start_dt != null) {
date_tMysqlOutput_1 = fgt.start_dt.getTime();
...
pstmt_tMysqlOutput_1.setNull(8, java.sql.Types.DATE);
                    ...
                    if(fgt.end_dt != null) {
date_tMysqlOutput_1 = fgt.end_dt.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(9, java.sql.Types.DATE);
                    ...
                    if(fgt.created_at != null) {
date_tMysqlOutput_1 = fgt.created_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
pstmt_tMysqlOutput_1.setNull(10, java.sql.Types.DATE);
                    ...
                    if(fgt.updated_at != null) {
date_tMysqlOutput_1 = fgt.updated_at.getTime();
if(date_tMysqlOutput_1 < year1_tMysqlOutput_1 || date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
...
} else {pstmt_tMysqlOutput_1.setString(12, fgt.code);
}

                    pstmt_tMysqlOutput_1.setInt(13, fgt.asset_id);

                    pstmt_tMysqlOutput_1.setInt(14, fgt.barrier_type_id);

                    if(fgt.description == null) {
pstmt_tMysqlOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tMysqlOutput_1.setString(15, fgt.description);
}

                    pstmt_tMysqlOutput_1.setInt(16, fgt.current_flag);

                    pstmt_tMysqlOutput_1.setInt(17, fgt.version_no);
 ...
 */
	...
	nb_line_rejected_tMysqlOutput_1=nb_line_rejected_tMysqlOutput_1 + rejectedCount_tMysqlOutput_1;
        ...
        globalMap.put("tMysqlOutput_1_NB_LINE_REJECTED", nb_line_rejected_tMysqlOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("fgt"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final jb_performance_standard_init_refdt jb_performance_standard_init_refdtClass = new jb_performance_standard_init_refdt();

        int exitCode = jb_performance_standard_init_refdtClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jb_performance_standard_init_refdt.class.getClassLoader().getResourceAsStream("barrier_project/jb_performance_standard_init_refdt_0_1/contexts/"+contextStr+".properties");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jb_performance_standard_init_refdt");
        }
...
/************************************************************************************************
 *     95050 characters generated by Talend Open Studio for Data Integration 
