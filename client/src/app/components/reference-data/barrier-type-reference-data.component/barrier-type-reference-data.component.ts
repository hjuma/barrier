...
export class BarrierTypeReferenceDataComponent extends ReferenceDataComponent implements OnInit {
  ...
  constructor(private referenceDataService: ReferenceDataService, private assetService: AssetService, private formBuilder: FormBuilder, private toasterService: ToasterService) {
    super();
    this.barrierType = {};
  ...
  private generatePayload(current: Object) {
    ...
    if (!this.isNew) {
      ...
      barrierType['version_no'] = current['version_no'];
    }
    return barrierType;
  }
