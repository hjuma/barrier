...
export class FacilityReferenceDataComponent extends ReferenceDataComponent implements OnInit {
  ...
  constructor(private referenceDataService: ReferenceDataService, private formBuilder: FormBuilder, private toasterService: ToasterService) {
    super();
    this.facility = {};
  ...
  private generatePayload(current: Object) {
    ...
    if (!this.isNew) {
      ...
      facility['version_no'] = current['version_no'];
    }
    return facility;
  }
